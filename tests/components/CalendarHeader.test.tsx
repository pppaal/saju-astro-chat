...
describe('CalendarHeader', () => {
  ...
  describe('Year Summary', () => {
    it('should display all grade counts when summary provided', () => {
      ...
      expect(screen.getByText('18')).toBeInTheDocument(); // Best
      expect(screen.getAllByText('55')).toHaveLength(2); // Good + Bad
      expect(screen.getByText('17')).toBeInTheDocument(); // Worst
    });
    ...
    it('should hide worst days badge when count is 0', () => {
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very large summary numbers', () => {
      ...
      const badges = screen.getAllByText('999');
      expect(badges.length).toBe(4); // 4 visible badges
    });
