...
import { getStrengthsAndWeaknesses } from '@/components/destiny-map/free-report/analyzers/strengthsAnalyzer';
import type { SajuData, AstroData } from '@/components/destiny-map/free-report/types';

// Mock utils
vi.mock('@/components/destiny-map/free-report/analyzers/utils', () => ({
