...
import {
  ...
  getHouseDomain,
  HOUSE_DOMAINS,
} from '@/components/destiny-map/free-report/utils/houses';
import type { AstroData } from '@/components/destiny-map/free-report/types';

// Mock validation module
vi.mock('@/components/destiny-map/free-report/utils/validation', () => ({
