...
import {
  useAiStreaming,
  type UseAiStreamingParams,
  type AiStatus,
} from '@/components/iching/hooks/useAiStreaming'
...
describe('useAiStreaming', () => {
  ...
  describe('startAiInterpretation', () => {
    it('should not start if result is null', async () => {
      const { result } = renderHook(() => useAiStreaming({ ...defaultParams, result: null }))
    ...
    it('should handle Korean locale for rate limit error', async () => {
      ...
      const { result } = renderHook(() => useAiStreaming({ ...defaultParams, locale: 'ko' }))
  ...
  describe('Korean language support', () => {
    it('should use Korean premium data when lang is ko', async () => {
      ...
      const { result } = renderHook(() => useAiStreaming({ ...defaultParams, lang: 'ko' }))
    ...
    it('should use English premium data when lang is en', async () => {
      ...
      const { result } = renderHook(() => useAiStreaming({ ...defaultParams, lang: 'en' }))
  ...
  describe('without premium data', () => {
    it('should handle null premium data', async () => {
      ...
      const { result } = renderHook(() => useAiStreaming({ ...defaultParams, premiumData: null }))
