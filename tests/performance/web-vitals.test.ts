...
describe('Performance Best Practices', () => {
  ...
  it('should recommend code splitting for large bundles', () => {
    ...
    // Bundle size exceeds recommended, should implement code splitting
    expect(bundleSize).toBeGreaterThan(maxRecommendedSize)
  })

  it('should recommend preconnect for critical origins', () => {
    const criticalOrigins = ['https://fonts.googleapis.com', 'https://cdn.example.com']
