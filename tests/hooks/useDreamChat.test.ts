...
describe('useDreamChat', () => {
  ...
  const mockResult = {
    ...
    themes: [{ label: 'Transformation', description: 'Change and growth' }],
    recommendations: [
  ...
  describe('Message sending', () => {
    ...
    it('should not send message while loading', async () => {
      ...
      const { result } = renderHook(() => useDreamChat('en', 'Dream text', mockResult, null, null))
    ...
    it('should add user message to chat', async () => {
      ...
      const userMessage = result.current.chatMessages.find((m) => m.role === 'user')
  ...
  describe('Dream context building', () => {
    ...
    it('should include user profile saju in context', async () => {
      ...
      const { result } = renderHook(() =>
        useDreamChat('en', 'Dream', mockResult, mockUserProfile as any, null)
      )
    ...
    it('should work without saju info', async () => {
      ...
      const { result } = renderHook(() => useDreamChat('en', 'Dream', mockResult, null, null))
  ...
  describe('SSE streaming response', () => {
    ...
    it('should handle empty streaming response', async () => {
      ...
      const { result } = renderHook(() => useDreamChat('ko', 'Dream', mockResult, null, null))
  ...
  describe('Edge cases', () => {
    ...
    it('should handle recommendations as objects', async () => {
      ...
      expect(body.dreamContext.recommendations).toContain('Keep a dream journal')
    })
