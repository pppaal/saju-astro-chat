  ...
  describe('fetchHistory', () => {
    it('should fetch consultations successfully', async () => {
      const mockConsultations = [
        { id: '1', theme: 'today', summary: 'Daily fortune', createdAt: '2024-01-01', locale: 'en' },
    ...
    it('should append data when offset > 0', async () => {
      const firstPage = [{ id: '1', theme: 'today', summary: 'First', createdAt: '2024-01-01', locale: 'en' }];
      const secondPage = [{ id: '2', theme: 'today', summary: 'Second', createdAt: '2024-01-02', locale: 'en' }];
