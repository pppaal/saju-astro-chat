...
describe('Pages Smoke Tests', () => {
  ...
  describe('Community Pages (2)', () => {
    it('should have community pages', () => {
      assertPages([
        'app/community/page',
        'app/community/recommendations/page',
      ]);
    });
  });
  ...
  describe('Destiny Matrix Pages (2)', () => {
    it('should have destiny matrix pages', () => {
      assertPages([
        'app/destiny-matrix/themed-reports/page',
        'app/destiny-matrix/viewer/page',
      ]);
    });
  });
  ...
  describe('Life Prediction Pages (2)', () => {
    it('should have life prediction pages', () => {
      assertPages([
        'app/life-prediction/page',
        'app/life-prediction/result/page',
      ]);
    });
  });

  describe('My Journey Pages (4)', () => {
    it('should have my journey pages', () => {
      assertPages([
        'app/myjourney/page',
        'app/myjourney/circle/page',
        'app/myjourney/history/page',
        'app/myjourney/profile/page',
      ]);
    });
  });
  ...
  describe('Policy Pages (3)', () => {
    it('should have policy pages', () => {
      assertPages([
        'app/policy/privacy/page',
        'app/policy/refund/page',
        'app/policy/terms/page',
      ]);
    });
  });
  ...
  describe('Pages Summary', () => {
    it('should have all page categories', () => {
      const categories = [
        'main', 'admin', 'astrology', 'auth', 'blog', 'calendar',
        'community', 'compatibility', 'contact', 'destiny-map',
        'destiny-match', 'destiny-matrix', 'destiny-pal', 'dream',
        'faq', 'iching', 'icp', 'life-prediction', 'myjourney',
        'notifications', 'numerology', 'personality', 'policy',
        'pricing', 'profile', 'saju', 'success', 'tarot', 'test',
      ];
