...
describe('Saju Profile API - GET /api/me/saju', () => {
  ...
  describe('Middleware Configuration', () => {
    ...
    it.skip('should have createAuthenticatedGuard config in the route file - verified by code inspection', () => {
      // The route file calls createAuthenticatedGuard at module-level (line 149)
      // This cannot be tested at runtime because mocks are set up after module initialization
    })
