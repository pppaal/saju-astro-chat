...
describe('GET /api/health/redis', () => {
  ...
  it('should return healthy status when Redis is available', async () => {
    ...
    // Route only exposes upstash and memory for rateLimit, not redis
    expect(data.data.rateLimit.upstash).toBe(false)
  })
  ...
  it('should include rate limit information', async () => {
    ...
    // Route only exposes upstash and memory for rateLimit
