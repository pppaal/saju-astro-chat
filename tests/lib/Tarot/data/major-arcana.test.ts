...
describe('Major Arcana Cards', () => {
  ...
  describe('Specific Card Validations', () => {
    ...
    it('The Magician (1) has manifestation theme', () => {
      ...
      expect(magician.upright.keywords.some((k) => k.toLowerCase().includes('manifestation'))).toBe(
        true
      )
    })
    ...
    it('Death (13) has transformation theme', () => {
      ...
      if (death) {
        const hasTransformTheme =
          death.upright.meaning.toLowerCase().includes('transform') ||
    ...
    it('The World (21) has completion theme', () => {
      ...
      const hasCompletionTheme =
        world.upright.meaning.toLowerCase().includes('complet') ||
