...
describe('invalidateClientCaches', () => {
  ...
  describe('Error Handling - Partial Failures', () => {
    it('should catch error from first cache and continue', async () => {
      ...
      // Assert
      expect(logger.warn).toHaveBeenCalledWith('[invalidateClientCaches] Partial failure:', error)
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle null/undefined errors', async () => {
      ...
      // Assert
      expect(logger.warn).toHaveBeenCalledWith('[invalidateClientCaches] Partial failure:', null)
    })
  })
  ...
  describe('Logging Verification', () => {
    it('should log with correct message format on success', async () => {
      ...
      expect(logger.info).toHaveBeenCalledWith(expect.stringContaining('[invalidateClientCaches]'))
      expect(logger.info).toHaveBeenCalledWith(expect.stringContaining('All client caches cleared'))
    })
    ...
    it('should log with correct format on error', async () => {
      ...
      expect(logger.warn).toHaveBeenCalledWith(expect.stringContaining('Partial failure'), error)
    })
