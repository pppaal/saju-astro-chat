...
import {
  findAspects as baseFind,
  findNatalAspects as baseFindNatal,
} from '@/lib/astrology/foundation/aspects'
...
describe('aspectsPlus', () => {
  ...
  const mockTransitChart: Chart = {
    planets: [{ name: 'Mars', lon: 150, lat: 0, speed: 0.5 }],
    houses: [],
  }
  ...
  describe('findAspectsPlus', () => {
    ...
    it('should preserve base rule overrides', () => {
      ...
      findAspectsPlus(mockNatalChart, mockTransitChart, { maxResults: 100, orbs: { default: 3.0 } })
