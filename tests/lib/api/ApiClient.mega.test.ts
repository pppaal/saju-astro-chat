...
class ApiClientTestBuilder {
   ...
   */
  static expectFetchCalledWith(url: string, expectedOptions: Partial<RequestInit>): void {
   ...
   */
  static expectHeadersContain(url: string, headerKey: string, headerValue: string): void {
   ...
   */
  static expectHeadersNotContain(url: string, headerKey: string): void {
    expect(fetch).toHaveBeenCalledWith(
      url,
      expect.objectContaining({
...
describe('ApiClient MEGA - POST requests', () => {
  ...
  it('should make successful POST request', async () => {
    ApiClientTestBuilder.mockFetchWith(createMockResponse({ data: { result: 'success' } }))
...
describe('ApiClient MEGA - postStream', () => {
  ...
  it('should throw on error', async () => {
    ...
    await expect(client.postStream(TEST_CONSTANTS.URLS.STREAM_PATH, {})).rejects.toThrow(
      'Stream error'
    )
  })
