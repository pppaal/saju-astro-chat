...
describe('validator MEGA - LongitudeSchema', () => {
  describe('Valid longitudes', () => {
    it('should accept valid range (-180 to 180)', () => {
      ...
      expect(LongitudeSchema.safeParse(126.9780).success).toBe(true);
      expect(LongitudeSchema.safeParse(-74.0060).success).toBe(true);
...
describe('validator MEGA - BirthDataSchema', () => {
  ...
  describe('Invalid birth data', () => {
    it('should reject missing required fields', () => {
      ...
      expect(BirthDataSchema.safeParse({
        birthDate: '1990-06-15',
      }).success).toBe(false);
    });
...
describe('validator MEGA - PaginationSchema', () => {
  describe('Valid pagination', () => {
    it('should accept valid page and limit', () => {
      ...
      expect(PaginationSchema.safeParse({ page: 5, limit: 50 }).success).toBe(true);
    });

    it('should have minimum values', () => {
      expect(PaginationSchema.safeParse({ page: 1, limit: 1 }).success).toBe(true);
    });
  });
  ...
  describe('Invalid pagination', () => {
    it('should reject page less than 1', () => {
      ...
      expect(PaginationSchema.safeParse({ page: -1, limit: 10 }).success).toBe(false);
    });
