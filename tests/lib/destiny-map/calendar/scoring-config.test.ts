...
describe('scoring-config', () => {
  ...
  describe('SOLAR_RETURN_SCORES', () => {
    ...
    it('should have decreasing bonus with distance from birthday', () => {
      expect(SOLAR_RETURN_SCORES.exactBirthday).toBeGreaterThan(
        SOLAR_RETURN_SCORES.nearBirthday1
      );
      expect(SOLAR_RETURN_SCORES.nearBirthday1).toBeGreaterThan(
        SOLAR_RETURN_SCORES.nearBirthday3
      );
      expect(SOLAR_RETURN_SCORES.nearBirthday3).toBeGreaterThan(
        SOLAR_RETURN_SCORES.nearBirthday7
      );
    });
