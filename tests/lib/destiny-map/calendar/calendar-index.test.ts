...
describe('Destiny Calendar Module Exports', () => {
  ...
  describe('Saju Analysis exports', () => {
    ...
    it('should export scoreYongsinFitForDate', async () => {
      const { scoreYongsinFitForDate } = await import('@/lib/destiny-map/calendar')
      expect(scoreYongsinFitForDate).toBeDefined()
      expect(typeof scoreYongsinFitForDate).toBe('function')
    })

    it('should export scoreGeokgukFitForDate', async () => {
      const { scoreGeokgukFitForDate } = await import('@/lib/destiny-map/calendar')
      expect(scoreGeokgukFitForDate).toBeDefined()
