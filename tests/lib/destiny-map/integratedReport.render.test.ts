...
vi.mock('@/components/destiny-map/charts/integrated/IntegratedReport.module.css', () => ({
...
describe('통합 리포트 — 정적 HTML 렌더', () => {
  it('실데이터로 HTML 파일 생성', async () => {
    ...
    ctx.input = { ...(ctx.input as object), name: '내담자', gender: 'female', place: '대한민국 서울', timeZone: 'Asia/Seoul (UTC+9)', isoUTC: '1992-03-15T00:20:00Z' }
    ...
    const cssPath = resolve(__dirname, '../../../src/components/destiny-map/charts/integrated/IntegratedReport.module.css')
