...
describe('Destiny Map Calendar - Astrology Analysis', () => {
  ...
  it('should export getRetrogradePlanetsForDate function', async () => {
    const { getRetrogradePlanetsForDate } =
      await import('@/lib/destiny-map/calendar/astrology-analysis')
...
describe('Destiny Map Calendar - Saju Analysis', () => {
  ...
  it('should export scoreYongsinFitForDate function', async () => {
    const { scoreYongsinFitForDate } = await import('@/lib/destiny-map/calendar/saju-analysis')

    expect(typeof scoreYongsinFitForDate).toBe('function')
  })

  it('should export scoreGeokgukFitForDate function', async () => {
    const { scoreGeokgukFitForDate } = await import('@/lib/destiny-map/calendar/saju-analysis')

    expect(typeof scoreGeokgukFitForDate).toBe('function')
  })
...
describe('Destiny Map Calendar - Category Scoring', () => {
  it('should export calculateAreaScoresForCategories function', async () => {
    const { calculateAreaScoresForCategories } =
      await import('@/lib/destiny-map/calendar/category-scoring')
...
describe('Destiny Map Calendar - Profile Factory', () => {
  ...
  it('should export calculateSajuProfileFromBirthDate function', async () => {
    const { calculateSajuProfileFromBirthDate } =
      await import('@/lib/destiny-map/calendar/profile-factory')
  ...
  it('should export calculateAstroProfileFromBirthDate function', async () => {
    const { calculateAstroProfileFromBirthDate } =
      await import('@/lib/destiny-map/calendar/profile-factory')
