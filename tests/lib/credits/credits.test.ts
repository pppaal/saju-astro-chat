...
describe('PLAN_CONFIG', () => {
  ...
  describe('plan progression', () => {
    ...
    it('compatibility limit increases with plan tier', () => {
      expect(PLAN_CONFIG.free.compatibilityLimit).toBeLessThan(
        PLAN_CONFIG.starter.compatibilityLimit
      )
      expect(PLAN_CONFIG.starter.compatibilityLimit).toBeLessThan(
        PLAN_CONFIG.pro.compatibilityLimit
      )
      expect(PLAN_CONFIG.pro.compatibilityLimit).toBeLessThan(
        PLAN_CONFIG.premium.compatibilityLimit
      )
    })
