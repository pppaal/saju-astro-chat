  ...
  return {
    ...
    layer2: {
      cell_2_1: {
        value: 9.0,
        code: 'extreme',
        source: { sajuFactor: '식신', astroFactor: 'Venus' },
      },
      cell_2_2: {
        value: 3.0,
        code: 'clash',
        source: { sajuFactor: '겁재', astroFactor: 'Saturn' },
      },
    },
  }
}
...
describe('FusionReportGenerator - Overall Score', () => {
  ...
  it('should provide grade description in English', () => {
    ...
    expect(report.overallScore.gradeDescriptionEn).toMatch(
      /harmony|balance|growth|challenge|attention|area|proceed/i
    )
  })
