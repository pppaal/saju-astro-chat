...
describe('astrologyengine (destiny-map)', () => {
  ...
  describe('house determination', () => {
    function getHouseFromLongitude(longitude: number, cusps: number[]): number {
  ...
  describe('summary generation', () => {
    ...
    it('should generate complete summary', () => {
      ...
      const summary = generateSummary('John', planets, 'Leo', 'Taurus', 'Earth', '갑 (목)')
    ...
    it('should omit name if not provided', () => {
      ...
      const summary = generateSummary(undefined, planets, 'Virgo', 'Gemini', 'Fire', '병 (화)')
    ...
    it('should omit dominant element if not provided', () => {
      ...
      const summary = generateSummary('Jane', planets, 'Cancer', 'Pisces', undefined, '임 (수)')
