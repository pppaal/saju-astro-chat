  ...
  describe('formatCityForDropdown', () => {
    describe('English locale', () => {
      ...
      it('should use country code when full name not available', () => {
        expect(formatCityForDropdown('Tokyo', 'ZZ', 'en')).toBe('Tokyo, ZZ')
        expect(formatCityForDropdown('Paris', 'YY', 'en')).toBe('Paris, YY')
      })
      ...
      it('should handle lowercase country codes', () => {
        expect(formatCityForDropdown('Seoul', 'kr', 'en')).toBe('Seoul, South Korea')
        expect(formatCityForDropdown('Tokyo', 'jp', 'en')).toBe('Tokyo, Japan')
      })
    ...
    describe('default locale', () => {
      it('should default to English when no locale specified', () => {
        ...
        expect(formatCityForDropdown('Tokyo', 'JP')).toBe('Tokyo, Japan')
      })
    })
  })
