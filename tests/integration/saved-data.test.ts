  ...
  describe("Saved Person", () => {
    ...
    it("retrieves persons by relationship", async () => {
      ...
      await testPrisma.savedPerson.create({
        data: { userId: user.id, name: "Person 1", relationship: "friend", birthDate: "1990-01-01", gender: "male" },
      });
      await testPrisma.savedPerson.create({
        data: { userId: user.id, name: "Person 2", relationship: "family", birthDate: "1985-01-01", gender: "female" },
      });
      await testPrisma.savedPerson.create({
        data: { userId: user.id, name: "Person 3", relationship: "friend", birthDate: "1992-01-01", gender: "male" },
      });
