...
describe('Saju Analysis Integration', () => {
  ...
  describe('Full Saju Analysis Pipeline', () => {
    ...
    it('should generate personality report from Saju analysis', async () => {
      ...
      const sajuResult = calculateSajuData('1985-03-20', '10:00', 'female', 'solar', 'Asia/Seoul')
    ...
    it('should handle different birth times consistently', async () => {
      const morning = calculateSajuData('1990-01-01', '06:00', 'male', 'solar', 'Asia/Seoul')

      const evening = calculateSajuData('1990-01-01', '18:00', 'male', 'solar', 'Asia/Seoul')
    ...
    it('should handle leap month correctly', async () => {
      const result = calculateSajuData('2020-04-15', '12:00', 'female', 'lunar', 'Asia/Seoul', true)
    ...
    it('should analyze different genders with same birth data', async () => {
      const male = calculateSajuData('1995-06-10', '15:30', 'male', 'solar', 'Asia/Seoul')
      const female = calculateSajuData('1995-06-10', '15:30', 'female', 'solar', 'Asia/Seoul')
  ...
  describe('Saju Data Persistence', () => {
    it('should save and retrieve Saju reading', async () => {
      ...
      const sajuResult = calculateSajuData('1992-08-25', '09:15', 'male', 'solar', 'Asia/Seoul')
  ...
  describe('Saju Edge Cases', () => {
    it('should handle year boundaries correctly', async () => {
      const newYear = calculateSajuData('2000-01-01', '00:00', 'male', 'solar', 'Asia/Seoul')

      const oldYear = calculateSajuData('1999-12-31', '23:59', 'male', 'solar', 'Asia/Seoul')

      expect(newYear.yearPillar).not.toEqual(oldYear.yearPillar)
    })

    it('should handle early morning hours (子時)', async () => {
      const midnight = calculateSajuData('2000-06-15', '00:30', 'female', 'solar', 'Asia/Seoul')
    ...
    it('should validate input data ranges', async () => {
      const validResult = calculateSajuData('1990-12-31', '23:59', 'male', 'solar', 'Asia/Seoul')
