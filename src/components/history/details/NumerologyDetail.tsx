import type { NumerologyContent } from '@/app/myjourney/history/lib/types';
import styles from './DetailModal.module.css';

type NumerologyDetailProps = {
  detail: NumerologyContent;
};

export function NumerologyDetail({ detail }: NumerologyDetailProps) {
  return (
