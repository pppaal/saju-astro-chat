import type { TarotContent } from '@/app/myjourney/history/lib/types';
import { formatDate } from '@/app/myjourney/history/lib/helpers';
...
export function TarotDetail({ detail, recordDate }: TarotDetailProps) {
  return (
