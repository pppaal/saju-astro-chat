import type { PersonalityCompatibilityContent } from '@/app/myjourney/history/lib/types';
import styles from './DetailModal.module.css';

type CompatibilityDetailProps = {
  detail: PersonalityCompatibilityContent;
};

export function CompatibilityDetail({ detail }: CompatibilityDetailProps) {
  return (
