...
const CompatibilityFreeReport = memo(function CompatibilityFreeReport({
  persons,
  person1Saju,
  person2Saju,
  person1Astro,
  ...
  const analysisData = useMemo(() => {
    ...
    const buildSajuProfile = (saju: SajuRawData | null | undefined): SajuProfile | null => {
      ...
      const dayMasterYinYang = saju?.dayMaster?.yin_yang || saju?.dayMaster?.yinYang || '양'

      return {
        dayMaster: {
          name: dayMasterName,
          element: dayMasterElement as import('@/lib/Saju/foundation/types').FiveElement,
...
export default CompatibilityFreeReport
