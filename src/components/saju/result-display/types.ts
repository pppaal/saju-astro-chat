// src/components/saju/result-display/types.ts

import type { DaeunData, YeonunData, WolunData, IljinData, PillarData, DayMaster } from '../../../lib/Saju';
...
export type { DaeunData, YeonunData, WolunData, IljinData, PillarData, DayMaster };
