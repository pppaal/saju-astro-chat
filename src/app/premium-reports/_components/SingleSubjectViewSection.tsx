      ...
      <ReportSurfaceSection title="단일 해석 뷰" eyebrow="Single Subject View" tone="cyan">
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-3">
          <article className="rounded-[22px] border border-white/10 bg-[#090f1b]/88 p-5">
            ...
            <p className="mt-3 text-[15px] leading-[1.7] text-slate-200/95">{view.structureAxis.thesis}</p>
          ...
          <article className="rounded-[22px] border border-white/10 bg-[#090f1b]/88 p-5">
            ...
            <p className="mt-3 text-[15px] leading-[1.7] text-slate-200/95">{view.actionAxis.whyThisFirst}</p>
          ...
          <article className="rounded-[22px] border border-white/10 bg-[#090f1b]/88 p-5">
            ...
            <p className="mt-3 text-[15px] leading-[1.7] text-slate-200/95">{view.riskAxis.warning}</p>
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
          <article className="rounded-[22px] border border-white/10 bg-[#090f1b]/88 p-5">
            ...
            {view.timingState.whyNow && (
              <p className="mt-3 text-[15px] leading-[1.7] text-slate-200/95">{view.timingState.whyNow}</p>
            )}
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              {view.timingState.windows.map((window) => (
                ...
                >
                  ...
                  <p className="mt-3 text-[15px] leading-[1.7] text-slate-200/95">{window.summary}</p>
                </div>
              ))}
            </div>
          </article>
            ...
            <div className="mt-4 space-y-3">
              {view.competingPressures.slice(0, 4).map((pressure) => (
                ...
                >
                  ...
                  <p className="mt-2 text-[15px] leading-[1.7] text-slate-200/95">{pressure.summary}</p>
                  {pressure.nextWindow && (
