...
import { LAYERS, LEVEL_INFO, totalCells } from './matrixData';
import type { MatrixResult, PersonalInsight, LayerCard } from './matrixData';
    ...
    >
      ...
      >
        <button
          ...
          onClick={() => onGoToLayer(activeIndex - 1)}
