    ...
    async (e: React.FormEvent) => {
      ...
      if (!form.birthDate || !form.birthTime || !form.city) {
        dispatch({
          type: 'SET_FIELD',
          field: 'cityErr',
          value: t('error.allFieldsRequired') || '⚠️ All fields are required',
        })
        return
      }
      if (!form.selectedCity || !form.selectedCity.lat || !form.selectedCity.lon) {
        dispatch({
          type: 'SET_FIELD',
          field: 'cityErr',
          value: t('error.selectValidCity') || '⚠️ Please select a valid city from the list',
        })
        return
      }
        ...
        <div className={styles.card}>
          ...
          <form onSubmit={onSubmit} className={styles.form}>
            ...
            <div className={styles.grid2}>
              ...
              <div className={styles.field}>
                ...
                <div className={styles.genderSelectWrapper}>
                  ...
                  >
                    <span className={styles.genderIcon}>{form.gender === 'Male' ? '♂' : '♀'}</span>
            ...
            <button className={styles.submitButton} type="submit">
              <span className={styles.buttonText}>{t('app.analyze') || 'Begin Your Journey'}</span>
