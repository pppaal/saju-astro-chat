    ...
    <div className={styles.resultCard}>
      ...
      <div className={styles.resultCardHeader}>
        ...
        <h3 className={styles.resultCardTitle}>
          {t('compatibilityPage.pairwiseMatrix', '1:1 ?? ??')} ({pairwiseMatrix.length}?)
        </h3>
      </div>
            ...
            <div key={idx} className={styles.pairItem}>
              <div className={styles.pairHeader}>
                ...
                {pair.score !== undefined && (
                  <span className={styles.pairScore}>{pair.score}?</span>
                )}
              </div>
              {pair.summary && (
              ...
              <div className={styles.pairDetails}>
                <span className={styles.pairSaju}>?? {pair.saju}</span>
