...
interface SubmitButtonProps {
  ...
  /** When true, the submit kicks off the chat counselor instead of the analysis report. */
  toCounselor?: boolean
}
      ...
      <button type="submit" disabled={isLoading} className={styles.submitButton}>
        ...
        {isLoading ? (
          <>
            ...
            {toCounselor
              ? t('compatibilityPage.startingCounselor', 'Starting counselor…')
              : t('compatibilityPage.calculating', 'Calculating...')}
          </>
        ) : toCounselor ? (
          t('compatibilityPage.startCounselor', 'Start Counselor Chat')
        ) : (
