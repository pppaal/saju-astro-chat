...
export default function DestinyMatchError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error('Destiny Match error:', {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="text-center max-w-md" role="alert">
        ...
        <h1 className="text-2xl font-bold text-white mb-3">매칭 오류</h1>
        <p className="text-gray-400 mb-6">
          매칭 페이지를 불러오는 중 오류가 발생했습니다. 다시 시도해 주세요.
        </p>
