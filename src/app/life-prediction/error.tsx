...
export default function LifePredictionError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error("Life Prediction error:", { message: error.message, digest: error.digest, stack: error.stack });
  }, [error]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="text-center max-w-md" role="alert">
        ...
        <h1 className="text-2xl font-bold text-white mb-3">예측 오류</h1>
        <p className="text-gray-400 mb-6">
          인생 예측을 불러오는 중 오류가 발생했습니다. 다시 시도해 주세요.
        </p>
