...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    qKo: '크레딧은 어떻게 작동하나요?',
    a: 'Credits are used for premium AI readings and detailed reports. Each service has a credit cost shown upfront. Purchased credit packs are valid for 3 months from purchase date. Premium subscribers receive monthly credits by plan.',
    aKo: '크레딧은 프리미엄 AI 리딩 및 상세 리포트에 사용됩니다. 각 서비스마다 사전에 표시된 크레딧 비용이 있습니다. 구매한 크레딧 팩은 구매일로부터 3개월간 유효합니다. 프리미엄 구독자는 플랜에 따라 월간 크레딧을 받습니다.',
  },
  {
    category: 'payment',
    icon: '🔁',
