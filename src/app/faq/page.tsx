...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    qKo: "크레딧은 어떻게 작동하나요?",
    a: "Credits are used for premium AI readings and detailed reports. Each service has a credit cost displayed upfront. Credits never expire and can be purchased in packs. Premium subscribers receive bonus credits monthly.",
    aKo: "크레딧은 프리미엄 AI 리딩 및 상세 리포트에 사용됩니다. 각 서비스마다 미리 표시된 크레딧 비용이 있습니다. 크레딧은 절대 만료되지 않으며 팩으로 구매할 수 있습니다. 프리미엄 구독자는 매월 보너스 크레딧을 받습니다.",
  },
  {
    category: 'payment',
    icon: "🔁",
