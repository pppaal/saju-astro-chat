      ...
      <div className={styles.page}>
        <article className={styles.card}>
          ...
          <p className={styles.subtitle}>
            destinypal 은 사용자의 사주 본명(생년월일·시·출생지) 을 기반으로
            평생·연·월·일·대운 5 tier 흐름을 짜드립니다. 먼저 로그인하여
            저장된 본명을 불러오세요.
          </p>
          ...
          <div className={styles.actions}>
            ...
            <Link href="/destinypal/preview" className={styles.btnSecondary}>
              1995 sample 미리보기
            </Link>
          </div>

          <p className={styles.note}>
            샘플은 1995-02-09 06:40 서울 출생 (남) 기준 — 디자인과 정보
            구조를 그대로 둘러볼 수 있습니다.
          </p>
        </article>
      </div>
    ...
    <div className={styles.page}>
      <article className={styles.card}>
        ...
        <p className={styles.subtitle}>
          ...
          <strong> 출생 시각</strong>, <strong>출생지 좌표</strong> 가 필요합니다.
          프로필에서 한 번만 저장해두면 destinypal 의 모든 tier 가 자동으로
          연결됩니다.
        </p>
        ...
        <p className={styles.note}>
          본명은 진태양시(진경도) 보정에 사용되며, destinypal·calendar·counselor
          전체에서 동일하게 재사용됩니다.
        </p>
      </article>
    </div>
