...
const plans: Plan[] = [
  {
    ...
    readings: 1,
    features: [
      { textKey: "aiReadings1", included: true },
      { textKey: "basicSaju", included: true },
      { textKey: "oneCardTarot", included: true },
      { textKey: "dailyFortune", included: true },
      { textKey: "history7", included: true },
      { textKey: "compatibility", included: false },
      { textKey: "followUp", included: false },
  ...
  },
  {
    ...
    readings: 10,
    features: [
      { textKey: "aiReadings10", included: true },
      { textKey: "detailedSaju", included: true },
      { textKey: "threeCardTarot", included: true },
      { textKey: "compatibilityCount2", included: true },
      { textKey: "followUpCount2", included: true },
      { textKey: "history30", included: true },
      { textKey: "adFree", included: true },
      { textKey: "pdfReport", included: false },
    ],
  ...
  },
  {
    ...
    popular: true,
    features: [
      { textKey: "aiReadings30", included: true },
      { textKey: "sajuFortune", included: true },
      { textKey: "allTarotSpreads", included: true },
      { textKey: "compatibilityCount5", included: true },
      { textKey: "followUpCount5", included: true },
      { textKey: "history90", included: true },
      { textKey: "pdfDownload", included: true },
      { textKey: "adFree", included: true },
    ],
  ...
  },
  {
    ...
    readings: 50,
    features: [
      { textKey: "aiReadings50", included: true },
      { textKey: "fullSaju", included: true },
      { textKey: "allTarotSpreads", included: true },
      { textKey: "compatibilityCount10", included: true },
      { textKey: "followUpCount10", included: true },
      { textKey: "history1year", included: true },
      { textKey: "pdfDownload", included: true },
