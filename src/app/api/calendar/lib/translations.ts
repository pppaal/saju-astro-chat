...
export const SAJU_FACTOR_TRANSLATIONS: Record<string, { ko: string; en: string }> = {
  stemBijeon: {
    ko: "자기 흐름이 두텁게 차오르는 자리예요. 회의·미팅에서 말이 부푸는 흐름을 타기 좋아요. 같은 자리 동료와는 흐름이 엇갈리기 쉬우니 너무 밀지는 마세요.",
  ...
  stemInseong: {
    ko: "지지(支持)의 흐름이 한쪽에서 들어오는 자리예요. 막혔던 답이 누군가 한마디에 풀리기 쉬워요. 선배·상사에게 물어보는 흐름을 놓치지 마세요.",
  ...
  stemJaeseong: {
    ko: "재정적 흐름이 잠깐 두터워지는 구간이에요. 미뤘던 돈 결정이 술술 미끄러집니다. 할인 품목 체크·재테크 결정 흘려보내기 좋아요.",
  ...
  stemSiksang: {
    ko: "표현의 흐름이 활짝 열리는 날이에요. 기획서·프레젠테이션 준비가 부드럽게 흘러갑니다. 평소 막혀 있던 제안도 오늘은 트인 자리로 내보내 보세요.",
  ...
  stemGwansal: {
    ko: "외부 압력이 위에서 가라앉아 들어오는 날이에요. 큰 실수만 피하면 흐름은 잦아듭니다. 튀는 흐름은 접어두고 맡은 일을 조용히 가져가세요.",
  ...
  branchSamhap: {
    ko: "세 흐름이 한 점에 모이는 드문 자리예요. 흩어져 있던 일이 하나로 수렴하는 흐름이라, 계약 사인·이직 면접·중요한 미팅을 이 흐름에 얹어 보내세요.",
  ...
  branchSamhapNegative: {
    ko: "흐름이 갈라지고 어긋나는 자리예요. 오늘 새로 띄운 일은 나중에 엉키기 쉬우니, 급하지 않다면 며칠 뒤로 흘려보내세요. 마무리 쪽에 무게를 두세요.",
  ...
  branchYukhap: {
    ko: "두 흐름이 부드럽게 맞닿는 자리예요. 새 사람과 흐름이 자연스럽게 겹치니, 소개팅·네트워킹·동창 모임에서 인연 한 줄이 들어찰 수 있어요.",
  ...
  branchChung: {
    ko: "흐름이 정면으로 부딪쳐 흔들리는 자리예요. 가까운 사람과의 대화가 엉키기 쉬우니 예민한 주제는 잠가 두세요. 운전대 잡을 때도 평소보다 속도를 늦추세요.",
  ...
  branchXing: {
    ko: "흐름이 어긋나 작은 틈이 벌어지는 자리예요. 서류·오타가 그 틈으로 새 나가기 쉬우니 보내기 전 한 번 더 살펴 두세요. 계약서는 줄 사이까지 읽어 두세요.",
    en: "The current misaligns and small gaps open up. Document slips and typos leak through those gaps — sweep the page once more before sending. Read contracts between the lines."
  },
  branchHai: {
  ...
  // 천을귀인(天乙貴人) - 가장 좋은 귀인
  cheoneulGwiin: {
    ko: "⭐ 귀인의 흐름이 두텁게 들어차는 1년 몇 안 되는 자리예요. 막혀 있던 길이 누군가의 손끝에서 트입니다. 면접·계약·프로포즈·개업 일정을 오늘 흐름 위에 얹으세요.",
  ...
  // ============================================================
  geokguk_정관격: {
    ko: "👔 정관격의 흐름이 본명에 두텁게 깔린 분이에요. 규율과 책임, 명예의 흐름이 본명을 잡아갑니다. 공식적인 자리·승진·직함에 무게를 얹어 가져가 보세요.",
  ...
  geokguk_식신격: {
    ko: "🎨 본명 흐름의 무게가 식신격에 실리는 분이에요. 창작·표현·여유의 흐름이 줄기를 이루고 있어요. 좋아하는 한 가지에 시간을 얹어 결과를 흘려보내세요.",
  ...
  geokguk_편재격: {
    ko: "💰 본명 흐름의 무게가 편재격에 실리는 분이에요. 사업과 활동, 큰 흐름이 줄기를 이룹니다. 한 번에 크게 들어오는 기회 앞에서 망설이지 말고 손을 펼치세요.",
  ...
  geokguk_종왕격: {
    ko: "👑 종왕격의 흐름이 본명에 새겨져 있는 분이에요. 자기 결단을 강하게 끌고 가는 줄기가 박혀 있어요. 독립과 자기 주도로 길을 풀어가 보세요.",
  ...
  geokguk_종살격: {
    ko: "🛡️ 본명 흐름의 무게가 종살격에 실리는 분이에요. 강한 관살에 흐름을 맡기는 줄기가 박혀 있어요. 권위와 정면으로 맞서기보다 그 흐름을 타고 올라가 보세요.",
  ...
  geokguk_갑기화토격: {
    ko: "🌍 본명 흐름의 무게가 갑기화토격에 실리는 분이에요. 천간합이 토로 화하는 흐름이 줄기를 이루는 드문 사주예요. 안정과 신뢰를 길게 가져가며 길을 열어 보세요.",
  ...
  geokguk_곡직격: {
    ko: "🌳 본명 흐름의 무게가 곡직격에 실리는 분이에요. 목 기운으로 꽉 찬 줄기가 박힌 특수격국입니다. 위로 곧게 뻗어 올라가는 한 가지 목표를 길게 가져가 보세요.",
  ...
  branchBanghap: {
    ko: "계절 흐름이 본명 지지와 한 점에 모이는 자리예요. 큰 흐름이 자연스럽게 함께 흘러갑니다. 같은 흐름을 타는 사람과 손을 맞추면 추진력이 더 두툼해져요.",
  ...
  branchPa: {
    ko: "흐름이 작게 깨지는 자리예요. 큰 일은 미루고 작은 마무리부터 챙기세요. 서명·발표는 며칠 뒤 흐름이 다시 매끄러워질 때 흘려보내세요.",
    en: "The current breaks in small places today. Hold big moves and start with small wraps. Let signatures and presentations drift to a day when the surface smooths out again."
  },
  branchHaeRelation: {
    ko: "흐름이 서로 미세하게 어긋나는 자리예요. 손에 잡힌 일을 우선 단단히 다지세요. 새로 띄우는 흐름은 옆 자리에서 막히기 쉬우니 미루는 편이 안전해요.",
  ...
  iljinBanghap: {
    ko: "🌅 오늘은 계절 흐름이 본명 지지와 한 점에 모이는 자리예요. 큰 흐름이 자연스럽게 함께 흘러가니, 같은 흐름을 타는 동료·팀과 보폭을 맞추면 추진력이 한층 두터워져요.",
  ...
  iljinPa: {
    ko: "🌅 오늘은 흐름이 작게 깨지는 자리예요. 큰 일은 미루고 작은 마무리부터 챙기세요. 서명·발표는 흐름이 다시 매끄러워질 며칠 뒤로 흘려보내세요.",
    en: "🌅 The current breaks in small places today. Hold big moves and start with small wraps. Let signatures and presentations drift to a day when the surface smooths out again."
  },
  iljinHaeRelation: {
    ko: "🌅 오늘은 흐름이 서로 미세하게 어긋나는 자리예요. 손에 잡힌 일을 우선 단단히 다지세요. 새로 띄우는 흐름은 옆 자리에서 막히기 쉬우니 미루는 편이 안전해요.",
    en: "🌅 Two currents misalign by a hair today. Lock down what's already in hand first. New launches snag on the next current over — safer to hold them back."
  },
};
...
export const ASTRO_FACTOR_TRANSLATIONS: Record<string, { ko: string; en: string }> = {
  ...
  // 달 위상 (실제 계산 기반)
  lunarNewMoon: {
    ko: "🌑 흐름이 한 번 비워졌다가 새로 차오르기 시작하는 자리예요. 다이어트·금연·새 프로젝트·새 습관을 이 비어 있는 흐름 위에 심어 두면 이어가기 쉬워요.",
  ...
  // 세운(歲運) - 연간 운세 영향
  seunBijeon: {
    ko: "📅 올해는 자기 흐름이 한 해 내내 부풀어 오르는 해예요. 자신감과 추진력이 차오르는 만큼 같은 자리에 선 경쟁자도 가까이 들어와요. 협력과 경쟁의 흐름을 번갈아 잡으세요.",
  ...
  seunInseong: {
    ko: "📅 올해는 도움의 흐름이 위쪽에서 한 해 내내 흘러들어요. 멘토·선배·부모의 손길이 자주 닿는 자리이니, 공부·자격증·진학 같은 학습의 흐름에 올라타 보세요.",
  ...
  seunJaeseong: {
    ko: "📅 올해는 재정적 흐름이 두텁게 들어차는 해예요. 수입 줄기가 굵어지거나 재테크 기회가 닿아 올 수 있어요. 큰 돈 결정을 한 해의 흐름 위에 얹기 좋습니다.",
  ...
  seunSiksang: {
    ko: "📅 올해는 표현의 흐름이 한 해 내내 트인 채로 머무는 해예요. 예술·창작·연애의 흐름이 부드럽게 열려 있어요. 재능을 안에 가두지 말고 그 흐름 위로 흘려보내세요.",
  ...
  seunGwansal: {
    ko: "📅 올해는 외부 압력이 위에서 가라앉아 들어오는 해예요. 직장 스트레스와 권위자와의 흐름이 엉키기 쉬우니, 자세를 낮추고 건강 관리의 흐름을 굵게 잡으세요.",
  ...
  seunSamhap: {
    ko: "📅 올해는 세 흐름이 한 점에 모이는 특별한 해예요! 흩어져 있던 길이 한 줄로 수렴하니, 큰 결정·전환·도전을 이 해의 흐름 위에 얹으세요. 인생의 변곡점이 될 수 있어요.",
  ...
  // 월운(月運) - 월간 운세 영향
  wolunBijeon: {
    ko: "📆 이번 달은 자기 흐름이 다시 차오르는 달이에요. 자신감과 추진력이 부풀어 오르니, 새 시작·도전을 이 달의 흐름 위에 얹어 보내세요.",
  ...
  wolunInseong: {
    ko: "📆 이번 달은 지지의 흐름이 위쪽에서 흘러드는 달이에요. 선배·멘토의 한마디가 막힌 곳을 풀어주니, 공부·학습 쪽으로 흐름을 모으세요.",
  ...
  wolunJaeseong: {
    ko: "📆 이번 달은 재정적 흐름이 한 겹 두꺼워지는 달이에요. 수입 줄기가 굵어지고 쇼핑·재테크 기회가 닿아 와요. 돈 결정은 이 달의 흐름에 미끄러뜨려 보내세요.",
  ...
  wolunSiksang: {
    ko: "📆 이번 달은 표현의 흐름이 활짝 열려 있는 달이에요. 예술·창작·연애의 흐름이 부드럽게 흘러요. 자기 표현은 가둬 두지 말고 흐름 따라 내보내세요.",
  ...
  wolunGwansal: {
    ko: "📆 이번 달은 외부 압력이 위에서 가라앉아 들어오는 달이에요. 직장 스트레스와 윗사람과의 흐름이 굳어지기 쉬우니, 자세를 낮추고 흐름을 부드럽게 쥐세요.",
  ...
  wolunSamhap: {
    ko: "📆 이번 달은 세 흐름이 한 점에 모이는 특별한 달이에요! 흩어져 있던 일이 한 줄로 수렴하니, 중요한 결정·계약·새 시작을 이 달의 흐름 위에 얹으세요.",
  ...
  wolunYukhap: {
    ko: "📆 이번 달은 인연의 흐름이 부드럽게 맞닿는 달이에요. 새 만남·소개팅·인맥 확장이 자연스럽게 겹쳐 들어와요. 사람 흐름 따라 기회가 흘러들 수 있어요.",
  ...
  wolunChung: {
    ko: "📆 이번 달은 흐름이 정면으로 부딪쳐 흔들리는 달이에요. 예상 못 한 변화에 자세를 굳히지 말고, 부드럽게 휘는 자세로 흐름을 따라가세요.",
  ...
  // 일진(日辰) - 당일 운세 (가장 중요!)
  iljinBijeon: {
    ko: "🌅 오늘은 자기 흐름이 하루 사이에 부풀어 오르는 자리예요. 자신감과 추진력이 차오르는 만큼 같은 자리 사람과는 흐름이 엇갈리기 쉬워요. 협력과 경쟁의 흐름을 번갈아 잡으세요.",
  ...
  iljinInseong: {
    ko: "🌅 오늘은 지지의 흐름이 위쪽에서 들어오는 자리예요. 선배·멘토의 한마디가 막힌 곳을 풀어주니, 공부·자격증 준비도 이 흐름 위에 올려두기 좋아요.",
  ...
  // ============================================================
  jupiterConjunct: {
    ko: "♃ 목성이 당신의 별자리로 들어와 자리잡는 자리예요. 12년에 한 번 들어차는 확장의 흐름입니다. 새 사업·해외 진출·학업·큰 투자를 이 두툼한 흐름 위에 얹어 보내세요. 이 흐름은 놓치면 다시 차오르기까지 오래 걸려요.",
  ...
  asteroidCeresConjunct: {
    ko: "🌾 돌봄의 흐름이 차오르는 자리예요. 누군가를 챙기거나 챙김을 받는 흐름이 두텁게 들어차니, 가족·가까운 사람과의 식탁을 오늘 흐름 위에 얹어 보세요. 따뜻한 밥 한 끼가 관계를 굵게 만듭니다.",
  ...
  asteroidCeresTrine: {
    ko: "🌾 돌봄의 흐름이 자연스럽게 흐르는 자리예요. 챙김을 주고받는 흐름이 부드럽게 풀리니, 안부·작은 선물·따뜻한 한 마디가 잘 닿습니다.",
  ...
  asteroidCeresSquare: {
    ko: "🌾 돌봄의 흐름이 어긋나는 자리예요. 챙겨주려는 마음이 부담으로 비치기 쉬우니, 한 발 물러서서 상대의 속도를 기다려 주세요.",
  ...
  asteroidPallasConjunct: {
    ko: "🦉 지혜의 흐름이 차오르는 자리예요. 패턴을 꿰뚫어 보는 흐름이 두텁게 들어차니, 복잡한 자료·전략 문서·기획안을 오늘 흐름 위에 얹어 보세요.",
  ...
  asteroidPallasTrine: {
    ko: "🦉 지혜의 흐름이 자연스럽게 흐르는 자리예요. 큰 그림과 디테일 사이를 부드럽게 오가는 흐름이라, 전략적인 결정을 이 흐름 위로 흘려 보내세요.",
  ...
  asteroidPallasSquare: {
    ko: "🦉 지혜의 흐름이 갈라지는 자리예요. 너무 머리로만 가져가면 답이 굳어지니, 직관을 한 번 끼워 흐름을 풀어 보세요.",
  ...
  asteroidJunoConjunct: {
    ko: "💍 관계의 흐름이 단단해지는 자리예요. 약속·헌신의 흐름이 두텁게 들어차니, 중요한 대화·계약·결혼 약속을 오늘 흐름 위에 얹어 보세요.",
  ...
  asteroidJunoTrine: {
    ko: "💍 관계의 흐름이 자연스럽게 흐르는 자리예요. 파트너와 호흡이 잘 맞물려 굴러가니, 같이 결정해야 할 일 한 가지를 오늘 흐름 위에 얹어 보세요.",
  ...
  asteroidJunoSquare: {
    ko: "💍 관계의 흐름이 부딪치는 자리예요. 평등과 균형의 흐름이 흔들리니, 일방적으로 끌고 가지 말고 상대 입장을 한 번 더 살펴 주세요.",
  ...
  asteroidVestaConjunct: {
    ko: "🕯️ 집중의 흐름이 두텁게 모이는 자리예요. 헌신과 몰입의 흐름이 한 점에 박히니, 가장 중요한 한 가지에만 오늘 시간을 얹어 보세요. 작은 불씨도 단단해집니다.",
  ...
  asteroidVestaTrine: {
    ko: "🕯️ 집중의 흐름이 부드럽게 깊어지는 자리예요. 몰입의 흐름이 잔잔히 풀려 작업·연구·수행이 잘 잡힙니다. 오늘은 한 갈래에 오래 머물러 보세요.",
  ...
  asteroidVestaSquare: {
    ko: "🕯️ 집중의 흐름이 갈라지는 자리예요. 한 가지에 너무 매달리면 다른 일이 흐트러지니, 잠깐 빠져나와 다른 흐름도 살피세요.",
  ...
  transitSemisextile: {
    ko: "흐름이 미세하게 조정되는 자리예요. 작은 적응이 필요한 흐름이라 큰 변화 없이 부드럽게 흘려보내세요.",
    en: "A faint adjustment in the current. A subtle adaptation — let things flow without forcing change."
  },
  transitQuincunx: {
    ko: "흐름이 어긋나 조정이 필요한 자리예요. 어색한 흐름이라 무리하지 말고 한 발 물러서서 자세를 다시 맞추세요.",
    en: "Currents misalign and call for adjustment. Don't push — step back and let the current re-align."
  },
  transitQuintile: {
    ko: "재능 흐름이 살아나는 자리예요. 창의 흐름이 부드럽게 열리니 평소 못 꺼내던 아이디어를 펼쳐 보세요.",
    en: "The current of talent stirs. Creativity opens easily — let the ideas you've been holding back come out."
  },
  transitBiquintile: {
    ko: "영감 흐름이 응용되는 자리예요. 떠오른 아이디어를 실제 결과로 연결하기 좋아요.",
    en: "Inspiration translates into application. A good time to turn fresh ideas into deliverables."
  },
  transitSesquiquadrate: {
    ko: "작은 긴장 흐름이 도는 자리예요. 큰 마찰은 없지만 미끄럽지 않으니 속도를 한 단계 늦추세요.",
    en: "A faint friction runs through the current. Nothing breaks, but the flow catches — dial the speed down a notch."
  },
  // ─── Zodiacal Releasing (Agent 3) ───
  zrSpiritL1: {
    ko: "{sign} 흐름이 영혼의 큰 흐름을 이끄는 시기예요. 의도·진로의 흐름이 이 자리에서 다음 챕터로 흘러갑니다.",
    en: "The {sign} current leads the soul's larger flow. Intention and direction shift into the next chapter from here."
  },
  zrFortuneL1: {
    ko: "{sign} 흐름이 몸과 일의 흐름을 차오르게 하는 시기예요. 물질·환경의 흐름이 이 챕터를 통해 부풀어 오릅니다.",
    en: "The {sign} current builds up the body's and work's flow. Material and environmental flow swells through this chapter."
  },
  zrPeak: {
    ko: "흐름이 정점에 모이는 자리예요. 큰 결정 미끄러뜨리기 좋아요. 챕터의 핵심 사건이 이 구간에 박힐 가능성이 높습니다.",
  ...
  zrLoosingOfBond: {
    ko: "흐름이 반대편으로 풀리는 자리예요. 큰 전환 신호로 받아들이세요. 묶여 있던 흐름이 풀리며 다음 챕터의 방향을 미리 보여줍니다.",
    en: "The current loosens toward the opposite side. Read it as a major transition — bound currents release and preview the next chapter's direction."
  },
  // ─── 일식 / 월식 — astro-eclipse Swiss Eph 실시간 (Agent 4) ───
  solarEclipse: {
    ko: "흐름이 가려졌다 다시 차오르는 큰 전환 자리예요. 평소 못 보던 흐름이 잠깐 멈춘 자리에서 새 흐름이 솟습니다.",
    en: "The current is veiled and then swells back — a major transition. A new flow surfaces from the pause."
  },
  lunarEclipse: {
    ko: "흐름이 풀리며 감정 흐름이 정리되는 자리예요. 묵혀둔 마음이 표면으로 떠올라 한꺼번에 비워집니다.",
    en: "The current loosens and the emotional flow clears. Held feelings rise to the surface and empty at once."
  },
  eclipseToNatalPlanet: {
    ko: "본명 {planet} 흐름이 식의 흐름에 직접 닿는 자리예요. 그 영역의 흐름이 평소보다 크게 흔들립니다.",
    en: "The natal {planet} current is touched directly by the eclipse — that domain's flow shakes more than usual."
  },
  // ─── Triplicity / Term / Face dignity (Agent 1) ───
  triplicityMatch: {
    ko: "본명 흐름의 원소가 자연스럽게 받쳐주는 자리예요. 같은 원소끼리 만나 흐름이 두텁게 차오릅니다.",
    en: "The element of the natal current supports today's flow. Current meets current — the flow swells smoothly."
  },
  termMatch: {
    ko: "본명 흐름의 미세한 구획이 흐름을 받쳐주는 자리예요. 작은 받침이 흐름을 정확하게 잡아 줍니다.",
    en: "The fine bounds of the natal current hold the flow steady. A small support keeps the current on its line."
  },
  faceMatch: {
    ko: "본명 흐름의 10도 구획이 살아나는 자리예요. 작은 흐름이 그날의 흐름에 색을 입힙니다.",
    en: "The 10-degree face of the natal current livens up. A small flow colors today's day."
  },
  natalAlmuten: {
    ko: "본명 알무텐 흐름이 두텁게 박혀 있는 시기예요. 평소 흐름이 머무는 자리에서 흐름이 한층 살아납니다.",
    en: "The natal almuten is firmly seated. The current quickens where it usually settles."
  },
  // ─── Midpoint extractor (Agent 2) ───
  midpointSunMoon: {
    ko: "본명 태양·달 중간 흐름이 트랜짓에 직접 닿는 자리예요. 정체성 흐름이 표면으로 차오릅니다.",
    en: "The natal Sun/Moon midpoint is touched by transit — identity flow surfaces."
  },
  midpointVenusMars: {
    ko: "본명 금성·화성 중간 흐름이 살아나는 자리예요. 끌림과 행동의 흐름이 한 점에 모입니다.",
    en: "The Venus/Mars midpoint comes alive — attraction and action converge."
  },
  midpointSunVenus: {
    ko: "본명 태양·금성 중간 흐름이 닿는 자리예요. 사랑 흐름이 자연스럽게 차오릅니다.",
    en: "The Sun/Venus midpoint is touched — love's current rises naturally."
  },
  midpointMercuryVenus: {
    ko: "본명 수성·금성 중간 흐름이 닿는 자리예요. 표현 흐름이 부드럽게 흐릅니다.",
    en: "The Mercury/Venus midpoint is touched — expression flows softly."
  },
  midpointSunMars: {
    ko: "본명 태양·화성 중간 흐름이 닿는 자리예요. 추진력 흐름이 한 점에서 솟아오릅니다.",
    en: "The Sun/Mars midpoint is touched — drive surges at a single point."
  },
  midpointMoonVenus: {
    ko: "본명 달·금성 중간 흐름이 닿는 자리예요. 감정과 호의의 흐름이 같이 차오릅니다.",
    en: "The Moon/Venus midpoint is touched — feeling and warmth swell together."
  },
  midpointSunJupiter: {
    ko: "본명 태양·목성 중간 흐름이 닿는 자리예요. 확장 흐름이 두텁게 흘러듭니다.",
    en: "The Sun/Jupiter midpoint is touched — expansion thickens the current."
  },
  midpointVenusJupiter: {
    ko: "본명 금성·목성 중간 흐름이 닿는 자리예요. 풍요 흐름이 부드럽게 부풉니다.",
    en: "The Venus/Jupiter midpoint is touched — abundance swells gently."
  },
  midpointMarsSaturn: {
    ko: "본명 화성·토성 중간 흐름이 닿는 자리예요. 결단의 흐름이 무겁게 굳어집니다.",
    en: "The Mars/Saturn midpoint is touched — resolve hardens with weight."
  },
  midpointJupiterSaturn: {
    ko: "본명 목성·토성 중간 흐름이 닿는 자리예요. 시간 단위의 큰 흐름이 한 점에 모입니다.",
    en: "The Jupiter/Saturn midpoint is touched — time's larger current gathers at one point."
  },
  // ─── Solar Arc directions (Agent 3) ───
  solarArcSunConjunct: {
    ko: "본명 태양 흐름이 직접 이동해 본명에 닿는 자리예요. 정체성 흐름의 큰 전환이 펼쳐집니다.",
    en: "The arc-driven natal Sun reaches the natal current — a major shift in identity unfolds."
  },
  solarArcSaturnSquare: {
    ko: "본명 토성의 흐름이 본명을 압박하는 자리예요. 책임 흐름이 무거워지는 시기입니다.",
    en: "Solar Arc Saturn presses on the natal current — responsibility weights down."
  },
  solarArcJupiterTrine: {
    ko: "본명 목성 흐름이 본명에 흘러드는 자리예요. 확장 흐름이 자연스럽게 차오릅니다.",
    en: "Solar Arc Jupiter flows into the natal current — expansion swells smoothly."
  },
  solarArcMoonConjunct: {
    ko: "본명 달 흐름이 직접 이동해 본명에 닿는 자리예요. 감정·일상 흐름의 큰 챕터 전환입니다.",
    en: "Solar Arc Moon meets the natal current — a chapter turn in emotion and daily flow."
  },
  solarArcMarsConjunct: {
    ko: "본명 화성 흐름이 본명에 직접 닿는 자리예요. 행동 흐름의 큰 점화 신호입니다.",
    en: "Solar Arc Mars touches the natal current — a major ignition of action."
  },
  solarArcVenusConjunct: {
    ko: "본명 금성 흐름이 본명에 닿는 자리예요. 관계·가치 흐름의 깊은 결합 시기입니다.",
    en: "Solar Arc Venus meets the natal current — a deep binding of relationship and value."
  },
  solarArcDefault: {
    ko: "본명 흐름이 직접 이동해 본명에 닿는 자리예요. 큰 흐름의 줄기가 펼쳐집니다.",
    en: "A natal point arcs into the natal current — the larger trunk unfolds."
  },
  // ─── 진행 행성 어스펙트 (Agent 4) ───
  progSunConjunct: {
    ko: "진행 태양 흐름이 본명 행성에 직접 닿는 자리예요. 정체성 흐름이 새로 빚어지는 시기입니다.",
    en: "Progressed Sun meets a natal planet — identity flow is being newly shaped."
  },
  progSunTrine: {
    ko: "진행 태양 흐름이 본명에 부드럽게 흐르는 자리예요. 정체성 흐름이 자연스럽게 차오릅니다.",
    en: "Progressed Sun flows easily — identity swells naturally."
  },
  progSunSquare: {
    ko: "진행 태양 흐름이 본명에 비스듬히 압박하는 자리예요. 정체성 흐름의 도전 신호입니다.",
    en: "Progressed Sun presses obliquely on natal — a challenge to identity."
  },
  progSunOpposition: {
    ko: "진행 태양 흐름이 본명과 정면으로 만나는 자리예요. 정체성 흐름의 대조 자리입니다.",
    en: "Progressed Sun meets natal head-on — a polarity in identity."
  },
  progMercuryConjunct: {
    ko: "진행 수성 흐름이 본명에 직접 닿는 자리예요. 소통·결정 흐름이 새로 빚어집니다.",
    en: "Progressed Mercury meets natal — communication and decision are reshaped."
  },
  progMercurySquare: {
    ko: "진행 수성 흐름이 본명을 비틀어 만나는 자리예요. 소통 흐름이 어긋나기 쉬워요.",
    en: "Progressed Mercury twists into natal — communication snags easily."
  },
  progVenusConjunct: {
    ko: "진행 금성 흐름이 본명에 닿는 자리예요. 관계·가치 흐름이 새로 차오릅니다.",
    en: "Progressed Venus meets natal — relationship and value swell anew."
  },
  progVenusTrine: {
    ko: "진행 금성 흐름이 본명에 부드럽게 흐르는 자리예요. 관계·가치 흐름이 활짝 열립니다.",
    en: "Progressed Venus flows easily — relationship and value open up."
  },
  progMarsConjunct: {
    ko: "진행 화성 흐름이 본명에 직접 닿는 자리예요. 행동·욕구 흐름이 점화되는 시기입니다.",
    en: "Progressed Mars meets natal — action and drive ignite."
  },
  progMarsOpposition: {
    ko: "진행 화성 흐름이 본명과 정면으로 만나는 자리예요. 행동·결단 흐름의 대치 자리입니다.",
    en: "Progressed Mars meets natal head-on — action squares off."
  },
  // ─── Draconic + Harmonics (Agent 5) ───
  draconicSunConjunct: {
    ko: "영혼 흐름의 태양이 본명에 닿는 자리예요. 깊은 흐름이 표면으로 떠오릅니다.",
    en: "The draconic Sun touches the natal current — a deep flow surfaces."
  },
  draconicMoonConjunct: {
    ko: "영혼 흐름의 달이 본명에 닿는 자리예요. 깊은 감정 흐름이 표면으로 차오릅니다.",
    en: "The draconic Moon touches natal — deep emotional flow rises."
  },
  draconicVenusConjunct: {
    ko: "영혼 흐름의 금성이 본명에 닿는 자리예요. 깊은 관계 흐름이 살아납니다.",
    en: "The draconic Venus touches natal — the deeper current of connection stirs."
  },
  draconicGeneric: {
    ko: "영혼 흐름이 본명 흐름에 닿는 자리예요. 깊은 흐름의 줄기가 표면으로 떠오릅니다.",
    en: "A draconic point touches the natal flow — a soul-level current surfaces."
  },
  harmonic4thMars: {
    ko: "노력 흐름의 화성 패턴이 트랜짓에 활성화되는 자리예요. 도전과 노력의 흐름이 차오릅니다.",
    en: "The H4 Mars pattern is activated — effort and challenge swell."
  },
  harmonic4thGeneric: {
    ko: "노력 흐름 패턴이 활성화되는 자리예요. 도전과 단련의 흐름이 깊어집니다.",
    en: "The H4 effort pattern stirs — challenge and discipline deepen."
  },
  harmonic5thVenus: {
    ko: "재능 흐름의 금성 패턴이 활성화되는 자리예요. 창의 흐름이 두텁게 차오릅니다.",
    en: "The H5 Venus pattern is activated — creativity swells."
  },
  harmonic5thGeneric: {
    ko: "재능 흐름 패턴이 활성화되는 자리예요. 창의 흐름이 살아납니다.",
    en: "The H5 creative pattern stirs — talent comes alive."
  },
  harmonic7thNeptune: {
    ko: "영감 흐름의 해왕성 패턴이 활성화되는 자리예요. 깊은 직관 흐름이 부풉니다.",
    en: "The H7 Neptune pattern is activated — inspiration deepens."
  },
  harmonic7thGeneric: {
    ko: "영감 흐름 패턴이 활성화되는 자리예요. 직관과 영감 흐름이 차오릅니다.",
    en: "The H7 inspiration pattern stirs — intuition swells."
  },
  harmonic9thJupiter: {
    ko: "영성 흐름의 목성 패턴이 활성화되는 자리예요. 완성 흐름이 두텁게 차오릅니다.",
    en: "The H9 Jupiter pattern is activated — completion and meaning swell."
  },
  harmonic9thGeneric: {
    ko: "영성 흐름 패턴이 활성화되는 자리예요. 완성 흐름이 깊어집니다.",
