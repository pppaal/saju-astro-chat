...
export const KO_MESSAGES = {
  GRADE_0: {
    ...
    general: '🌟 최고의 날이에요. 핵심 1~2개를 앞당겨 처리하면 체감 성과가 큽니다.',
  } as CategoryMessages,
  ...
  GRADE_1: {
    ...
    general: '✨ 아주 좋은 날이에요. 기회를 잡되 검증 단계를 빼지 않는 편이 맞습니다.',
  } as CategoryMessages,
  ...
  GRADE_3: {
    ...
    general: '⚠ 조심하는 날이에요. 속도보다 한 번 더 확인하는 절차와 리스크 관리가 중요합니다.',
  } as CategoryMessages,

  GRADE_4: {
    career: '🛡 지키는 날이에요. 비가역 결정은 늦추고 조건 점검부터 하세요.',
    ...
    general: '🛡 지키는 날이에요. 새로 벌이기보다 정리하고 점검하면서 가는 편이 맞습니다.',
  } as CategoryMessages,
