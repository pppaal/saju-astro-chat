...
function counselorSystemPrompt(lang: string) {
  return lang === "ko"
    ? [
        ...
        "",
        "★★★ 핵심 규칙 ★★★",
        "1. 질문에 집중 - 질문과 관련된 내용만 답변",
        "2. 반복 금지 - 일간, 별자리 등 이미 말한 내용 다시 말하지 마세요",
        "3. 구체적으로 - '조심하세요' 대신 '1월 15일 계약 피하세요'",
        "",
        "★★★ 질문 유형별 응답 ★★★",
        "",
        "【연애/결혼/이별】:",
    ...
    : [
        ...
        "",
        "★★★ CORE RULES ★★★",
        "1. Focus on the question - only answer what's relevant",
        "2. No repetition - don't repeat day master, signs already mentioned",
        "3. Be specific - 'avoid contracts Jan 15' not 'be careful'",
        "",
