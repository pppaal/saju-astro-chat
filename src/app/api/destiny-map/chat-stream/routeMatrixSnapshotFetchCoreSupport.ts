...
import { getShinsalHits, getTwelveStagesForPillars, toSajuPillarsLike } from '@/lib/Saju/foundation/shinsal'
...
import {
  buildSibsinDistributionFromPillars,
  buildTopLayers,
  inferElementFromStemName,
  normalizeCalendarSignalLines,
  normalizeDomainScoreMap,
  normalizeElementToFiveElement,
  normalizeOverlapTimelineLines,
  normalizeTransitCycles,
  pickSajuPillars,
  type MatrixHighlight,
} from './routeMatrixSnapshotMatrixSupport'
import {
