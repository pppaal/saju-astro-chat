...
function CircleContent() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm(t('myjourney.circle.confirmDelete'))) {
      return
    }
    try {
  ...
  const _getRelationInfo = (rel: string) => {
    ...
    return found
      ? { ...found, label: t(found.labelKey) }
      : { value: rel, labelKey: rel, label: rel, icon: '👤' }
  }
  ...
  return (
    <main className={styles.container}>
      ...
      <p className={styles.subtitle}>{t('myjourney.circle.subtitle')}</p>
        ...
        <section className={styles.card}>
          ...
          <div className={styles.formGrid}>
            ...
            <div className={styles.formGroup}>
              ...
              <div className={styles.selectWrapper}>
                ...
                >
                  ...
                  <span
                    className={`${styles.selectArrow} ${relationOpen ? styles.selectArrowOpen : ''}`}
                  >
                    ▾
                  </span>
                </button>
            ...
            <div className={styles.formGroup}>
              ...
              {timeUnknown && (
                <p className={styles.hint}>{t('myjourney.circle.timeUnknownHint')}</p>
              )}
            </div>
            ...
            <div className={styles.formGroup}>
              ...
              <div className={styles.selectWrapper}>
                ...
                >
                  ...
                  <span
                    className={`${styles.selectArrow} ${genderOpen ? styles.selectArrowOpen : ''}`}
                  >
                    ▾
                  </span>
                </button>
