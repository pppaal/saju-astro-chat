...
export const SERVICE_NAME_KEYS: Record<string, string> = {
  // kebab-case versions
...
export const _SERVICE_URLS: Record<string, string> = {
  ...
  destinyMatrix: '/destiny-map/matrix',
  // single word services
  tarot: '/tarot',
  saju: '/saju',
  astrology: '/astrology',
