...
const sections: Section[] = [
  ...
  },
  {
    ...
    bodyKo:
      '약관은 언제든 변경될 수 있습니다. 신규 이용자에게는 즉시, 기존 이용자에게는 사소 변경 7일/중대한 변경 30일 사전 통지 후 효력이 발생합니다. 시행 이후 계속 이용하면 변경에 동의한 것으로 간주됩니다. 동의하지 않으면 이용을 중단해야 합니다.\n당사는 기능 추가·변경·중단, 신규 구매 가격 변경, 점검을 위한 일시 중단, 60일 사전 통지 후 서비스 종료를 할 수 있으며, 특정 기능을 유지할 의무는 없습니다.',
  },
  {
  ...
  },
  {
    ...
    bodyKo:
      '귀하는 서비스 이용/오용, 약관 위반, 제3자 권리 침해, 사용자 콘텐츠, 리딩 기반 의사결정으로 발생하는 청구·손해·책임·비용(법률비용 포함)에 대해 DestinyPal, Paul Rhee 및 임직원/대리인을 면책·방어·보상해야 합니다. 당사는 귀하 비용으로 단독 방어를 선택할 수 있습니다.',
  },
  {
