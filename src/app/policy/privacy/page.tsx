...
const sections: Section[] = [
  ...
  },
  {
    ...
    bodyKo:
      '데이터가 거주국 외(예: 미국)에서 처리될 수 있습니다. 표준계약조항(SCC), 처리 위탁 계약(DPA) 등 적정한 보호조치를 적용하며, 위치와 무관하게 보안을 유지합니다.',
  },
  {
  ...
  },
  {
    ...
    bodyKo:
      '본 서비스는 만 14세 미만(또는 EU 등 적용 연령 16세 미만) 아동을 대상으로 하지 않습니다. 아동의 정보를 고의로 수집하지 않으며, 관련 정보가 확인되면 삭제를 요청해 주세요.',
  },
  {
