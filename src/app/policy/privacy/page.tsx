...
const sections: PolicySection[] = [
  {
    ...
    title: '1. Overview',
    titleKo: '1. 개요',
    body: "DestinyPal ('we', 'us', 'our') is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information. We aim to comply with applicable laws, including PIPA (Korea), the GDPR (EU), the CCPA (California), and other relevant regulations.",
    bodyKo:
  ...
  },
  {
    ...
    titleKo: '2. 수집하는 정보',
    body: 'Account: Google OAuth profile information (email, display name, profile image). We do NOT collect or store passwords — authentication is handled exclusively via Google OAuth.\nAuthentication: OAuth tokens are encrypted at rest and are used only to maintain your login session.\nPayment: transaction IDs and billing information are processed by Stripe. We never store full card numbers.\nService Data: the birth date, time, and location, along with any other inputs you provide for astrology, saju, tarot, and other readings. Chat and reading messages exchanged with the AI counselors, together with the AI-generated responses, are stored to preserve your history. If you submit information about another person (for example, a partner’s birth information for compatibility or couple readings, or shared session data), you confirm that you have obtained their informed consent for us to receive and process such information.\nUploaded Images: profile and matching photos that you choose to upload are stored on Firebase Storage.\nAI Model Training: we do NOT use your inputs or AI responses to train AI models. The Anthropic Claude API used for readings operates under a commercial agreement that excludes API customer data from training.\nTechnical: IP address, browser and device information, OS, cookies, logs.\nCommunications: support tickets, feedback, and correspondence with us.',
    bodyKo:
  ...
  },
  {
    ...
    titleKo: '3. 정보 수집 방법',
    body: 'Direct: information you provide during signup, purchase, or service use.\nAutomatic: cookies, web beacons, and analytics tools (disabled until you consent) track usage patterns and technical data.\nThird Parties: payment processors (Stripe), authentication providers (Google OAuth), and analytics/advertising (Google AdSense). AdSense and Analytics are blocked until you consent via our CMP.',
    bodyKo:
  ...
  },
  {
    ...
    titleKo: '4. 정보 이용 목적',
    body: 'Service Delivery: providing astrology, saju, tarot, and other readings. [Legal basis (GDPR Art.6): performance of a contract]\nAccount & Billing: authenticating users and processing payments. [Performance of a contract]\nCommunication — service notices and support. [Performance of a contract]\nCommunication — marketing. [Consent — Art.6(1)(a); withdrawable at any time]\nImprovement: analyzing usage to improve features and UX. [Consent (analytics cookies)]\nCompliance & Safety: fraud prevention, legal obligations, and Terms enforcement. [Legal obligation / legitimate interest]\nAdvertising: personalized ads via Google AdSense. [Consent — blocked until you accept]',
    bodyKo:
  ...
  },
  {
    ...
    titleKo: '6. 제3자 제공/위탁',
    body: 'We do NOT sell personal information. We share data only with the service providers (processors) we use to operate the service:\n- Vercel Inc. (hosting, edge runtime, deployment) — US\n- Anthropic PBC (Claude AI for readings) — US\n- Stripe, Inc. (payment processing, PCI-DSS Level 1) — US\n- Google LLC (OAuth authentication, optional AdSense after consent) — US\n- Database hosting provider for Postgres (Neon / Vercel Postgres) — US\n- Google LLC — Firebase Storage (image uploads for profile and matching photos) — US\n- Sentry (error monitoring, when enabled) — US\n- Resend (transactional email delivery) — US\nLegal: when required by law, court, or government.\nBusiness transfers: in connection with mergers or acquisitions (with notice).\nAdvertising partners: Google AdSense may use cookies; you may opt out at https://www.google.com/settings/ads.',
    bodyKo:
  ...
  },
  {
    ...
    bodyKo: `다음의 권리를 행사할 수 있습니다: 열람, 정정, 삭제, 처리 제한, 데이터 이동(GDPR), 처리 반대, 동의 철회. 연락처: ${SUPPORT_EMAIL}.\n응답 기한: 한국 거주자는 10일 이내(개인정보 보호법), 그 외 지역은 30일 이내. 데이터 이동(portability) 요청 시에는 이메일로 기계 판독 가능한 형식의 사본을 제공해 드립니다.\nGDPR: EU 감독기관에 불만을 제기할 권리가 있습니다.\nCCPA: 캘리포니아 이용자는 열람, 삭제, 옵트아웃 권리를 행사할 수 있으며, 당사는 개인정보를 판매하지 않고 교차 맥락 행동 광고를 위해 공유하지도 않습니다. 또한 CCPA 권리 행사를 이유로 이용자를 차별(서비스 거부, 다른 가격 청구, 품질 저하 등)하지 않습니다 — 차별 금지권 (Cal. Civ. Code §1798.125).`,
  },
  {
    id: 'cookies',
    title: '9. Cookies and Tracking',
    titleKo: '9. 쿠키 및 추적',
    body: 'Uses: essential (login and security), analytics (after consent), advertising (AdSense after consent), and preferences.\nYou can control cookies via your browser settings; disabling them may limit features.\nAdSense and Analytics load only after consent via our CMP; personalized ads can be managed through Google Ads Settings.',
    bodyKo:
  ...
  },
  {
    ...
    titleKo: '10. 보안',
    body: 'Safeguards: TLS/SSL in transit, encryption at rest (e.g., AES-256 where supported), role-based access controls, MFA for staff, monitoring, secure cloud infrastructure, Stripe PCI-DSS Level 1 for payments, periodic security reviews, and incident response procedures.\nNo system is 100% secure; please protect your credentials.',
    bodyKo:
  ...
  },
  {
    ...
    bodyKo: `본 서비스의 가입은 만 14세 이상(또는 EU 등 디지털 동의 연령이 더 높게 설정된 지역에서는 해당 연령 이상)만 가능합니다. 당사는 적용 연령 미만 이용자의 개인정보를 고의로 수집하지 않으며, 해당 사실이 확인되는 경우 계정 및 관련 데이터를 지체 없이 삭제합니다. 자녀의 가입을 인지하신 법정대리인은 ${SUPPORT_EMAIL}로 연락하시면 즉시 삭제를 요청하실 수 있습니다.`,
  },
  {
    id: 'controller-and-complaints',
  ...
  },
  {
    ...
    body: 'We use AdSense to display ads. Google may use cookies and identifiers to serve and measure ads and to prevent fraud. AdSense loads only after you consent. You may opt out of personalized ads at https://www.google.com/settings/ads. See the Google Privacy Policy for details.',
    bodyKo:
  ...
  },
  {
    ...
    titleKo: '14. 방침 변경',
    body: `We may update this Privacy Policy from time to time. Material changes take effect after notice (7 days for minor changes, 30 days for significant changes). Continued use after the effective date constitutes acceptance.\nLast Updated: ${EFFECTIVE_DATE}`,
    bodyKo: `본 방침은 변경될 수 있으며, 중대한 변경은 사전 고지 후 효력이 발생합니다(경미한 변경은 7일, 중대한 변경은 30일). 시행일 이후에도 계속 이용하시는 경우 변경에 동의하신 것으로 간주됩니다.\n최종 업데이트: ${EFFECTIVE_DATE}`,
  },
]
...
export default function PrivacyPage() {
  return (
    <PolicyDocument
      ...
      titleFallbackEn="Privacy Policy"
      titleFallbackKo="개인정보처리방침"
      effectiveKey="policy.privacy.effective"
      effectiveDate={EFFECTIVE_DATE}
      footerKey="policy.privacy.footer"
