...
> = {
  en: {
    ...
    sections: [
      ...
      {
        title: "3. How We Collect",
        body: "Forms, support contact, automatic collection (cookies), payment integrations.",
      },
      {
        title: "4. Purpose of Use",
        body:
          "Authentication, service delivery, personalized reports, support, notices, statistics, billing, legal compliance.",
      },
      { title: "5. Retention", body: "Account until deletion (legal retention up to 5 years). Logs 2 years. Billing 5 years." },
      {
        ...
        body: "No sharing without consent except by law. We use processors for hosting, payments, email, analytics.",
      },
      {
        title: "7. Overseas Transfer",
        body: "Data may be transferred abroad to processors. Details provided in service notices.",
      },
      { title: "8. Your Rights", body: "Access, rectify, delete, restrict, withdraw consent. Contact: rheeco88@gmail.com" },
      { title: "9. Cookies", body: "Used for login and analytics. Manage in browser or Cookie Settings." },
      { title: "10. Security", body: "Encryption, access control, least privilege, monitoring, backup/DR, training." },
      { title: "11. Children", body: "Under 14 may require guardian consent." },
      { title: "12. Controller/DPO", body: "Email: rheeco88@gmail.com" },
      { title: "13. Notice of Changes", body: "We announce changes at least 7 days prior." },
    ],
  ...
  ko: {
    ...
    sections: [
      ...
      { title: "6. 제3자 제공/위탁", body: "동의 없는 제공은 원칙적으로 없음. 호스팅·결제·이메일·분석 등 위탁 사용." },
      { title: "7. 국외 이전", body: "해외 인프라/위탁사로 이전될 수 있으며, 세부는 서비스 내 고지." },
      { title: "8. 이용자 권리", body: "열람·정정·삭제·처리정지·동의철회. 연락: rheeco88@gmail.com" },
      { title: "9. 쿠키", body: "로그인 유지와 분석 목적. 브라우저 또는 쿠키 설정에서 관리." },
      { title: "10. 안전성 확보", body: "암호화, 접근통제, 최소권한, 모니터링, 백업/DR, 교육." },
      { title: "11. 아동", body: "만 14세 미만은 법정대리인 동의 필요할 수 있음." },
      { title: "12. 개인정보 보호책임자", body: "이메일: rheeco88@gmail.com" },
      { title: "13. 고지 의무", body: "변경 시 최소 7일 전 공지." },
    ],
  ...
  zh: {
    ...
    sections: [
      ...
      { title: "6. 提供/委托", body: "原则上不提供给第三方；使用托管/支付/邮件/分析等受托方。" },
      { title: "7. 境外传输", body: "可能传输至海外受托方；详情在服务内告知。" },
      { title: "8. 权利", body: "查阅、更正、删除、限制、撤回同意。联系：rheeco88@gmail.com" },
      ...
      { title: "12. 负责人", body: "邮箱：rheeco88@gmail.com" },
      { title: "13. 变更通知", body: "变更至少提前7日通知。" },
    ],
  ...
  ar: {
    ...
    sections: [
      ...
      { title: "3. طرق الجمع", body: "النماذج، الدعم، الجمع الآلي (كوكيز)، تكاملات الدفع." },
      {
        title: "4. الغرض",
        body:
          "المصادقة، تقديم الخدمة، التقارير المخصصة، الدعم، الإشعارات، الإحصاء، الدفع، الامتثال.",
      },
      { title: "5. مدة الاحتفاظ", body: "الحساب حتى الحذف (حتى 5 سنوات قانونياً). السجلات سنتان. الدفع 5 سنوات." },
      {
        title: "6. المشاركة/المعالجون",
        body: "لا مشاركة دون موافقة إلا بنص القانون. نستخدم معالجين للاستضافة والدفع والبريد والتحليلات.",
      },
      { title: "7. النقل إلى الخارج", body: "قد تُنقل البيانات إلى الخارج إلى معالجين. التفاصيل في إشعارات الخدمة." },
      { title: "8. حقوقك", body: "الوصول، التصحيح، الحذف، التقييد، سحب الموافقة. تواصل: rheeco88@gmail.com" },
      { title: "9. الكوكيز", body: "للاحتفاظ بتسجيل الدخول والتحليلات. الإدارة عبر المتصفح أو إعدادات الكوكيز." },
      ...
      { title: "12. المسؤول", body: "البريد: rheeco88@gmail.com" },
      { title: "13. إشعار التغييرات", body: "نعلن عن التغييرات قبل 7 أيام على الأقل." },
    ],
  ...
  es: {
    ...
    sections: [
      ...
      { title: "3. Métodos", body: "Formularios, soporte, recopilación automática (cookies), integraciones de pago." },
      {
        title: "4. Finalidad",
        body:
          "Autenticación, prestación, informes personalizados, soporte, avisos, estadísticas, pago, cumplimiento legal.",
      },
      { title: "5. Retención", body: "Cuenta hasta eliminación (máx. 5 años legales). Logs 2 años. Pagos 5 años." },
      {
        title: "6. Cesión/Encargados",
        body: "Sin cesión sin consentimiento salvo ley. Encargados: hosting, pagos, email, analítica.",
      },
      { title: "7. Transferencia internacional", body: "Puede haber transferencias al extranjero. Detalles en avisos del servicio." },
      {
        title: "8. Derechos",
        body:
          "Acceso, rectificación, supresión, restricción, retiro del consentimiento. Contacto: rheeco88@gmail.com",
      },
      ...
      { title: "12. Responsable/DPO", body: "Email: rheeco88@gmail.com" },
      { title: "13. Aviso de cambios", body: "Avisaremos con al menos 7 días de antelación." },
    ],
