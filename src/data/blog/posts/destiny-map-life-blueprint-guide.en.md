...
- **Ten Gods (십신)**: How every other element in the chart relates to the Day Master—resources, peers, output, wealth, authority
- **Daeun (대운)**: Ten-year luck pillars that describe the energetic climate of each major life phase
- **Five Element balance**: Where Wood, Fire, Earth, Metal, and Water are strong, weak, or in conflict

Saju's particular strength is timing: it has been used in Korea for centuries to evaluate auspicious dates, decade-long career arcs, and compatibility windows.
...
- **Houses**: The twelve life areas where each planet's energy actually plays out
- **Major aspects**: The geometric relationships (conjunction, opposition, trine, square, sextile) that show how parts of your psyche cooperate or compete

Where Saju asks "what is the energy of this moment?", Western astrology asks "what archetypes are configured in this person?"—and the two questions answer to different needs.
...
What you're here to develop and contribute. Synthesized from your Day Master and its supporting Ten Gods, the sign and house of your Sun, and—if relevant to the question—the Midheaven and North Node axis.

### Theme 2: Natural Talents

Your innate aptitudes. Read from favorable elements and Expression-type Ten Gods (식신/상관) in Saju, and from strong, well-aspected planets in their domiciles or exaltations in the Western chart.

### Theme 3: Relationship Patterns

How you bond, attract, and clash. Combines Saju's Spouse Palace (the Day Branch) and wealth/authority stars with Venus, Mars, the Moon, and the 7th house in Western astrology.

### Theme 4: Career Path

Professional directions suited to your nature. Integrates Saju's career and wealth indicators with the Midheaven sign and ruler, the 10th and 6th houses, and the strongest elemental phase of your current Daeun.

### Theme 5: Growth and Evolution
...
- Which element dominates—or is conspicuously missing—in your Saju?
- Which house or sign clusters carry the most Western planetary weight?
- Where do the two systems converge on a single message?

### The Timing Section

Understanding life phases:

- Current Daeun theme and the elements it activates or stresses
- Active Western transits to personal planets and angles
- Annual overlay: Saju Seun (yearly pillar) alongside the year's notable transits

### The Action Section

Practical guidance:

- Elements to cultivate or restrain through environment, work, and relationships
- Favorable directions, colors, and seasons drawn from your elemental needs
- Windows of opportunity where Saju and Western timing agree

## Cross-System Correlations

The real value of an integrative reading lies in how the systems compare.

### When Systems Agree

Convergence highlights core, reliable traits:

- A Water Day Master with a Cancer or Pisces Sun strongly emphasizes emotional sensitivity and intuitive intelligence
- A Wood Day Master with an Aries Sun and a prominent Mars points to initiative, growth, and pioneering energy

### When Systems Differ

Divergence reveals genuine internal complexity—not contradiction:

- A Fire-dominant Saju with a Water Moon describes a person whose outer drive runs hot while their inner life is reflective and feeling-oriented
- A Saju showing a quiet, introverted Day Master alongside a fiery Leo Ascendant suggests a private self that learned to perform a more expressive public persona

These tensions are often the most useful part of the reading, because they name something the person already feels but couldn't articulate.
...
- Aligning actions with the elemental needs of your chart
...
- Identifying growth edges (deficient elements, challenging aspects)
- Understanding recurring patterns across decades
- Developing underused parts of the chart
...
- Progressions that move your inner chart forward symbolically
