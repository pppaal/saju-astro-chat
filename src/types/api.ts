...
/**
 * @deprecated Use ChatMessage from @/lib/api/validator instead for Zod validation
...
// Re-export the canonical ChatMessage type from validator
export type { ChatMessage as ChatMessageValidated } from '@/lib/api/validator'
