...
// This file (1,107 lines) is being modularized for better maintainability.
// Types have been extracted to modules/types.ts
// Future implementations will be split into:
// - modules/solarTerms/ - 24절기 계산
// - modules/lunarMansions/ - 28수 계산
// - modules/planetaryHours/ - 행성시 계산
// - modules/progressions/ - 진행법 계산
// - modules/confidence/ - 신뢰도 계산
//
// For new imports, consider using: import { ... } from './modules'
