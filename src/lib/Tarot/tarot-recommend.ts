...
export function generateDynamicSpread(
  question: string,
  cardCount?: number
): {
  cardCount: number
  ...
  > = {
    1: [
      {
        title: 'Answer',
        titleKo: '답변',
        description: 'Direct answer to your question',
        descriptionKo: '질문에 대한 직접적인 답',
      },
    ],
    2: [
      {
        ...
        descriptionKo: '첫 번째 선택',
      },
      {
        title: 'Option B',
        titleKo: '선택 B',
        description: 'Second choice',
        descriptionKo: '두 번째 선택',
      },
    ],
    3: [
      {
        title: 'Past',
        titleKo: '과거',
        description: 'What has led to this',
        descriptionKo: '이 상황을 만든 과거',
      },
      {
        title: 'Present',
        titleKo: '현재',
    ...
    4: [
      ...
      },
      {
        title: 'Challenge',
        titleKo: '도전',
        description: 'What you face',
        descriptionKo: '직면한 도전',
      },
    ...
    7: [
      {
        ...
        descriptionKo: '한 주의 시작',
      },
      {
        title: 'Tuesday',
        titleKo: '화요일',
        description: 'Building momentum',
        descriptionKo: '모멘텀 구축',
      },
      {
        title: 'Wednesday',
        titleKo: '수요일',
        description: 'Midweek energy',
        descriptionKo: '주중 에너지',
      },
    ...
    10: [
      ...
      },
      {
        title: 'Challenge',
        titleKo: '도전',
        description: 'Immediate challenge',
        descriptionKo: '즉각적 도전',
      },
      {
        title: 'Foundation',
        titleKo: '기반',
      ...
      { title: 'Past', titleKo: '과거', description: 'Recent past', descriptionKo: '최근 과거' },
      {
        ...
        descriptionKo: '최선의 결과',
      },
      {
        title: 'Future',
        titleKo: '미래',
        description: 'Near future',
        descriptionKo: '가까운 미래',
      },
      {
        title: 'Self',
        titleKo: '자신',
        description: 'Your attitude',
        descriptionKo: '당신의 태도',
      },
      {
        title: 'Environment',
        titleKo: '환경',
