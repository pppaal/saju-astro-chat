...
export { STEM_TO_ELEMENT_EN as STEM_TO_ELEMENT } from '@/lib/Saju/foundation/constants';
export { STEM_NAMES as STEMS, BRANCH_NAMES as BRANCHES } from '@/lib/Saju/foundation/constants';
...
export { YUKHAP, CHUNG, XING, HAI } from '@/lib/Saju/foundation/constants';
