...
export const RELATIONS_DICTIONARY: RelationEntry[] = [
  ...
  // ──────────────────────────────────────────────
  {
    ...
    name: '갑기합토 (甲己合土)',
    result: '토',
    ko: '갑의 추진력과 기의 안정이 만나 흙의 결로 화합돼요. 굳건한 토대 위에서 빠른 행동이 가능한 결이라, 큰 그림을 단단히 짚고 갈 때 빛납니다.',
  ...
  },
  {
    ...
    name: '을경합금 (乙庚合金)',
    result: '금',
    ko: '을의 유연함과 경의 단호함이 만나 쇠의 결로 모여요. 부드러움이 결단으로 다듬어지는 흐름이라, 의리와 약속을 지키는 자리에서 또렷해집니다.',
  ...
  },
  {
    ...
    name: '병신합수 (丙辛合水)',
    result: '수',
    ko: '병의 빛과 신의 정련이 만나 의외로 물의 결로 흘러요. 뜨거운 에너지가 차분히 가라앉아 지혜로 바뀌는 자리라, 위엄과 권위가 자연스레 따라옵니다.',
  ...
  },
  {
    ...
    name: '정임합목 (丁壬合木)',
    result: '목',
    ko: '정의 따뜻한 불빛과 임의 깊은 물이 만나 새 나무의 결로 자라요. 감정과 직관이 결합해 창작과 인연을 키우는 흐름이라, 다정한 끌림이 강합니다.',
  ...
  },
  {
    ...
    name: '무계합화 (戊癸合火)',
    result: '화',
    ko: '무의 단단한 산과 계의 가는 물이 만나 의외로 불의 결로 피어요. 무거운 토대에서 열정이 솟는 자리라, 나이 차·관점 차를 넘어 끌리는 일이 많습니다.',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    pairKo: '갑경',
    name: '갑경충 (甲庚冲)',
    ko: '뻗어 오르는 나무와 단단한 쇠가 정면으로 마주서요. 추진과 결단이 부딪히며 가지를 쳐 정리하는 결이라, 변동과 충돌이 잦지만 그만큼 빠르게 다듬어집니다.',
  ...
  },
  {
    ...
    pairKo: '병임',
    name: '병임충 (丙壬冲)',
    ko: '한낮의 태양과 깊은 강물이 정면으로 충돌해요. 드러내려는 빛과 감추려는 물이 맞서는 결이라, 명암이 또렷하고 감정의 진폭이 큽니다.',
  ...
  },
  {
    ...
    pairKo: '정계',
    name: '정계충 (丁癸冲)',
    ko: '따뜻한 등불과 차가운 이슬이 마주서요. 작은 불꽃이 가는 물에 꺼지는 결이라, 의지와 의심, 열정과 회의가 안에서 자주 부딪힙니다.',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    name: '자축합토 (子丑合土)',
    result: '토',
    ko: '한겨울 물과 얼어붙은 흙이 손을 잡아 진득한 토양으로 굳어요. 차분히 머금고 견디는 결이라, 단숨에 풀리진 않아도 오래 가는 약속이 됩니다.',
  ...
  },
  {
    ...
    name: '묘술합화 (卯戌合火)',
    result: '화',
    ko: '연한 풀과 마른 흙이 만나 의외로 따뜻한 불을 피워요. 부드러움과 듬직함이 결합해 가정·정서 안에서 온기를 만드는 결이라, 다정한 합으로 통합니다.',
  ...
  },
  {
    ...
    name: '진유합금 (辰酉合金)',
    result: '금',
    ko: '습한 흙과 다듬인 쇠가 만나 단단한 금속으로 빚어져요. 정리와 마무리에 강한 결이라, 약속·계약·실무가 깔끔하게 떨어집니다.',
  ...
  },
  {
    ...
    name: '사신합수 (巳申合水)',
    result: '수',
    ko: '한낮의 불과 가을 쇠가 만나 의외로 물의 결로 흘러요. 열정과 분석이 만나 지혜로 식는 자리라, 합 안에 작은 형(刑)의 결도 함께 들어 있습니다.',
  ...
  },
  {
    ...
    pairKo: '오미',
    name: '오미합 (午未合, 음양합)',
    ko: '한낮의 불과 한여름의 흙이 손을 잡아 정점의 열기를 함께 머금어요. 별도의 변화 오행 없이 음양의 결이 짝을 이루는 자리라, 친밀과 동행감이 강합니다.',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    name: '인오술 삼합 (寅午戌, 화국)',
    result: '화',
    ko: '봄의 시작, 한낮의 정점, 가을의 갈무리가 모여 거대한 불의 국을 이뤄요. 시작·확산·정리의 셋이 한 줄로 흐르는 결이라, 열정과 명성이 함께 커집니다.',
  ...
  },
  {
    ...
    name: '사유축 삼합 (巳酉丑, 금국)',
    result: '금',
    ko: '여름의 시작, 가을의 정점, 겨울의 갈무리가 모여 단단한 쇠의 국을 이뤄요. 의리·결단·정리가 한 흐름이 되는 결이라, 약속과 실무가 깔끔하게 풀립니다.',
  ...
  },
  {
    ...
    name: '신자진 삼합 (申子辰, 수국)',
    result: '수',
    ko: '가을 쇠, 한겨울 물, 봄의 진흙이 모여 큰 물의 국을 이뤄요. 정보·인연·흐름이 한 줄로 모이는 결이라, 지혜와 사교가 동시에 깊어집니다.',
  ...
  },
  {
    ...
    name: '해묘미 삼합 (亥卯未, 목국)',
    result: '목',
    ko: '겨울 끝 물, 봄 한가운데 나무, 여름의 흙이 모여 큰 나무의 국을 이뤄요. 호기심·성장·인연이 함께 자라는 결이라, 새 시도와 사람의 연이 동시에 풍성해집니다.',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    result: '목',
    ko: '입춘·춘분·곡우의 세 자리가 한 계절을 이뤄 봄의 결로 흐릅니다. 시작의 에너지가 한 방향으로 모이는 결이라, 새로 펴는 일·새 인연이 한꺼번에 일어요.',
  ...
  },
  {
    ...
    result: '화',
    ko: '입하·하지·대서의 세 자리가 한 계절을 이뤄 여름의 결로 흐릅니다. 열기·표현·외향이 한꺼번에 부풀어 오르는 결이라, 사람 앞에 서는 일이 많아져요.',
  ...
  },
  {
    ...
    result: '금',
    ko: '입추·추분·상강의 세 자리가 한 계절을 이뤄 가을의 결로 흐릅니다. 정리·수확·결단이 한 방향으로 모이는 결이라, 약속과 마무리가 단호해집니다.',
  ...
  },
  {
    ...
    result: '수',
    ko: '입동·동지·대한의 세 자리가 한 계절을 이뤄 겨울의 결로 흐릅니다. 갈무리·사유·기다림이 한 흐름이 되는 결이라, 안으로 깊어지는 시기가 옵니다.',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    pairKo: '자오',
    name: '자오충 (子午冲)',
    ko: '한밤의 물과 한낮의 불이 정반대로 마주서요. 감정과 열기, 안과 밖이 가장 큰 폭으로 부딪히는 결이라, 변화·이동·관계의 진폭이 커집니다.',
  ...
  },
  {
    ...
    pairKo: '축미',
    name: '축미충 (丑未冲)',
    ko: '겨울 흙과 여름 흙이 같은 토끼리 마주서요. 보존과 발산, 옛것과 새것이 같은 자리에서 맞붙는 결이라, 가족·재물 안에서 작은 갈등이 자주 일어요.',
  ...
  },
  {
    ...
    pairKo: '인신',
    name: '인신충 (寅申冲)',
    ko: '봄나무와 가을 쇠가 정면으로 마주서요. 시작과 정리, 진취와 결단이 부딪히는 결이라, 이동·여행·자리바꿈이 잦아집니다.',
  ...
  },
  {
    ...
    pairKo: '묘유',
    name: '묘유충 (卯酉冲)',
    ko: '연한 풀과 다듬인 보석칼이 마주서요. 섬세함과 단호함이 부딪히는 결이라, 인연의 흔들림과 작은 결별이 동반될 수 있어요.',
  ...
  },
  {
    ...
    pairKo: '진술',
    name: '진술충 (辰戌冲)',
    ko: '습한 봄 흙과 마른 가을 흙이 같은 토끼리 마주서요. 보관과 정리, 깊은 곳과 마른 곳이 부딪히는 결이라, 묵은 일이 한꺼번에 드러납니다.',
  ...
  },
  {
    ...
    pairKo: '사해',
    name: '사해충 (巳亥冲)',
    ko: '한낮의 불과 깊은 밤 물이 마주서요. 빛과 어둠, 양과 음이 정면으로 맞서는 결이라, 신념·종교·해외 같은 큰 주제의 변동이 따라옵니다.',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    ko: '봄나무·여름불·가을쇠 셋이 한자리에 모여 서로 어긋나요. 의지·열정·결단이 한 줄이 되지 못하는 결이라, 의리·은혜를 둘러싼 복잡한 일이 따라옵니다.',
  ...
  },
  {
    ...
    ko: '겨울·가을·여름의 세 흙이 한자리에 모여 서로 밀어내요. 같은 토끼리 자리를 다투는 결이라, 권력·재물·문서 안에서 마찰이 일기 쉬워요.',
  ...
  },
  {
    ...
    pairKo: '자묘',
    name: '자묘 상형 (子卯, 무례지형)',
    ko: '한겨울 물과 봄 한가운데 풀이 어긋나게 만나요. 흐름과 새 가지가 서로의 예의를 깨는 결이라, 가까운 사이에서 작은 무례와 오해가 생기기 쉬워요.',
  ...
  },
  {
    ...
    pairKo: '오오',
    name: '오오 자형 (午午, 자형)',
    ko: '같은 여름 불이 둘 모이는 자형이에요. 열기가 자기끼리 다투는 결이라, 한꺼번에 타올랐다가 소진되기 쉬워 속도 조절이 핵심입니다.',
  ...
  },
  {
    ...
    pairKo: '축오',
    name: '축오해 (丑午害)',
    ko: '겨울 흙과 한낮 불이 어긋나게 만나요. 따뜻해지려는 결이 자꾸 식는 자리라, 감정과 인정 사이에서 작은 서운함이 쌓이기 쉬워요.',
  ...
  },
  {
    ...
    pairKo: '인사',
    name: '인사해 (寅巳害)',
    ko: '봄나무와 여름불이 합인 듯 어긋나요. 같이 가는 듯하면서 작은 형의 결이 섞여 있는 자리라, 동행 안에서도 미세한 마찰이 따라옵니다.',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    pairKo: '자유',
    name: '자유파 (子酉破)',
    ko: '한밤 물과 가을 쇠가 서로의 결을 깎아요. 흐름이 차갑게 굳고 깎이는 자리라, 정리가 빨리 끝나지만 인연이 식을 수 있어요.',
  ...
  },
  {
    ...
    pairKo: '인해',
    name: '인해파 (寅亥破)',
    ko: '봄나무와 큰 물이 합인 듯 깨져요. 부드럽게 자라는 결 안에 작은 균열이 함께 들어 있는 자리라, 시작한 일이 막바지에서 한번 흔들립니다.',
