...
export const GEOKGUK_DICTIONARY: GeokgukEntry[] = [
  ...
  // ──────────────────────────────────────────────
  {
    ...
    name: '정관격',
    hanja: '正官格',
    ko: '안정과 책임을 인생의 큰 축으로 가져가는 스타일이에요. 정해진 자리, 정통적인 길에서 가장 빛나고, 신뢰와 약속을 지키는 것이 자기다움의 표현이에요.',
  ...
  },
  {
    ...
    name: '편관격',
    hanja: '偏官格',
    ko: '도전과 압박을 자기 연료로 바꾸는 강인한 모습이에요. 정해진 길보다는 직접 길을 뚫고 가는 사람이라, 위기에서 오히려 또렷해지는 흐름이 있어요.',
  ...
  },
  {
    ...
    name: '정재격',
    hanja: '正財格',
    ko: '꾸준한 노력으로 안정된 자산을 쌓는 느낌이에요. 큰 한 방보다 매일의 한 걸음으로 멀리 가는 사람이라, 시간이 갈수록 더 단단해져요.',
  ...
  },
  {
    ...
    name: '편재격',
    hanja: '偏財格',
    ko: '변동과 흐름 속에서 재물을 만들어 가는 활동적인 스타일이에요. 사람과 기회를 잘 엮어내는 감각이 있어, 큰 그림을 그리고 움직일 때 가장 빛나요.',
  ...
  },
  {
    ...
    name: '정인격',
    hanja: '正印格',
    ko: '학문과 정통적 지혜로 자기 자리를 만들어 가는 모습이에요. 받아들이고 가르치는 흐름이 강해서, 배움이 곧 자기다움이 되는 사람이에요.',
  ...
  },
  {
    ...
    name: '편인격',
    hanja: '偏印格',
    ko: '독특한 시선과 직관으로 자기만의 답을 찾는 느낌이에요. 정통적인 길보다 옆길에서 핵심을 보는 감각이 있어, 남다른 분야에서 빛나요.',
  ...
  },
  {
    ...
    name: '식신격',
    hanja: '食神格',
    ko: '여유롭게 표현하고 풍요롭게 나누는 스타일이에요. 자기 안의 것을 부드럽게 꺼내 놓는 흐름이라, 의식주와 인복이 자연스럽게 따라와요.',
    ...
    strengths_ko: ['편안한 표현력', '풍요로움', '사람을 끌어들이는 느낌'],
  ...
  },
  {
    ...
    name: '상관격',
    hanja: '傷官格',
    ko: '재능과 창의를 활발하게 발산하는 모습이에요. 자기 표현이 또렷하고 감각이 뛰어나서, 정해진 틀보다 자유로운 자리에서 빛나는 사람이에요.',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    name: '종왕격',
    hanja: '從旺格',
    ko: '자기 색이 매우 또렷하고 강한 느낌이에요. 흐름을 거스르기보다 자기 본성을 끝까지 밀고 갈 때 길이 열리는 사람이라, 독립과 자기 주도가 핵심이에요.',
  ...
  },
  {
    ...
    name: '종강격',
    hanja: '從強格',
    ko: '받아들이고 채우는 흐름이 매우 강한 스타일이에요. 학문과 지혜가 자기 자산이 되는 사람이라, 안에 쌓인 것이 깊어질수록 멀리 가요.',
  ...
  },
  {
    ...
    name: '종세격',
    hanja: '從勢格',
    ko: '주변의 큰 흐름을 따라 자기 자리를 만드는 모습이에요. 혼자 버티기보다 시대와 사람의 면을 읽고 그 위에 올라탈 때 가장 멀리 가요.',
  ...
  },
  {
    ...
    name: '종아격',
    hanja: '從兒格',
    ko: '자기 안의 것을 끝까지 풀어내는 흐름을 따르는 느낌이에요. 표현과 창작, 가르침으로 세상에 자기를 옮겨 놓는 사람이라, 결과가 곧 자기 분신이 돼요.',
    ...
    strengths_ko: ['뛰어난 표현', '창의력', '아이를 키우는 느낌'],
  ...
  },
  {
    ...
    name: '종재격',
    hanja: '從財格',
    ko: '재물과 활동의 큰 흐름을 따라 사는 스타일이에요. 자기를 고집하기보다 큰 판의 흐름에 올라탈 때 부와 성취가 자연스럽게 따라와요.',
    ...
    advice_ko: '벌어들이는 면이 강한 만큼 자기 몸과 사람을 돈처럼 보지 않는 선을 지키세요.',
  ...
  },
  {
    ...
    name: '종살격',
    hanja: '從殺格',
    ko: '큰 압박과 책임의 흐름을 그대로 따라가는 강한 모습이에요. 무거운 자리를 피하지 않고 받아들일 때 오히려 자기 자리가 또렷해지는 사람이에요.',
  ...
  },
  {
    ...
    name: '건록격',
    hanja: '建祿格',
    ko: '자기 힘으로 자리를 만들어 가는 자수성가형 느낌이에요. 누구에게 기대기보다 자기 두 발로 서는 흐름이 강해서, 독립의 자리가 가장 자기다워요.',
  ...
  },
  {
    ...
    name: '양인격',
    hanja: '羊刃格',
    ko: '결단력과 추진력이 매우 강한 스타일이에요. 한번 마음먹은 일은 끝까지 밀어붙이는 흐름이라, 승부의 자리에서 가장 또렷해지는 사람이에요.',
    ...
    career_ko: '운동, 군경, 경영 일선, 외과, 스타트업 리더처럼 승부 면이 살아있는 자리가 잘 맞아요.',
    ...
    advice_ko: '센 면을 부드러움으로 한 번씩 풀어 주세요. 부드러움이 진짜 결단의 힘을 깊게 만들어요.',
  ...
  },
  {
    ...
    name: '잡기격',
    hanja: '雜氣格',
    ko: '여러 기운이 한 자리에 섞여 있는 다재다능한 모습이에요. 한 가지에만 머물기보다 여러 가능성을 같이 안고 가는 사람이라, 핵심을 정하는 일이 인생의 키예요.',
