...
export const ULTRA_ADVANCED_DICTIONARY: UltraAdvancedEntry[] = [
  ...
  // ──────────────────────────────────────────────
  {
    ...
    name: '종왕격',
    hanja: '從旺格',
    ko: '자기 힘이 너무 강해서 그 강한 흐름을 그대로 따라가는 결이에요. 같은 결의 사람들과 모여 큰 힘을 만들 때 가장 또렷해지고, 작은 자리에 갇히면 답답함을 느끼는 흐름이에요.',
  ...
  },
  {
    ...
    name: '종강격',
    hanja: '從強格',
    ko: '뒷받침해 주는 기운과 자기 기운이 함께 매우 강한 결이에요. 학문·정신·전통의 큰 줄기에서 자기 자리를 찾고, 깊이 쌓는 일에서 가장 빛나는 흐름이에요.',
    ...
    meaning_ko: '학문과 정신의 큰 줄기를 따라가는 결',
  ...
  },
  {
    ...
    name: '종아격',
    hanja: '從兒格',
    ko: '자기가 만들어 내는 결과·표현·작품의 흐름을 따라가는 결이에요. 자신을 비워 가며 무언가를 길러 내는 사람이라, 만들고 가르치는 자리에서 가장 또렷해져요.',
    ...
    meaning_ko: '내가 길러 내는 것의 흐름을 따라가는 결',
    meaning_en: 'Following what you nurture into being',
    traits_ko: ['표현의 결', '길러 내는 힘', '창작의 흐름'],
  ...
  },
  {
    ...
    name: '종재격',
    hanja: '從財格',
    ko: '재물과 활동의 큰 흐름을 따라가는 결이에요. 자기 힘은 약하지만 바깥의 자원이 압도적으로 강해, 그 흐름을 자기 길로 삼아 움직일 때 가장 또렷해져요.',
    ...
    meaning_ko: '재물의 흐름을 따라가는 큰 결',
    meaning_en: 'Following the strong current of wealth',
    traits_ko: ['외부 활동성', '재물 감각', '큰 흐름의 결'],
  ...
  },
  {
    ...
    name: '종살격',
    hanja: '從殺格',
    ko: '강한 압력과 책임의 흐름을 정면으로 따라가는 결이에요. 자기 힘은 가볍지만 외부의 거센 결을 받아들여 그 안에서 자리를 잡는, 위기에서 오히려 또렷해지는 사람이에요.',
    ...
    warning_ko: '쉼 없이 압력만 받으면 몸이 먼저 무너지니 회복의 결을 일상에 꼭 끼워 두세요.',
  ...
  },
  {
    ...
    name: '종세격',
    hanja: '從勢格',
    ko: '자기 결이 약해서, 가장 크게 흐르는 외부의 큰 결을 따라가는 사람이에요. 시대의 큰 흐름과 자기를 맞춰 갈 때 가장 또렷해지고, 거슬러 가면 힘을 잃는 결이에요.',
    ...
    meaning_ko: '시대의 큰 결을 따라가는 흐름',
    meaning_en: 'Following the great tide of the times',
    traits_ko: ['시대 감각', '큰 결 적응', '유연한 따라감'],
    ...
    warning_ko: '흐름에 너무 맞추다 보면 자기 결이 옅어질 수 있으니 안의 중심도 같이 챙겨 주세요.',
  ...
  },
  {
    ...
    name: '종관격',
    hanja: '從官格',
    ko: '안정된 권위와 정해진 자리의 흐름을 따라가는 결이에요. 자기 힘은 약하지만 정통의 큰 줄기를 따라 움직일 때 가장 또렷해지는 사람이에요.',
    ...
    meaning_ko: '정통의 큰 줄기를 따라가는 결',
    meaning_en: 'Following the main trunk of orthodoxy',
    traits_ko: ['정통의 결', '안정된 자리', '권위 적응'],
  ...
  },
  {
    ...
    name: '종인격',
    hanja: '從印格',
    ko: '뒷받침해 주는 기운의 큰 흐름을 따라가는 결이에요. 학문·문서·정신적 자산이 곧 자기 길이라, 깊이 배우고 천천히 쌓는 자리에서 가장 빛나요.',
    ...
    warning_ko: '받아들이기만 하면 정작 자기 결이 옅어질 수 있으니 표현하고 내보내는 시간을 따로 가지세요.',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hanja: '甲己合化土格',
    subType: '진화격',
    ko: '두 결이 만나 단단하고 너른 결로 새로 태어난 흐름이에요. 변화가 완성된 진짜 합화의 결이라, 사람과 사람을 잇고 큰 자리에서 중심을 잡는 사람이에요.',
    ...
    meaning_ko: '합이 완성되어 너른 중심의 결로 다시 태어난 흐름',
  ...
  },
  {
    ...
    hanja: '甲己合化土格',
    subType: '가화격',
    ko: '두 결이 만나려 했지만 완전한 변화에는 닿지 못한 흐름이에요. 너름과 중심을 향하면서도 가끔 자기 본래 결로 돌아가는 사람이라, 두 결을 오가는 매력이 있어요.',
    ...
    traits_ko: ['두 결을 오감', '부분적 너름', '본래 결의 회귀'],
    traits_en: ['moving between two lines', 'partial breadth', 'return to original line'],
    warning_ko: '한쪽으로만 치우치기 어려운 결이니 두 결의 균형 자체를 자기 강점으로 삼아 보세요.',
  ...
  },
  {
    ...
    hanja: '乙庚合化金格',
    subType: '진화격',
    ko: '부드러움과 날카로움이 만나 또렷한 결단의 결로 다시 태어난 흐름이에요. 정교한 판단과 깨끗한 마무리가 자기다움인, 날을 세울 때 가장 빛나는 사람이에요.',
  ...
  },
  {
    ...
    hanja: '乙庚合化金格',
    subType: '가화격',
    ko: '날을 세우려 했지만 완전히 단단해지지 못한 결이에요. 정확함을 추구하면서도 가끔은 부드러운 본래 결로 돌아가는, 그 사이의 결을 가진 사람이에요.',
    ...
    warning_ko: '결단이 흔들릴 수 있으니 큰 판단은 충분히 자고 깬 뒤 한 번 더 보는 결을 가지세요.',
  ...
  },
  {
    ...
    hanja: '丙辛合化水格',
    subType: '진화격',
    ko: '빛과 보석이 만나 깊은 물의 결로 다시 태어난 흐름이에요. 겉의 화려함이 안의 지혜로 모이는, 조용히 깊어지는 사람이에요.',
  ...
  },
  {
    ...
    hanja: '丙辛合化水格',
    subType: '가화격',
    ko: '깊이로 모이려 했지만 완전한 변화에는 닿지 못한 결이에요. 빛과 깊이가 같이 살아 있는 두 결의 사람이라, 양쪽 자리에서 각기 다른 매력을 보여요.',
    ...
    meaning_ko: '빛과 깊이가 같이 흐르는 미완의 결',
    ...
    warning_ko: '겉과 안의 결이 다를 수 있으니 안의 결을 누군가에게 정직하게 풀어내는 자리를 가지세요.',
  ...
  },
  {
    ...
    hanja: '丁壬合化木格',
    subType: '진화격',
    ko: '불빛과 큰 물이 만나 곧게 자라는 나무의 결로 다시 태어난 흐름이에요. 따뜻함과 생명력이 함께 자라는, 사람을 살리는 결을 가진 사람이에요.',
    ...
    meaning_ko: '따뜻함과 생명력이 함께 자라는 결',
    meaning_en: 'Warmth and vitality growing together',
    traits_ko: ['살리는 결', '곧게 자람', '따뜻한 성장'],
  ...
  },
  {
    ...
    hanja: '丁壬合化木格',
    subType: '가화격',
    ko: '곧게 자라려 했지만 완전한 합화에는 닿지 못한 결이에요. 따뜻함과 큰 물이 따로 흐르는 시간도 있어, 그때그때 다른 결로 자신을 보여줄 수 있는 사람이에요.',
    ...
    meaning_ko: '따뜻함과 큰 물이 따로 흐르기도 하는 결',
    ...
    warning_ko: '결이 흔들릴 수 있으니 자기를 살리는 사람과 자리도 같이 챙겨 두세요.',
  ...
  },
  {
    ...
    hanja: '戊癸合化火格',
    subType: '진화격',
    ko: '단단한 흙과 맑은 물이 만나 환한 불의 결로 다시 태어난 흐름이에요. 무거움과 차가움을 환함으로 바꾸는, 자리를 밝히는 사람이에요.',
    ...
    meaning_ko: '무거움이 환함으로 바뀐 결',
    meaning_en: 'Heaviness turned into brightness',
    traits_ko: ['밝히는 결', '온기의 변화', '환한 중심'],
  ...
  },
  {
    ...
    hanja: '戊癸合化火格',
    subType: '가화격',
    ko: '환함으로 바뀌려 했지만 완전한 합화에는 닿지 못한 결이에요. 밝은 자리와 차분한 본래 결을 오가는, 두 결을 다 가진 사람이에요.',
    ...
    meaning_ko: '밝음과 차분함이 같이 흐르는 미완의 결',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    name: '천상삼기',
    hanja: '天上三奇',
    ko: '하늘의 큰 결 셋이 한 사주에 모인 흐름이에요. 거시적인 시야와 큰 자리에서 일을 보는 감각이 있어, 큰 그림을 그리는 자리에서 가장 또렷해지는 사람이에요.',
    ...
    meaning_ko: '하늘의 큰 결 셋이 모인 결',
    meaning_en: 'Three great sky-currents gathered',
    traits_ko: ['넓은 시야', '큰 그림 감각', '하늘의 결'],
  ...
  },
  {
    ...
    name: '인중삼기',
    hanja: '人中三奇',
    ko: '사람의 큰 결 셋이 한 사주에 모인 흐름이에요. 사람을 다루고 마음을 읽는 감각이 깊어서, 관계의 큰 흐름에서 또렷해지는 사람이에요.',
    ...
    meaning_ko: '사람의 큰 결 셋이 모인 결',
    meaning_en: 'Three great human-currents gathered',
    traits_ko: ['관계 감각', '마음 읽기', '사람의 결'],
    ...
    warning_ko: '사람을 너무 깊이 읽다 보면 자기 결이 흐려지니 혼자 충전하는 시간도 잊지 마세요.',
  ...
  },
  {
    ...
    name: '지하삼기',
    hanja: '地下三奇',
    ko: '땅의 큰 결 셋이 한 사주에 모인 흐름이에요. 현장과 실물에 강한 감각이 있어, 직접 만들고 다루는 자리에서 가장 또렷해지는 사람이에요.',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    hanja: '年柱空亡',
    subType: '조상·사회',
    ko: '뿌리의 자리에 빈 결이 들어와 있는 흐름이에요. 가문이나 사회적 배경에 기대기보다 자기 손으로 길을 내는 사람이라, 작게 시작해 크게 만드는 결이 잘 어울려요.',
    ...
    meaning_ko: '뿌리 자리에 빈 결이 든 흐름',
    meaning_en: 'An empty line at the root seat',
    traits_ko: ['스스로 길 냄', '뿌리의 가벼움', '자수의 결'],
  ...
  },
  {
    ...
    hanja: '月柱空亡',
    subType: '부모·직업',
    ko: '부모와 직업의 자리에 빈 결이 들어온 흐름이에요. 정해진 길보다 자기 결로 직업을 새로 빚어 가는 사람이라, 전형적인 경로 밖에서 더 또렷해질 수 있어요.',
  ...
  },
  {
    ...
    hanja: '日柱空亡',
    subType: '배우자·자신',
    ko: '자기 자리에 빈 결이 들어온 흐름이에요. 세속의 채움보다 안의 비움에서 더 또렷해지는, 영적이고 자유로운 결을 가진 사람이에요.',
  ...
  },
  {
    ...
    hanja: '時柱空亡',
    subType: '자녀·말년',
    ko: '자녀와 말년의 자리에 빈 결이 들어온 흐름이에요. 결과나 후계에 집착하기보다 과정 자체를 깊이 음미하는 사람이라, 말년의 결이 오히려 자유로워지는 흐름이에요.',
