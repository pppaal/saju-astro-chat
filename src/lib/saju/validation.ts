...
export const VALID_STEMS = ['甲', '乙', '丙', '丁', '戊', '己', '庚', '辛', '壬', '癸'] as const
...
export function parseTimeStringSafe(timeStr: string): ParsedTime {
  ...
  if (minute < 0 || minute > 59) {
    throw new SajuValidationError('INVALID_MINUTE', `Minute out of range: ${minute}. Must be 0-59`)
  }
...
export function safeValidateSajuBirthInfo(
  ...
  | { success: true; data: z.infer<typeof SajuBirthInfoSchema> }
