...
import { getIljinCalendar, getMonthlyCycles } from './unse'
import { getYearPillarForDate } from './datePillars'
import { STEMS, TIME_STEM_LOOKUP } from './constants'
import { getTimeBranchFromHour } from './validation'
...
import type { DayMaster, IljinData, WolunData, SajuPillarsInput } from './types'
...
import { determineGeokguk, type GeokgukResult } from './geokguk'
import { determineYongsin, type YongsinResult } from './yongsin'
...
import type { FiveElement, RelationHit } from './types'
// 합살/합화/천간합/지지 충형해파/원진/귀문 — 정통 관계 분석
import { analyzeRelations, type AnalyzeInput as RelAnalyzeInput } from './relations'
// 전체 신살 (양인·백호·괴강·현침·도화·역마·천을귀인 등)
import { getShinsalHits, type ShinsalHit as ShinsalHitRich } from './shinsal'
