...
import { SAJU_CACHE, DAEUN_CACHE, COMPATIBILITY_CACHE, CACHE_KEY } from '@/lib/constants/cache'
 ...
 */
export function generateCompatibilityCacheKey(person1Key: string, person2Key: string): string {
  const sep = CACHE_KEY.SEPARATOR
  // 순서에 관계없이 같은 키 생성
