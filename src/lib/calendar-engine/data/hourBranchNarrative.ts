...
export const HOUR_BRANCH_NARRATIVE: Record<Branch, HourBranchNarrative> = {
  ...
  축: {
    ...
    baselineEn: 'Deepest sleep window. The body needs full rest here.',
    positiveKo: '꿈과 직관이 활발해져요. 영감이 떠오르면 짧게 메모해두세요.',
    positiveEn: 'Dreams and intuition come alive. If insight comes, jot it down briefly.',
  ...
  인: {
    ...
    baselineEn: 'Dawn energy starts to rise. Breathwork and morning routines settle well.',
  ...
  묘: {
    ...
    baselineEn: 'Morning setup hour. Light walks, stretching, and planning fit well.',
  ...
  진: {
    ...
    baselineEn: 'The active phase begins. Commute, meeting setup, first calls all fit.',
  ...
  오: {
    ...
    positiveEn: 'A great time for lunch with people; new connections settle naturally.',
  ...
  미: {
    ...
    baselineEn: 'Digest-and-organize time. Follow-ups and admin work flow easily.',
  ...
  신: {
    ...
    baselineEn: 'Late-afternoon recharge. Collaboration and brainstorming fit here.',
  ...
  유: {
    ...
    baselineEn: 'Day wrap-up time. Closing tasks and checklists fit best.',
    ...
    cautionEn: 'Heavy drinks or commitments here cost you tomorrow.',
  },
  술: {
    windowKo: '19-21시 (술시)',
    windowEn: '7-9pm (Dog hour)',
    baselineKo: '저녁이 안정되는 시간이에요. 가족이나 가까운 사람, 휴식이 핵심이에요.',
    baselineEn: 'Evening settles. Family, close ties, and rest take center.',
  ...
  해: {
    ...
    baselineEn: 'Day-closing time. Rest, read, or do a light meditation.',
    positiveKo: '꿈, 창작, 잠들기 전 짧은 영감 노트가 자리잡기 좋아요.',
    positiveEn: 'Dreams, creative bursts, and pre-sleep notes settle here.',
