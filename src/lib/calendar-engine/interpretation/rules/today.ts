...
export const RULES_TODAY: InterpretationRule[] = [
  ...
  },
  {
    ...
    template: `오늘은 **돈·실리 감각**이 좋은 결 — 거래·정산·실속 챙기는 일에 좋아요.`,
  ...
  },
  {
    ...
    template: `오늘은 **책임·공식 일**에 집중 좋은 결 — 보고·결재·약속 처리에 좋아요.`,
  ...
  },
  {
    ...
    template: `오늘은 **귀인의 날** — 부탁·면담·중요한 연락에 우호적. 미뤘던 사람에게 먼저 연락해 보세요.`,
  ...
  },
  {
    ...
    template: `오늘은 **막힘·지연이 끼는 결** — 한 번에 안 풀릴 수 있어요. 새로 벌이기보다 점검·마무리에 집중하세요.`,
  ...
  },
  {
    ...
    template: `오늘은 **머리가 맑은 결** — 공부·시험·자격·집필·기획이 잘 풀려요. 인풋·아웃풋 둘 다 좋아요.`,
  ...
  },
  {
    ...
    template: `오늘은 **기세가 오르는 결** — 주도권 잡고 밀어붙이기 좋아요. 발표·승부·자기 어필에 좋아요.`,
