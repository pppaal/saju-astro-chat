...
const SHINSAL_POLARITY: Record<string, Polarity> = {
  // 길신
  '천을귀인': 3, '천덕귀인': 2, '월덕귀인': 2,
  '문창귀인': 2, '학당귀인': 2, '관귀학관': 2,
  '천을': 3, '천덕': 2, '월덕': 2,
  // 도화·역마·화개 — 중립이지만 테마 강력
  '도화': 1, '도화살': 1, '홍염': 1, '홍염살': 1,
  '역마': 0, '역마살': 0,
  '화개': 1, '화개살': 1,
  '장성': 2, '장성살': 2,
  // 흉신
  '백호': -2, '백호살': -2, '괴강': -1, '괴강살': -1,
  '양인': -2, '양인살': -2, '현침': -1, '현침살': -1,
  '공망': -1, '원진': -2, '귀문': -1, '귀문관살': -1,
  '망신': -1, '망신살': -1, '겁살': -2, '재살': -2, '천살': -1,
  '지살': 0, '월살': -1, '화개': 1,
  '육해': -1, '육해살': -1,
}
