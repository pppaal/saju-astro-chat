...
export const SHINSAL_THEME_MAP: Record<string, AstroThemeKey[]> = {
  // ─── 12신살 ───
  장성:  ['career', 'reputation'],         장성살: ['career', 'reputation'],
  반안:  ['family', 'social'],             반안살: ['family', 'social'],
  역마:  ['travel', 'career'],             역마살: ['travel', 'career'],
  육해:  ['health', 'crisis'],             육해살: ['health', 'crisis'],
  화개:  ['spirituality', 'study'],        화개살: ['spirituality', 'study'],
  겁살:  ['crisis', 'money'],
  재살:  ['crisis', 'legal'],
  천살:  ['crisis', 'health'],
  월살:  ['money', 'crisis'],
  망신:  ['reputation', 'crisis'],         망신살: ['reputation', 'crisis'],
  지살:  ['travel', 'business'],
  년살:  ['love', 'social'],

  // ─── 길성 ───
  천을귀인: ['career', 'reputation', 'crisis'],  천을: ['career', 'reputation', 'crisis'],
  태극귀인: ['spirituality', 'reputation'],
  천덕귀인: ['health', 'family'],                천덕: ['health', 'family'],
  월덕귀인: ['health', 'family'],                월덕: ['health', 'family'],
  천주귀인: ['family', 'money'],
  암록:     ['money', 'career'],
  금여성:   ['love', 'money'],                    금여: ['love', 'money'],
  천의성:   ['health', 'study'],
  천문성:   ['study', 'spirituality'],
  문창:     ['study', 'reputation'],              문창귀인: ['study', 'reputation'],
  문곡:     ['study', 'creativity'],
  학당귀인: ['study'],                            학당: ['study'],
  관귀학관: ['study', 'career'],
  건록:     ['career', 'money'],
  제왕:     ['career', 'reputation'],
  길성:     ['personality'],

  // ─── 도화·홍염 (애정·매력) ───
  도화:   ['love', 'creativity', 'social'],       도화살: ['love', 'creativity', 'social'],
  홍염:   ['love'],                               홍염살: ['love'],

  // ─── 흉살 ───
  현침:   ['crisis', 'health'],                   현침살: ['crisis', 'health'],
  고신:   ['social', 'crisis'],                   고신살: ['social', 'crisis'],
  과숙:   ['family', 'crisis'],                   과숙살: ['family', 'crisis'],
  괴강:   ['career', 'crisis'],                   괴강살: ['career', 'crisis'],
  양인:   ['career', 'crisis'],                   양인살: ['career', 'crisis'],
  백호:   ['crisis', 'health'],                   백호살: ['crisis', 'health'],
  공망:   ['crisis', 'spirituality'],
  귀문관: ['health', 'spirituality'],             귀문: ['health', 'spirituality'],
  귀문관살: ['health', 'spirituality'],
  원진:   ['family', 'crisis'],
  천라지망: ['crisis', 'legal'],
  삼재:   ['crisis'],
  화해:   ['family', 'crisis'],                   화해살: ['family', 'crisis'],
  괘살:   ['crisis'],
  흉성:   ['crisis'],
}
