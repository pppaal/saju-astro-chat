...
const PLANET_HOUSE_LINES: Record<PlanetHouseKey, Record<HouseNumber, SignLine>> = {
  Sun: {
    1: {
      ko: '태양이 자아의 자리에 놓여서, 본인 자신이 곧 빛나는 무대가 돼요. 첫인상과 존재감만으로도 정체성이 또렷이 드러나는 느낌이에요.',
    ...
    2: {
      ko: '본인다움이 자원과 가치관의 자리에서 드러나요. 손에 잡히는 결과와 자신만의 기준을 통해 정체성이 단단해지는 스타일이에요.',
    ...
    4: {
      ko: '가정과 뿌리의 자리에 빛이 머물러서, 안에서부터 정체성이 다져져요. 가족·집·고향 같은 사적인 자리에서 가장 본인답게 빛나는 모습이에요.',
    ...
    5: {
      ko: '창조·놀이·연애의 자리에서 가장 본인답게 빛나요. 표현이 곧 정체성이고, 무대 위에 설 때 면이 또렷해지는 사람.',
    ...
    6: {
      ko: '일상의 노동과 돌봄의 자리에서 자기를 풀어내요. 매일의 디테일을 다듬는 과정에서 본인다움이 또렷해지는 느낌이에요.',
    ...
    7: {
      ko: '관계와 파트너십의 자리에 자아가 머물러요. 일대일 만남 속에서 본인이 누구인지 또렷해지고, 상대가 정체성의 거울이 되는 스타일이에요.',
    ...
    9: {
      ko: '확장과 신념·먼 여정의 자리에 자아가 머물러요. 더 큰 그림과 의미를 향해 가는 길 자체가 본인다움인 모습이에요.',
      en: 'The Sun in the 9th house lives in expansion, belief, and long journeys — the search for larger meaning is identity itself.',
    },
    10: {
      ko: '커리어와 사회적 자리에 빛이 올라가요. 공적인 무대에서 본인다움이 가장 또렷하고, 성취와 평판이 곧 정체성이 되는 느낌이에요.',
    ...
    11: {
      ko: '친구·커뮤니티·미래 비전의 자리에서 본인다움이 풀려요. 큰 그룹과 함께 가는 길에서 정체성이 또렷해지는 스타일이에요.',
    ...
    12: {
      ko: '내면과 은둔·영성의 자리에 빛이 머물러요. 보이지 않는 자리에서 정체성이 깊어지고, 조용히 있을 때 가장 본인다워지는 모습이에요.',
  ...
  Moon: {
    1: {
      ko: '감정이 표면에 그대로 드러나요. 본인의 기분이 곧 첫인상이 되고, 정서가 정체성과 거의 한 덩어리로 움직이는 느낌이에요.',
    ...
    2: {
      ko: '자원과 소유 안에서 정서적 안전을 찾아요. 손에 잡히는 안정·물질적 토대가 있어야 마음이 차분해지는 스타일이에요.',
    ...
    3: {
      ko: '대화와 학습이 정서의 안식처예요. 말로 풀어내고 가까운 사람과 주고받을 때 마음이 안정되는 모습이에요.',
    ...
    4: {
      ko: '가정과 뿌리가 정서의 토대예요. 집·가족·고향 같은 사적인 자리에서 마음이 가장 안전해지는 느낌이에요.',
    ...
    5: {
      ko: '창조와 놀이로 감정이 풀려요. 표현하고 연애하고 무언가를 만들어낼 때 마음이 회복되는 스타일이에요.',
    ...
    6: {
      ko: '일상의 루틴과 돌봄에서 마음의 안정을 찾아요. 작은 일과를 챙기고 누군가를 보살피는 일이 정서적 회복이 되는 모습이에요.',
    ...
    7: {
      ko: '관계 안에서 정서가 비춰져요. 파트너를 통해 자기 마음을 알게 되고, 일대일 친밀함 안에서 가장 안정되는 느낌이에요.',
    ...
    8: {
      ko: '강렬한 변화와 깊은 결합의 자리에서 정서의 면이 자라요. 위기를 통과하며 마음이 단단해지고, 얕은 연결로는 만족이 어려운 스타일이에요.',
    ...
    9: {
      ko: '신념과 큰 그림이 정서의 안식처예요. 여행·배움·철학 안에서 마음이 자유로워지고 채워지는 모습이에요.',
    ...
    10: {
      ko: '사회적 성취와 인정이 정서와 깊이 엮여요. 평판과 공적인 자리가 마음을 흔드는 면, 일에서 받는 인정이 곧 정서적 회복인 느낌이에요.',
    ...
    11: {
      ko: '친구와 커뮤니티가 정서의 안전망이에요. 무리 속에서 마음이 채워지고, 같은 비전을 나누는 그룹이 가족처럼 느껴지는 스타일이에요.',
    ...
    12: {
      ko: '고독과 영성 안에서 정서의 본질을 만나요. 보이지 않는 자리에서 마음이 깊어지고, 가끔의 은둔이 회복인 모습이에요.',
  ...
  Mercury: {
    1: {
      ko: '말과 사고가 정체성 자체로 드러나요. 본인이 어떻게 말하고 생각하는지가 곧 첫인상이고, 머리의 빠른 회전이 본인다움인 느낌이에요.',
    ...
    2: {
      ko: '실용적 사고가 자원의 흐름을 만들어요. 가치와 손에 잡히는 결과를 따져 보는 머리가 자산을 짓는 스타일이에요.',
    ...
    3: {
      ko: '소통과 짧은 학습이 본인의 핵심 모습이에요. 가까운 거리의 정보 교환·이웃·형제자매와의 교류에서 머리가 가장 빛나요.',
    ...
    4: {
      ko: '가정·뿌리 안에서 사고가 차분히 다듬어져요. 집과 가족 안에서 말하고 정리하는 일이 본인의 느낌이에요.',
    ...
    5: {
      ko: '창의적 표현과 즐거운 학습이 사고의 스타일이에요. 글쓰기·놀이·아이들과의 교류 안에서 머리가 가장 자유롭게 펼쳐져요.',
    ...
    6: {
      ko: '일상의 분석·관리에서 명민함이 빛나요. 디테일을 다듬고 시스템을 정리하는 자리에서 머리가 가장 또렷한 모습이에요.',
    ...
    7: {
      ko: '대화와 협력 안에서 사고가 정리돼요. 파트너와 주고받는 말 속에서 본인 생각의 면이 또렷해지는 느낌이에요.',
    ...
    8: {
      ko: '심층 연구·심리·재무 분석이 본인다움이에요. 표면 밑의 패턴을 꿰뚫는 머리가 가장 본인답게 작동하는 스타일이에요.',
    ...
    9: {
      ko: '큰 그림·철학·국제적 시야가 사고의 모습이에요. 먼 거리의 학문·외국어·신념 체계 안에서 머리가 가장 크게 펼쳐져요.',
    ...
    10: {
      ko: '공적 자리에서 말과 사고가 평판이 돼요. 공식적인 발언·발표·전문성 있는 글이 곧 커리어 자산이 되는 느낌이에요.',
    ...
    12: {
      ko: '내면 사유와 명상에서 깊은 통찰이 열려요. 혼자 있을 때 머리가 가장 또렷해지고, 직관에 가까운 사고가 작동하는 스타일이에요.',
  ...
  Venus: {
    1: {
      ko: '매력이 첫인상으로 그대로 드러나요. 본인의 외양·태도 자체가 호감을 자아내고, 미적 감각이 정체성과 한 덩어리인 모습이에요.',
    ...
    2: {
      ko: '소유와 감각이 미감의 토대예요. 손에 잡히는 아름다움·편안한 환경·물질적 안정이 사랑과 만족의 통로인 느낌이에요.',
    ...
    3: {
      ko: '대화와 학습 안에서 끌림이 시작돼요. 말의 면·재치·짧은 글이 사랑과 호감을 자아내는 스타일이에요.',
    ...
    4: {
      ko: '가정·뿌리가 미감과 안식의 자리예요. 집을 아름답게 꾸미고 가족 안에서 사랑을 누리는 방식이 본인의 모습이에요.',
    ...
    5: {
      ko: '창조와 연애가 미감의 정점이에요. 예술·놀이·로맨스의 자리에서 사랑이 가장 직접적으로 표현되는 느낌이에요.',
    ...
    6: {
      ko: '일상 챙김과 작은 봉사 안에서 사랑이 풀려요. 누군가를 위해 매일의 디테일을 다듬는 일이 곧 애정 표현인 스타일이에요.',
    ...
    7: {
      ko: '관계와 파트너십이 정체성의 거울이에요. 일대일 만남이 본인의 가장 핵심 무대이고, 사랑이 곧 본인다움인 모습이에요.',
    ...
    8: {
      ko: '깊은 결합과 공유 자원에서 가치가 만들어져요. 강도 높은 친밀함·신뢰·금기 영역의 사랑이 본인의 느낌이에요.',
    ...
    9: {
      ko: '먼 곳·다른 문화 안에서 사랑이 깨어나요. 여행지·외국·철학적 대화 속에서 끌림이 가장 또렷해지는 스타일이에요.',
    ...
    10: {
      ko: '공적 자리에서 매력과 미감이 자산이 돼요. 커리어와 사회적 평판이 사랑·아름다움과 깊이 엮이는 모습이에요.',
    ...
    11: {
      ko: '커뮤니티와 친구가 사랑의 통로예요. 같은 비전을 나누는 그룹·우정 안에서 애정이 자연스럽게 자라는 느낌이에요.',
    ...
    12: {
      ko: '내면·은둔 안에서 깊은 사랑이 자라요. 보이지 않는 자리·비밀·영성 안에서 사랑이 가장 본질에 닿는 스타일이에요.',
  ...
  Mars: {
    1: {
      ko: '자기 자신을 던지는 게 행동의 결인 사람. 추진력과 욕망이 첫인상과 태도로 그대로 드러나는 모습이에요.',
      en: 'Mars in the 1st house gives action a self-thrown grain — drive and desire show right in first impression and bearing.',
    },
    2: {
      ko: '자원·소유를 쌓는 행동에서 욕망이 풀려요. 손에 잡히는 결과·재화·기술을 쌓아 올리는 일이 본인의 느낌이에요.',
    ...
    3: {
      ko: '말과 학습을 추진하는 자리에서 본인다움이 살아나요. 빠른 정보 교환·가까운 거리의 활동·이웃과의 분주함이 추진력인 스타일이에요.',
    ...
    4: {
      ko: '가정·뿌리를 지키는 행동이 욕망의 모습이에요. 집과 가족을 위해 움직이는 일이 본인의 가장 깊은 추진력인 느낌이에요.',
    ...
    5: {
      ko: '창조·연애의 자리에서 욕망이 폭발해요. 표현·로맨스·놀이의 무대에서 추진력이 가장 직접적으로 풀리는 스타일이에요.',
    ...
    6: {
      ko: '일상 노동·운동·반복 작업에서 추진력이 풀려요. 매일의 루틴 안에서 몸을 쓰는 일이 본인의 모습이에요.',
    ...
    7: {
      ko: '관계와 파트너십 안에서 욕망이 비춰져요. 일대일 만남에서 자기 추진력을 알게 되고, 상대가 자극제가 되는 느낌이에요.',
    ...
    8: {
      ko: '심층 변화·공유 자원·위기에서 추진력이 풀려요. 깊은 변혁의 자리에서 욕망이 가장 또렷해지는 스타일이에요.',
    ...
    9: {
      ko: '여행·확장·학문 추진에서 본인다움이 살아나요. 먼 곳·신념·큰 그림을 향해 가는 일이 욕망의 모습이에요.',
    ...
    10: {
      ko: '공적 자리·커리어 추진에서 욕망이 가장 또렷한 느낌이에요. 사회 무대를 점령하려는 의지가 본인의 핵심 동력인 스타일이에요.',
    ...
    11: {
      ko: '커뮤니티·미래 비전을 위한 행동이 본인의 모습이에요. 그룹·운동·집단적 변화를 위해 추진력을 쓰는 사람.',
    ...
    12: {
      ko: '뒤에서·내면에서 조용히 행동하는 면, 보이지 않는 추진. 직접 부딪히기보다 간접적·영적·예술적 통로로 욕망이 풀리는 느낌이에요.',
  ...
  Jupiter: {
    1: {
      ko: '자기 자신·정체성에 풍요와 자신감이 깃드는 자리, 본인이 곧 기회의 통로인 스타일이에요. 존재감만으로도 사람과 행운이 모이는 모습이에요.',
    ...
    2: {
      ko: '자원·소유·수입의 길이 넉넉히 열리는 면, 가치가 풍성하게 쌓이는 자리. 손에 잡히는 자산이 시간이 갈수록 자라는 느낌이에요.',
    ...
    3: {
      ko: '학습·소통·이웃과의 교류에서 기회가 트이는 면, 말과 글이 자산이 되는 자리. 다양한 시도와 짧은 학습이 풍요를 부르는 스타일이에요.',
    ...
    4: {
      ko: '가정·뿌리·부동산이 풍요의 무대인 면, 안에서부터 크게 자라는 자리. 가족과 집안의 기반이 본인의 가장 큰 자산이 되는 모습이에요.',
    ...
    5: {
      ko: '창작·연애·자녀의 자리에서 행운이 가장 또렷한 면, 표현이 풍요로 이어지는 자리. 무대 위에서 빛나면 자연스럽게 기회가 따라오는 느낌이에요.',
    ...
    6: {
      ko: '일상의 노동·건강 관리에서 의미가 커지는 면, 작은 봉사가 큰 자산이 되는 자리. 매일의 디테일이 시간이 갈수록 풍요로 자라는 스타일이에요.',
    ...
    7: {
      ko: '관계·파트너십이 확장의 통로인 면, 사람을 통해 세계가 넓어지는 자리. 파트너와의 만남이 인생의 가장 큰 행운으로 기능하는 모습이에요.',
    ...
    8: {
      ko: '심층 변화·공유 자원에서 큰 기회가 열리는 면, 위기 뒤에 풍요가 따라오는 자리. 변혁을 통과한 자리에서 자원이 들어오는 느낌이에요.',
    ...
    9: {
      ko: '먼 곳·학문·믿음에서 본인다움이 가장 크게 펼쳐지는 면, 확장이 곧 정체성인 자리. 여행과 큰 그림이 인생을 풍성하게 만드는 스타일이에요.',
    ...
    10: {
      ko: '사회 무대·커리어가 풍요의 정점인 면, 공적 성취가 그대로 자산이 되는 자리. 평판·인정·공적인 길이 본인의 가장 큰 행운인 모습이에요.',
    ...
    11: {
      ko: '커뮤니티·미래 비전이 기회의 통로인 면, 친구와 그룹에서 풍요가 들어오는 자리. 같은 비전을 나누는 사람들이 행운을 데려오는 느낌이에요.',
    ...
    12: {
      ko: '내면·영성·은둔에서 큰 의미가 자라는 면, 보이지 않는 곳에서 풍요가 익는 자리. 조용한 자기 시간이 가장 큰 자산으로 자라는 스타일이에요.',
  ...
  Saturn: {
    1: {
      ko: '자기 자신·정체성에 무게가 실린 면, 일찍부터 어른의 옷을 입는 자리. 본인다움이 시간과 노력으로 천천히 빚어지는 모습이에요.',
    ...
    2: {
      ko: '자원·소유·가치 위에 책임이 얹히는 면, 천천히 단단해지는 자리. 풍요가 한 번에 오지 않고 꾸준한 빌드로 자라는 느낌이에요.',
    ...
    3: {
      ko: '소통·학습이 단련을 거치는 면, 말과 사고에 신중함이 자리잡는 스타일이에요. 가벼운 잡담보다 깊고 정확한 말로 신뢰를 짓는 모습이에요.',
    ...
    4: {
      ko: '가정·뿌리에 무게와 책임이 깔리는 면, 안에서부터 단단해져야 하는 자리. 가족 안의 책임이 본인을 빚는 느낌이에요.',
    ...
    5: {
      ko: '창작·연애·자녀의 자리에서 시험이 따라오는 면, 표현이 책임으로 다듬어지는 자리. 가벼운 즐거움보다 깊고 진지한 표현으로 결과를 짓는 스타일이에요.',
    ...
    6: {
      ko: '책임의 별이 일상과 건강의 자리에 머물러, 일상 루틴과 자기 관리에 무게가 실려요. 꾸준한 노력이 결국 안정된 기반을 만들어내는 모습이에요.',
    ...
    7: {
      ko: '관계 안에서 책임과 시간이 시험대인 면, 오래 견디는 만남이 본인을 빚는 자리. 가벼운 인연보다 깊고 오래된 관계가 본인의 느낌이에요.',
    ...
    8: {
      ko: '심층 변화·공유 자원에서 깊은 책임이 쌓이는 면, 위기와 마주해 단단해지는 자리. 변혁의 자리에서 신중함과 통제력이 본인을 빚는 스타일이에요.',
    ...
    9: {
      ko: '신념·학문·먼 곳에서 단련이 따라오는 면, 천천히 익히는 진리의 자리. 큰 그림을 책임 있게 빌드하는 사람.',
    ...
    10: {
      ko: '커리어·사회 무대가 본인의 정점이자 시험대인 면, 평판이 곧 구조인 자리. 시간이 걸려도 단단한 권위를 짓는 사람.',
    ...
    11: {
      ko: '커뮤니티·미래 비전에 책임이 따라오는 면, 그룹 안에서 어른 역할이 자리잡는 모습이에요. 친구 무리 안에서 신뢰받는 진중한 자리.',
    ...
    12: {
      ko: '내면의 그림자·고독에서 깊은 단련이 일어나는 면, 보이지 않는 무게를 짊어지는 자리. 조용한 자기 작업이 가장 큰 빌드인 느낌이에요.',
  ...
  Uranus: {
    1: {
      ko: '자기 자신을 끊임없이 새로 정의하는 면, 정체성이 곧 파격인 자리. 첫인상부터 보통과 다른 면을 가진 사람.',
    ...
    2: {
      ko: '자원·가치에 파격이 따라오는 면, 새로운 방식으로 손에 잡는 자리. 수입의 길과 가치관이 통상적이지 않은 스타일이에요.',
    ...
    3: {
      ko: '사고·소통에 돌발과 영감이 깃드는 면, 한 박자 빠른 통찰의 자리. 보통 사람의 면을 가로지르는 아이디어가 자연스러운 모습이에요.',
    ...
    4: {
      ko: '가정·뿌리가 보통과 다른 면, 떠나고 다시 만드는 자리. 가족 패턴이 통상적이지 않거나 자주 재편되는 느낌이에요.',
    ...
    5: {
      ko: '창작·연애의 자리에서 자유가 가장 또렷한 면, 틀을 벗는 표현의 자리. 정형적인 로맨스보다 새로운 결의 만남이 본인다운 스타일이에요.',
    ...
    6: {
      ko: '일상·노동의 자리에서 혁신이 풀리는 면, 새로운 방식의 작업이 본인의 모습이에요. 정형적인 루틴보다 자유로운 흐름이 맞는 느낌이에요.',
    ...
    7: {
      ko: '관계가 보통과 다른 면, 자유와 평등이 만남의 조건인 자리. 통상적인 결혼/파트너십 모델보다 본인만의 면을 짓는 사람.',
    ...
    8: {
      ko: '심층·금기·공유 자원에서 파격이 일어나는 면, 변혁이 본인을 깨우는 자리. 깊은 자리에서의 갑작스러운 변화가 본인의 스타일이에요.',
    ...
    9: {
      ko: '신념·학문에 혁명이 깃드는 면, 기존 진리를 부수고 새 길을 여는 자리. 통념을 다시 쓰는 사고가 본인다움인 모습이에요.',
    ...
    10: {
      ko: '커리어가 보통과 다른 면, 새로운 직업·길을 여는 자리. 정형적인 직장이 답답하고, 본인만의 길을 만들어 가는 느낌이에요.',
    ...
    11: {
      ko: '커뮤니티·비전 안에서 혁명이 펼쳐지는 면, 미래의 그룹에 본인이 깃드는 자리. 보통 무리보다 진보적인 그룹이 본인의 본거지인 스타일이에요.',
    ...
    12: {
      ko: '무의식·은둔에서 돌발적 통찰이 터지는 면, 보이지 않는 자리에서 깨어나는 모습이에요. 혼자 있을 때 가장 자유로운 사고가 폭발하는 느낌이에요.',
  ...
  Neptune: {
    1: {
      ko: '자기 자신이 안개·꿈처럼 흐르는 면, 정체성이 유동적인 자리. 첫인상이 신비롭거나 잡히지 않는 스타일이에요.',
    ...
    2: {
      ko: '자원·소유의 경계가 흐려지는 면, 가치가 영적인 방향으로 옮겨지는 자리. 물질만으로 만족하기 어려운 모습이에요.',
    ...
    3: {
      ko: '소통·사고가 직관에 잠기는 면, 말이 시처럼 흐르는 자리. 논리만으로 잡히지 않는 통찰이 본인의 느낌이에요.',
    ...
    4: {
      ko: '가정·뿌리에 영적 면이 깃드는 면, 집이 곧 성소가 되는 자리. 가족 관계의 경계가 흐릿하거나 신비로운 스타일이에요.',
    ...
    5: {
      ko: '창작·연애의 자리에서 환상이 가장 짙은 면, 영감이 표현으로 직접 흐르는 자리. 로맨틱한 이상이 본인의 모습이에요.',
    ...
    6: {
      ko: '일상·건강의 경계가 모호해지는 면, 돌봄이 영적인 일이 되는 자리. 몸의 신호가 미세하게 흐르는 느낌이에요.',
    ...
    7: {
      ko: '관계가 환상에 잠기는 면, 상대를 통해 무한을 보는 자리. 파트너에게 신비로운 이상을 투사하기 쉬운 스타일이에요.',
    ...
    8: {
      ko: '심층·공유 자원이 신비에 잠기는 면, 변혁과 영성이 같은 자리에 모이는 모습이에요. 깊은 자리에서 직관·신비 체험이 일어나는 느낌이에요.',
    ...
    9: {
      ko: '신념·학문이 영성에 녹는 면, 진리가 직관으로 다가오는 자리. 종교·신비주의·먼 여행이 본인의 스타일이에요.',
    ...
    10: {
      ko: '커리어가 비전·예술에 잠기는 면, 공적 자리에서 환상이 자산이 되는 모습이에요. 예술·치유·영성 관련 커리어가 본인다움인 느낌이에요.',
    ...
    11: {
      ko: '커뮤니티·미래 비전이 영적인 면, 큰 꿈이 그룹과 함께 흐르는 자리. 영적·예술적 친구들이 본거지인 스타일이에요.',
    ...
    12: {
      ko: '내면·은둔·영성이 본인의 본거지인 면, 보이지 않는 자리에서 가장 또렷한 모습이에요. 명상·꿈·예술 안에서 자기 본질을 만나는 느낌이에요.',
  ...
  Pluto: {
    1: {
      ko: '자기 자신을 통째로 다시 빚는 면, 정체성이 죽고 다시 태어나는 자리. 존재감만으로 강도가 전달되는 스타일이에요.',
    ...
    2: {
      ko: '자원·소유·가치의 격변을 거치는 면, 가치 체계가 통째로 새로 쓰이는 자리. 돈·물질을 둘러싼 깊은 권력 작업이 본인의 모습이에요.',
    ...
    3: {
      ko: '사고·소통이 깊이 변혁되는 면, 말 한 마디에 권력이 실리는 자리. 표면 밑을 꿰뚫는 사고가 본인다움인 느낌이에요.',
    ...
    4: {
      ko: '가정·뿌리의 격변을 거치는 면, 가족 패턴이 통째로 다시 짜이는 자리. 가족 안의 어두운 자리를 발굴해 다시 짓는 스타일이에요.',
    ...
    5: {
      ko: '창작·연애의 자리에서 강렬함이 가장 또렷한 면, 표현이 곧 변혁인 자리. 어중간한 로맨스로는 만족하기 어려운 모습이에요.',
    ...
    6: {
      ko: '일상·건강이 변혁의 자리인 면, 작은 루틴 안에서 깊은 권력이 풀리는 느낌이에요. 매일의 디테일을 통제하고 재편하는 일이 본인의 스타일이에요.',
    ...
    7: {
      ko: '관계의 격변을 통해 본인이 다시 빚어지는 면, 상대가 곧 거울인 자리. 일대일 만남이 권력·신뢰의 시험대인 모습이에요.',
    ...
    8: {
      ko: '심층·공유 자원이 본인의 정체성 자체인 면, 변혁이 본거지인 자리. 죽음·재생·금기 영역이 본인의 본질에 닿는 느낌이에요.',
    ...
    9: {
      ko: '신념·학문이 변혁의 자리인 면, 진리가 죽고 다시 태어나는 자리. 한 번 믿었던 세계관이 무너지고 다시 짓는 스타일이에요.',
    ...
    10: {
      ko: '커리어·권력이 정점에 닿는 면, 사회 무대에서 통째로 다시 빚어지는 자리. 평판과 영향력을 깊이 다루는 자리.',
    ...
    11: {
      ko: '커뮤니티·집단의 변혁을 이끄는 면, 그룹의 권력 구조가 본인 손에 흐르는 자리. 운동·집단 변혁이 본인의 모습이에요.',
    ...
    12: {
      ko: '무의식의 변혁이 일어나는 면, 보이지 않는 자리에서 죽고 다시 태어나는 느낌이에요. 그림자 작업과 영적 변혁이 본인의 가장 깊은 스타일이에요.',
...
export const ASPECT_PAIR_DICTIONARY: AspectPairEntry[] = [
  ...
  // ---------- Sun × Moon (identity × emotion) ----------
  {
    ...
    ko: '자아와 감정이 한 자리에서 만나, 의식과 무의식이 한 톤으로 흐르는 모습이에요. 의지와 감정이 자연스럽게 같은 방향을 보는 흐름.',
  ...
  },
  {
    ...
    ko: '의지가 가는 길과 마음이 원하는 자리가 어긋나는 스타일이에요. 자아와 감정 사이의 긴장이 성장의 엔진이 돼요.',
  ...
  },
  {
    ...
    ko: '의지와 감정이 같은 강물에 흐르는 모습이에요. 자아 표현이 감정의 결과 잘 맞아 큰 노력 없이 자기다움이 나와요.',
  ...
  },
  {
    ...
    ko: '의지와 감정이 마주 보며 균형을 찾아가는 느낌이에요. 관계 안에서 자아와 마음의 두 축이 통합돼요.',
  ...
  // ---------- Sun × Venus (identity × love) ----------
  {
    ...
    ko: '자아의 별과 사랑의 별이 한 자리에 모여 빛나는 스타일이에요. 자기 표현 자체가 매력이 되고, 사랑이 정체성의 일부로 흘러요.',
  ...
  },
  {
    ...
    ko: '자아와 사랑이 가볍게 협력하는 모습이에요. 사교, 예술, 관계에서 부드러운 기회가 자주 다가와요.',
  ...
  },
  {
    ...
    ko: '자기 표현과 사랑의 면이 살짝 어긋나, 자존감과 관계 욕구 사이에서 갈등이 생기는 느낌이에요. 자기다움과 사랑의 균형을 배우게 돼요.',
  ...
  },
  {
    ...
    ko: '자아와 사랑이 같은 식으로 흐르는 스타일이에요. 매력과 자기 표현이 자연스럽게 어울려, 호감과 미적 감각이 타고난 강점이 돼요.',
  ...
  },
  {
    ...
    ko: '자아와 사랑이 마주 서서 균형을 배우는 모습이에요. 관계 안에서 자기다움과 상대 만족 사이를 오가며 통합점을 찾아요.',
  ...
  // ---------- Sun × Mars (identity × drive) ----------
  {
    ...
    ko: '자아의 별과 추진의 별이 한 자리에서 만나는 느낌이에요. 의지와 행동이 한 몸이 되어, 결정이 바로 움직임으로 바뀌어요.',
  ...
  },
  {
    ...
    ko: '자아와 추진이 부드럽게 협력하는 스타일이에요. 목표를 정하면 행동이 따라오지만, 멈춰 있으면 발화되지 않아요.',
  ...
  },
  {
    ...
    ko: '자아와 행동이 어긋난 각도로 맞물려, 추진은 강하지만 자주 부딪치는 모습이에요. 갈등 안에서 자기 의지를 다듬어가요.',
  ...
  },
  {
    ...
    ko: '자아와 추진이 같은 강물에 흐르는 느낌이에요. 행동이 자기다움을 그대로 표현해, 활력과 용기가 타고난 강점이 돼요.',
  ...
  },
  {
    ...
    ko: '자아와 확장이 어긋난 각도로 맞물려, 자신을 크게 펼치고 싶은 마음과 현실의 한계가 부딪치는 스타일이에요. 과한 자신감을 다듬는 과제예요.',
  ...
  },
  {
    ...
    ko: '자아와 확장이 같은 식으로 흐르는 모습이에요. 자기다움이 그대로 풍요와 신뢰로 이어지는 타고난 행운의 느낌이에요.',
    ...
    keywords_ko: ['타고난 행운', '풍요의 흐름', '신뢰의 느낌'],
    keywords_en: ['inborn fortune', 'abundance flow', 'trust-line'],
  },
  {
    planet1: 'Sun', planet2: 'Jupiter', aspect: 'opposition',
    ko: '자아와 확장이 마주 서서 균형을 찾는 스타일이에요. 자기다움과 큰 그림 사이를 오가며, 과욕과 절제의 중심점을 배우게 돼요.',
  ...
  // ---------- Sun × Saturn (identity × responsibility) ----------
  {
    ...
    ko: '자아의 별과 책임의 별이 한 자리에서 만나는 모습이에요. 자기다움이 구조와 함께 자라, 단단한 어른의 면을 일찍 입어요.',
  ...
  },
  {
    ...
    ko: '자아와 책임이 부드럽게 협력하는 느낌이에요. 꾸준한 노력이 자기다움을 단단하게 만들어, 의식적으로 쓸수록 강해져요.',
    ...
    keywords_ko: ['꾸준함의 느낌', '구조의 협력', '의식적 단련'],
    keywords_en: ['steady gift', 'structured cooperation', 'conscious discipline'],
  },
  {
    planet1: 'Sun', planet2: 'Saturn', aspect: 'square',
    ko: '자아와 책임이 어긋난 각도로 맞물려, 자기 표현과 의무 사이에서 무게가 느껴지는 스타일이에요. 자기다움을 부정하지 않고 책임을 지는 법을 배워요.',
  ...
  // ---------- Moon × Mercury (emotion × mind) ----------
  {
    ...
    ko: '감정의 별과 생각의 별이 한 자리에서 만나는 스타일이에요. 느끼는 그대로 말이 되어 나와, 정서와 사고가 거의 동시에 움직여요.',
  ...
  },
  {
    ...
    ko: '감정과 생각이 부드럽게 협력하는 모습이에요. 마음을 말로 옮기는 일이 자연스러워, 표현하려 할수록 잘 풀려요.',
  ...
  },
  {
    ...
    ko: '감정과 생각이 어긋난 각도로 맞물려, 마음과 말이 자주 따로 노는 느낌이에요. 느낌을 적확히 옮기는 법을 배우는 과제예요.',
  ...
  },
  {
    ...
    ko: '감정과 생각이 같은 식으로 흐르는 스타일이에요. 마음과 말이 자연스럽게 어울려, 공감과 소통이 타고난 강점이 돼요.',
  ...
  // ---------- Moon × Venus (emotion × love) ----------
  {
    ...
    ko: '감정의 별과 사랑의 별이 한 자리에 모이는 느낌이에요. 마음 그대로가 애정이 되어, 정서적 다정함이 매력이 돼요.',
  ...
  },
  {
    ...
    ko: '감정과 사랑이 부드럽게 협력하는 스타일이에요. 마음을 열수록 사랑과 미적 감각이 살아나는, 의식적 흐름의 모습이에요.',
  ...
  },
  {
    ...
    ko: '감정과 사랑이 어긋난 각도로 맞물려, 안정 욕구와 애정 표현 사이에서 갈등이 생기는 느낌이에요. 사랑 안에서 진짜 필요를 보는 학습.',
  ...
  },
  {
    ...
    ko: '감정과 사랑이 같은 강물에 흐르는 스타일이에요. 다정함과 미적 감각이 타고난 강점이 되어, 관계가 자연스럽게 따뜻해요.',
  ...
  },
  {
    ...
    ko: '감정과 사랑이 마주 서서 균형을 찾는 모습이에요. 내 욕구와 상대의 애정 사이를 오가며, 관계의 거울을 통해 통합점을 찾아요.',
  ...
  // ---------- Moon × Mars (emotion × drive) ----------
  {
    ...
    ko: '감정의 별과 추진의 별이 한 자리에서 만나는 느낌이에요. 느끼는 그대로 바로 움직여, 정서가 곧 행동이 돼요.',
  ...
  },
  {
    ...
    ko: '감정과 추진이 부드럽게 협력하는 스타일이에요. 마음이 움직이면 행동도 따라오지만, 멈춰 있으면 발화되지 않아요.',
  ...
  // ---------- Moon × Saturn (emotion × responsibility) ----------
  {
    ...
    ko: '감정의 별과 책임의 별이 한 자리에서 만나는 모습이에요. 마음이 늘 신중하고 무게가 있어, 정서적으로 일찍 어른이 돼요.',
  ...
  },
  {
    ...
    ko: '감정과 책임이 부드럽게 협력하는 느낌이에요. 꾸준한 자기 돌봄이 마음의 토대를 단단하게 만들어요.',
  ...
  },
  {
    ...
    ko: '감정과 책임이 어긋난 각도로 맞물려, 마음이 무겁고 외로워지기 쉬운 스타일이에요. 자기 감정을 부정하지 않고 안아주는 학습.',
    ...
    keywords_ko: ['감정의 무게', '외로움의 느낌', '자기 수용 학습'],
    keywords_en: ['heavy heart', 'lonely-line', 'self-acceptance lesson'],
  },
  {
    planet1: 'Moon', planet2: 'Saturn', aspect: 'trine',
    ko: '감정과 책임이 같은 식으로 흐르는 모습이에요. 마음의 깊이와 구조가 자연스럽게 어울려, 정서적 단단함이 타고난 강점이 돼요.',
  ...
  // ---------- Venus × Mars (love × desire) ----------
  {
    ...
    ko: '사랑의 별과 추진의 별이 한 자리에서 만나는 스타일이에요. 끌림과 욕망이 한 몸이 되어, 사랑 안에서 행동이 빠르게 일어나요.',
  ...
  },
  {
    ...
    ko: '사랑과 추진이 부드럽게 협력하는 모습이에요. 끌림이 있으면 행동도 자연스럽게 따라와, 의식적으로 다가갈수록 살아나요.',
    ...
    keywords_ko: ['협력적 끌림', '다가가는 느낌', '의식적 사랑'],
    keywords_en: ['cooperative attraction', 'reaching-line', 'conscious love'],
  },
  {
    planet1: 'Venus', planet2: 'Mars', aspect: 'square',
    ko: '사랑의 별과 추진의 별이 팽팽하게 만나는 느낌이에요. 끌림과 욕망 사이의 긴장이 강해, 사랑에서 빠른 결정과 갈등이 함께 일어나요.',
  ...
  },
  {
    ...
    ko: '사랑과 확장이 어긋난 각도로 맞물려, 너그러움이 과해지거나 자기 가치를 놓치는 모습이에요. 사랑 안에서 적정선을 찾는 학습.',
  ...
  },
  {
    ...
    ko: '사랑과 확장이 같은 식으로 흐르는 느낌이에요. 너그러움과 매력이 자연스럽게 어울려, 행운과 사랑이 타고난 짝이 돼요.',
  ...
  },
  {
    ...
    ko: '사랑과 확장이 마주 서서 균형을 찾는 스타일이에요. 자기 가치와 너그러움 사이를 오가며, 관계 안에서 적정한 풍요를 배워요.',
  ...
  // ---------- Venus × Saturn (love × responsibility) ----------
  {
    ...
    ko: '사랑의 별과 책임의 별이 한 자리에서 만나는 모습이에요. 애정이 진지하고 무게가 있어, 관계가 약속과 구조 위에서 자라요.',
  ...
  },
  {
    ...
    keywords_ko: ['꾸준한 사랑', '단단한 관계', '시간의 느낌'],
    keywords_en: ['steady love', 'sturdy relating', 'time-deepens'],
  },
  {
    planet1: 'Venus', planet2: 'Saturn', aspect: 'square',
    ko: '사랑과 책임이 어긋난 각도로 맞물려, 애정 안에서 거리감이나 두려움이 자주 일어나는 스타일이에요. 사랑의 무게를 안고 가는 학습.',
    ...
    keywords_ko: ['사랑의 거리감', '두려움의 느낌', '무게의 학습'],
    keywords_en: ['love-distance', 'fear-line', 'weight lesson'],
  },
  {
    planet1: 'Venus', planet2: 'Saturn', aspect: 'trine',
    ko: '사랑과 책임이 같은 식으로 흐르는 모습이에요. 진지함과 매력이 자연스럽게 어울려, 신뢰가 타고난 강점이 돼요.',
  ...
  },
  {
    ...
    ko: '사랑과 책임이 마주 서서 균형을 찾는 느낌이에요. 애정과 약속 사이를 오가며, 관계의 거울 안에서 통합점을 배워요.',
  ...
  // ---------- Venus × Pluto (love × transformation) ----------
  {
    ...
    ko: '사랑의 별과 변용의 별이 한 자리에서 만나는 스타일이에요. 애정이 깊고 강해, 관계가 변화의 거울로 작동해요.',
  ...
  },
  {
    ...
    ko: '사랑과 변용이 부드럽게 협력하는 모습이에요. 의식적으로 깊어질 때 관계가 진짜 변화를 만들어요.',
  ...
  },
  {
    ...
    ko: '사랑과 변용이 어긋난 각도로 맞물려, 관계 안에서 강한 끌림과 통제의 긴장이 함께 일어나는 느낌이에요. 사랑의 힘을 다루는 학습.',
  ...
  },
  {
    ...
    ko: '사랑과 변용이 같은 식으로 흐르는 스타일이에요. 깊이와 매력이 자연스럽게 어울려, 변화시키는 사랑이 타고난 강점이 돼요.',
  ...
  },
  {
    ...
    ko: '추진과 확장이 같은 강물에 흐르는 느낌이에요. 행동과 시야가 자연스럽게 어울려, 자신 있게 멀리 가는 강점이 돼요.',
  ...
  },
  {
    ...
    keywords_ko: ['타고난 꾸준함', '구조 있는 행동', '지속의 느낌'],
    keywords_en: ['innate endurance', 'structured action', 'sustaining-line'],
  },
  {
    planet1: 'Mars', planet2: 'Saturn', aspect: 'opposition',
    ko: '추진과 책임이 마주 서서 균형을 찾는 스타일이에요. 내 행동과 외부의 한계 사이를 오가며, 관계 안에서 인내와 도전의 통합점을 배워요.',
    ...
    keywords_ko: ['추진-한계 균형', '거울의 학습', '인내의 느낌'],
  ...
  // ---------- Mars × Pluto (drive × transformation) ----------
  {
    ...
    ko: '추진의 별과 변용의 별이 한 자리에서 만나는 모습이에요. 행동의 강도가 깊고 강해, 움직임이 큰 변화를 만들어요.',
  ...
  },
  {
    ...
    ko: '추진과 변용이 부드럽게 협력하는 느낌이에요. 의식적으로 행동할 때 변화의 깊이가 살아나요.',
  ...
  },
  {
    ...
    ko: '추진과 변용이 어긋난 각도로 맞물려, 행동에 강한 압박과 통제 욕구가 따라오는 스타일이에요. 힘을 적절히 쓰는 학습.',
    ...
    keywords_ko: ['강한 압박', '통제의 느낌', '힘의 학습'],
    keywords_en: ['heavy pressure', 'control-line', 'power lesson'],
  },
  {
    planet1: 'Mars', planet2: 'Pluto', aspect: 'trine',
    ko: '추진과 변용이 같은 식으로 흐르는 모습이에요. 행동과 깊이가 자연스럽게 어울려, 변화시키는 힘이 타고난 강점이 돼요.',
  ...
  // ---------- Saturn × Uranus (structure × innovation) ----------
  {
    ...
    ko: '책임의 별과 혁신의 별이 한 자리에서 만나는 스타일이에요. 구조와 자유가 한 몸으로 움직여, 옛 틀과 새 길을 동시에 짊어져요.',
  ...
  },
  {
    ...
    ko: '책임과 혁신이 부드럽게 협력하는 모습이에요. 의식적으로 새 것을 시도할 때 구조가 안전하게 지지해줘요.',
  ...
  },
  {
    ...
    ko: '책임과 혁신이 어긋난 각도로 맞물려, 구조와 자유 사이의 긴장이 강한 느낌이에요. 옛 것을 부수고 새 길을 내는 학습.',
  ...
  },
  {
    ...
    ko: '책임과 혁신이 마주 서서 균형을 찾는 모습이에요. 옛 질서와 새 흐름 사이를 오가며, 관계 안에서 통합점을 배워요.',
    ...
    keywords_ko: ['질서-변화 균형', '거울의 학습', '통합의 느낌'],
  ...
  // ---------- Saturn × Neptune (structure × dissolution) ----------
  {
    ...
    ko: '책임의 별과 꿈의 별이 한 자리에서 만나는 느낌이에요. 구조와 직관이 한 몸으로 움직여, 현실에 영감을 짓는 스타일이에요.',
  ...
  },
  {
    ...
    ko: '책임과 꿈이 부드럽게 협력하는 모습이에요. 의식적으로 비전을 짚을 때 구조가 그것을 받쳐줘요.',
  ...
  },
  {
    ...
    ko: '책임과 꿈이 어긋난 각도로 맞물려, 현실과 이상 사이의 갈등이 강한 느낌이에요. 환상을 다루며 구조를 짓는 학습.',
  ...
  },
  {
    ...
    ko: '책임과 꿈이 같은 식으로 흐르는 스타일이에요. 비전과 구조가 자연스럽게 어울려, 현실에 영감을 짓는 강점이 돼요.',
  ...
  },
  {
    ...
    keywords_ko: ['현실-이상 균형', '거울의 학습', '통합의 느낌'],
  ...
  // ---------- Saturn × Pluto (structure × transformation) ----------
  {
    ...
    ko: '책임의 별과 변용의 별이 한 자리에서 만나는 느낌이에요. 구조와 깊이가 한 몸이 되어, 큰 변화를 짓는 무게의 스타일이에요.',
  ...
  },
  {
    ...
    ko: '책임과 변용이 부드럽게 협력하는 모습이에요. 의식적으로 깊어질 때 구조가 변화를 안전하게 담아줘요.',
  ...
  },
  {
    ...
    ko: '책임과 변용이 어긋난 각도로 맞물려, 옛 구조와 깊은 변화 사이의 압박이 강한 느낌이에요. 권력과 인내를 함께 단련하는 학습.',
  ...
  // ---------- Jupiter × Saturn (expansion × responsibility) ----------
  {
    ...
    ko: '확장의 별과 책임의 별이 한 자리에서 만나는 느낌이에요. 큰 그림과 구조가 한 몸으로 움직여, 장기적인 빌드의 면을 입어요.',
  ...
  },
  {
    ...
    ko: '확장과 책임이 부드럽게 협력하는 스타일이에요. 의식적으로 시야를 키우면 구조가 그것을 단단히 받쳐줘요.',
  ...
  },
  {
    ...
    ko: '확장과 책임이 어긋난 각도로 맞물려, 성장의 야망과 현실의 한계가 부딪치는 모습이에요. 적정한 스케일을 배우는 학습.',
  ...
  },
  {
    ...
    ko: '확장과 책임이 마주 서서 균형을 찾는 스타일이에요. 야망과 현실 사이를 오가며, 관계의 거울 안에서 적정한 빌드의 통합점을 배워요.',
  ...
  // ---------- Jupiter × Pluto (expansion × transformation) ----------
  {
    ...
    ko: '확장의 별과 변용의 별이 한 자리에서 만나는 모습이에요. 큰 그림과 깊은 변화가 한 몸이 되어, 강한 신념의 면을 입어요.',
...
export function getPlanetSignInterpretation(
  ...
  return language === 'ko'
    ? `${planetLabel}이(가) ${signLabel}에 자리. 이 사인의 면을 통해 작용합니다.`
