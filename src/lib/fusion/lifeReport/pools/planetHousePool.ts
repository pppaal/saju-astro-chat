...
const SUN_HOUSE_LINES: Record<HouseNumber, string> = {
  ...
  3: '말과 학습, 짧은 거리의 소통에서 당신의 색이 살아나요. 호기심을 따라가시는 분이에요',
  4: '뿌리와 가정 안에서 자기 정체성이 단단해져요. 보이지 않는 자리에서 빛나는 분이에요',
  5: '창조·연애·놀이의 자리에서 가장 당신답게 빛나요. 표현이 곧 정체성이에요',
  6: '일상의 노동과 봉사에서 자기를 풀어내요. 디테일을 다듬는 편이에요',
  7: '관계와 파트너십에서 자기 모습이 비춰져요. 일대일 만남에서 자기 색이 또렷해져요',
  8: '깊은 변화와 공유 자원의 자리에서 자아가 새겨져요. 변혁을 거치며 자라요',
  9: '확장·믿음·먼 여행에서 자기를 발견해요. 큰 그림이 곧 정체성이에요',
  10: '사회 무대와 직업이 자아의 정점이에요. 사람들 앞에 설 때 당신의 모습이 가장 또렷해져요',
  11: '커뮤니티와 미래 비전 안에서 자기를 풀어내요. 친구와 큰 그룹 안에서 자기 모습이 비춰져요',
  12: '내면·은둔·영성의 자리에서 자아가 흐려졌다가 깊어져요. 보이지 않는 자리에서 빛나는 분이에요',
}
...
const MOON_HOUSE_LINES: Record<HouseNumber, string> = {
  ...
  3: '대화와 학습이 정서의 안식처예요. 말로 마음을 풀어내시는 편이에요',
  4: '뿌리와 가정이 정서의 토대예요. 집과 가족 안에서 마음이 안전해져요',
  5: '창조와 놀이로 감정이 풀려요. 표현이 곧 정서 회복이에요',
  6: '일상의 루틴과 돌봄에서 마음의 안정을 찾아요. 작은 일상을 챙기시는 편이에요',
  ...
  12: '고독과 영성에서 정서의 본질을 만나요. 보이지 않는 자리에서 깊어지는 분이에요',
}
...
const MERCURY_HOUSE_LINES: Record<HouseNumber, string> = {
  1: '말과 사고가 정체성 자체로 드러나요',
  2: '실용적 사고가 자원의 흐름을 만들어요',
  3: '소통과 짧은 학습이 본인의 핵심이에요',
  4: '가정·뿌리 안에서 사고가 차분히 다듬어져요',
  5: '창의적 표현과 즐거운 학습이 사고예요',
  6: '일상의 분석·관리에서 명민함이 빛나요',
  7: '대화와 협력 안에서 사고가 정리돼요',
  8: '심층 연구·심리·재무 분석이 당신의 색이에요',
  9: '큰 그림·철학·국제 시야가 사고예요',
  10: '공적 자리에서 말과 사고가 평판이 돼요',
  11: '네트워크와 미래 비전 안에서 아이디어가 풀려요',
  12: '내면 사유와 명상에서 깊은 통찰이 열려요',
}
...
const VENUS_HOUSE_LINES: Record<HouseNumber, string> = {
  1: '매력이 첫인상으로 그대로 드러나요',
  2: '소유와 감각이 미감의 토대예요',
  3: '대화와 학습 안에서 끌림이 시작돼요',
  4: '가정·뿌리가 미감과 안식의 자리예요',
  5: '창조와 연애가 미감의 정점이에요',
  6: '일상 챙김과 작은 봉사 안에서 사랑이 풀려요',
  7: '관계와 파트너십에서 자기 모습이 비춰져요',
  8: '깊은 결합과 공유 자원에서 가치가 만들어져요',
  9: '먼 곳·다른 문화 안에서 사랑이 깨어나요',
  10: '공적 자리에서 매력과 미감이 자산이 돼요',
  11: '커뮤니티와 친구가 사랑의 통로예요',
  12: '내면·은둔 안에서 깊은 사랑이 자라요',
}
...
const MARS_HOUSE_LINES: Record<HouseNumber, string> = {
  ...
  2: '자원·소유를 쌓는 행동에서 욕망이 풀려요',
  3: '말과 학습을 추진하는 자리에서 자기 색이 살아나요',
  4: '가정·뿌리를 지키는 행동이 욕망이에요',
  5: '창조·연애의 자리에서 욕망이 폭발해요',
  6: '일상 노동·운동·반복 작업에서 추진력이 풀려요',
  7: '관계와 파트너십 안에서 욕망이 비춰져요',
  8: '심층 변화·공유 자원·위기에서 추진력이 풀려요',
  9: '여행·확장·학문 추진에서 자기 색이 살아나요',
  10: '공적 자리·커리어 추진에서 욕망이 가장 또렷해져요',
  11: '커뮤니티·미래 비전을 위한 행동이 본인이에요',
  12: '뒤에서·내면에서 조용히 행동하는, 보이지 않는 추진이에요',
}
...
const JUPITER_HOUSE_LINES: Record<HouseNumber, string> = {
  ...
  9: '먼 곳·학문·믿음에서 자기 면이 가장 크게 펼쳐지, 확장이 곧 정체성인 자리',
...
const SATURN_HOUSE_LINES: Record<HouseNumber, string> = {
  ...
  3: '소통·학습이 단련을 거치며, 말과 사고에 신중함이 자리잡아요',
  ...
  11: '커뮤니티·미래 비전에 책임이 따라와, 그룹 안에서 어른 역할이 자리잡아요',
...
const URANUS_HOUSE_LINES: Record<HouseNumber, string> = {
  ...
  12: '무의식·은둔에서 돌발적 통찰이 터지며, 보이지 않는 자리에서 깨어나요',
}
...
const NEPTUNE_HOUSE_LINES: Record<HouseNumber, string> = {
  ...
  8: '심층·공유 자원이 신비에 잠기며, 변혁과 영성이 같은 자리에 모여요',
  9: '신념·학문이 영성에 녹, 진리가 직관으로 다가오는 자리',
  10: '커리어가 비전·예술에 잠기며, 공적 자리에서 환상이 자산이 돼요',
...
const PLUTO_HOUSE_LINES: Record<HouseNumber, string> = {
  1: '있는 그대로의 자신을 다시 빚는, 정체성이 죽고 다시 태어나는 자리예요',
  ...
  6: '일상·건강이 변혁의 자리이고, 작은 루틴 안에서 깊은 권력이 풀려요',
  ...
  12: '무의식의 변혁이 일어나, 보이지 않는 자리에서 죽고 다시 태어나요',
}
