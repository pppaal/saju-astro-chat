...
const SUN_HOUSE_LINES: Record<HouseNumber, string> = {
  ...
  3: '말과 학습, 짧은 거리의 소통에서 본인다움이 살아나요. 호기심을 따라가는 사람이에요',
  4: '뿌리와 가정 안에서 자기 정체성이 단단해져요. 보이지 않는 자리에서 빛나는 사람이에요',
  5: '창조·연애·놀이의 자리에서 가장 본인답게 빛나요. 표현이 정체성인 사람이에요',
  6: '일상의 노동과 봉사에서 자기를 풀어내요. 디테일을 다듬는 스타일이에요',
  7: '관계와 파트너십이 정체성의 거울이 돼요. 일대일 만남에서 본인다움이 또렷해져요',
  8: '깊은 변화와 공유 자원의 자리에서 자아가 새겨져요. 변혁을 거치는 사람이에요',
  9: '확장·믿음·먼 여행에서 자기를 발견해요. 큰 그림이 정체성인 사람이에요',
  10: '사회 무대와 직업이 자아의 정점이에요. 공적인 자리에서 본인다움이 가장 또렷해져요',
  11: '커뮤니티와 미래 비전 안에서 자기를 풀어내요. 친구와 큰 그룹이 정체성의 거울이에요',
  12: '내면·은둔·영성의 자리에서 자아가 흐려졌다가 깊어져요. 보이지 않는 자리에서 빛나는 사람이에요',
}
...
const MARS_HOUSE_LINES: Record<HouseNumber, string> = {
  ...
  9: '여행·확장·학문 추진에서 본인다움이 살아나는 스타일이에요',
...
const JUPITER_HOUSE_LINES: Record<HouseNumber, string> = {
  ...
  9: '먼 곳·학문·믿음에서 본인다움이 가장 크게 펼쳐지, 확장이 곧 정체성인 자리',
