...
// Top-level builder. Composes 6 domain narratives into a single LifeReport.
// Fully deterministic — same input always produces the same output (except
// the generatedAt timestamp in metadata).
