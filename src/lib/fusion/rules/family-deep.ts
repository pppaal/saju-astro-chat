...
export const familyDeepRules: Rule[] = [
  // ─── state: 평생 가정 결 ─────────────────────────────────
  {
    ...
    sajuPredicate: (s) =>
      hitByKeys(s, ['saju.state.sibsin.strong.정인', 'saju.state.geokguk.정인격']),
    astroPredicate: (a) =>
      hitByKeys(a, [
  ...
  },
  {
    ...
    sajuPredicate: (s) =>
      hitByKeys(s, ['saju.state.sibsin.strong.정관', 'saju.state.sibsin.strong.편관']),
    astroPredicate: (a) =>
      hitByKeys(a, [
  ...
  },
  {
    ...
    sajuPredicate: (s) => hitByKeys(s, ['saju.relation.지지충']),
    astroPredicate: (a) =>
      hitByKeys(a, ['astro.state.planet.Saturn.house.4', 'astro.state.stellium.house.4']),
  },
  {
    ...
    astroPredicate: (a) =>
      hitByPrefix(a, ['astro.state.stellium.house.5', 'astro.state.planet.Jupiter.house.5']),
  },
  {
  ...
  },
  {
    ...
    sajuPredicate: (s) =>
      hitByKeys(s, ['saju.state.sibsinGroup.비겁.strong', 'saju.state.relation.지지충']),
    astroPredicate: (a) =>
      hitByPrefix(a, [
  ...
  },
  {
    ...
    astroPredicate: (a) =>
      hitByKeys(a, ['astro.state.planet.Saturn.house.4', 'astro.state.planet.Saturn.house.6']),
  },
  {
    ...
    sajuPredicate: (s) =>
      hitByKeys(s, ['saju.state.sibsin.strong.편인', 'saju.state.geokguk.편인격']),
    astroPredicate: (a) =>
      hitByPrefix(a, [
  ...
  },
  {
    ...
    sajuPredicate: (s) =>
      hitByKeys(s, ['saju.state.elementDominant.earth', 'saju.state.geokguk.정인격']),
    astroPredicate: (a) =>
      hitByKeys(a, ['astro.state.stellium.house.4', 'astro.relation.aspect.Moon.trine.Saturn']),
  },
  ...
  // ─── timing: 가정 시기 ───────────────────────────────────
  {
    ...
    sajuPredicate: (s) =>
      hitByPrefix(s, ['saju.timing.event.day.지지충', 'saju.timing.seun.activates.천간충']),
    astroPredicate: (a) =>
      hitByPrefix(a, [
  ...
  },
  {
    ...
    sajuPredicate: (s) =>
      hitByPrefix(s, ['saju.timing.seun.sibsinJi.역마', 'saju.timing.event.day.지지충']),
    astroPredicate: (a) =>
      hitByPrefix(a, [
  ...
  // ─── state: 조상궁(년지) × 점성 4궁 = 가문·뿌리 유산 ──────
  {
    id: 'family.state.ancestral-heritage',
    layer: 'state',
    domain: 'family',
    meaning: '가문·뿌리의 유산',
    polarityHint: 'pos',
    narrative: {
      confirm:
        '사주 조상궁(년지)에 인성·관성이 들어 뿌리·가문의 무게가 또렷하고 + 점성 4궁(뿌리·집안)이 강조됨 — 가문·전통·조상의 기반이 평생 자기 정체성의 바탕이 되는 흐름. 뿌리를 챙길수록 단단해짐.',
    },
    sajuPredicate: (s) =>
      hitByKeys(s, [
        'saju.state.palace.조상.sibsin.정인',
        'saju.state.palace.조상.sibsin.편인',
        'saju.state.palace.조상.sibsin.정관',
        'saju.state.palace.조상.sibsin.편관',
      ]),
    astroPredicate: (a) =>
      hitByPrefix(a, [
