 ...
 */
export const TAROT_FOLLOWUP_RULES_KO = `이미 펼친 카드 안에서 후속 질문에 답한다. 새 카드 X.
...
export const TAROT_FOLLOWUP_RULES_EN = `Answer the follow-up using only the cards already on the table. No new cards.
