...
export const swordsCards: RawCard[] = [
  ...
  },
  {
    ...
    upright: {
      ...
      meaningKo:
        '소드 3은 상심과 슬픔을 나타냅니다. 연애에서는 이별이나 배신, 신뢰했던 사람에게 실망하는 상황이 올 수 있어요. 직장에서는 비판을 받거나 기대했던 결과가 나오지 않을 때 나타나는 카드예요. 지금은 아프지만, 이 고통이 영원하지는 않아요. 충분히 슬퍼하고 받아들이는 시간이 필요합니다. 상처는 결국 아물고, 그 경험은 당신을 더 강하게 만들 거예요.',
    ...
    reversed: {
      ...
      meaningKo:
        '역방향 소드 3은 치유가 시작되고 있다는 신호예요. 가장 힘든 시기는 지나갔고 이제 회복 중입니다. 상처를 잊는 게 아니라, 그 경험을 받아들이고 배우는 과정이에요. 연애에서는 다시 마음을 열 준비가 되었거나, 관계가 개선되기 시작해요. 직장에서는 비판을 건설적으로 받아들이고 발전할 수 있어요. 다만 아직 충분히 슬퍼하지 않았다면 성급하게 넘어가지 마세요. 진짜 치유는 시간이 필요해요.',
