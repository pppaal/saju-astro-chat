...
export const swordsCards: RawCard[] = [
  {
    ...
    upright: {
      ...
      meaningKo:
        '소드 에이스는 정신적 명확성의 빛으로 혼란의 구름을 뚫습니다. 단 하나의 검이 승리의 왕관을 쓰고 솟아오릅니다—이것은 돌파구의 순간, 진실이 환상을 베어내고 강력한 새 이해가 나타나는 때입니다. 정신이 날카롭고, 인식이 명확하고, 생각이 흐려지지 않았습니다. 이것은 깨달음의 카드, 모든 것을 바꾸는 갑작스러운 통찰, 마침내 보이는 "아하!" 순간입니다. 검은 단순히 생각뿐 아니라 진실을 나타냅니다—사물을 있는 그대로 보는 용기, 말해야 할 것을 말하는 것, 희망적 생각이 아닌 사실에 기반한 결정을 내리는 것. 사랑에서 정직한 소통이 분위기를 정리합니다; 진실은 불편할 때도 진정한 연결의 기반을 만듭니다. 직업에서 빛나는 아이디어가 나타나고, 정신적 도전이 정복되며, 명확한 사고가 성공으로 이어집니다. 소드 에이스는 정신이 제대로 휘둘러질 때 우리가 가진 가장 강력한 도구임을 상기시킵니다. 이 명확성을 현명하게 사용하세요—진실은 양날의 검으로, 해방시키거나 상처 줄 수 있습니다.',
  ...
  },
  {
    ...
    upright: {
      ...
      meaningKo:
        '소드 5는 한 인물이 검을 모으는 동안 다른 두 명이 패배하여 떠나가고, 폭풍 구름이 머리 위에 있는 것을 묘사합니다. 이것은 공허한 승리입니다—가치보다 더 많이 치른 승리, 논쟁에서는 이겼지만 관계를 잃은 것, 승자조차 상처 입고 절뚝이며 집으로 가는 전투. 누군가가 명예 없이 행동했고, 정직성보다 승리를 우선시했습니다. 패배한 인물들이 떠나갑니다; 싸움에서 졌지만 아마도 더 중요한 것을 보존했습니다. 사랑에서 이 카드는 회복할 수 없을 정도로 관계를 손상시키는 갈등을 경고합니다—상처 주는 말, 신뢰의 배신, 또는 친절함 대신 "옳은" 것의 씁쓸한 만족. 때때로 질문은 누가 이겼는지가 아니라, 이기는 것이 그 대가만큼 가치가 있었는지입니다. 직업에서 사무실 정치가 독성이 되었을 수 있습니다; 윤리 없는 야망이 적을 만듭니다; 또는 불공정한 싸움의 지는 편에 있을 수 있습니다. 소드 5는 전투를 살펴보라고 합니다: 중요한 것을 위해 싸우고 있나요, 아니면 그냥 이기려고 싸우나요? 어떤 승리는 가질 가치가 없습니다. 때때로 가장 현명한 선택은 배경의 인물들처럼 품위를 유지하며 떠나는 것입니다.',
      advice: 'Ask yourself: is winning worth the cost? Some battles are better left unfought.',
      adviceKo:
        '자신에게 물어보세요: 이기는 것이 그 대가만큼 가치가 있나요? 어떤 전투는 싸우지 않는 것이 낫습니다.',
    },
    reversed: {
      ...
      meaningKo:
        '역방향 소드 5는 갈등 후 화해의 가능성을 가져옵니다. 검이 반환되고 있습니다; 상처가 인정되고 있습니다; 함께 앞으로 나아갈 가능성이 현실이 됩니다. 아마도 어떤 대가를 치르더라도 이기는 것이 실수였음을 인식했습니다. 아마도 패배한 당사자들이 기꺼이 용서합니다. 이 카드는 사과하고, 잘못을 인정하고, 명예 없이 행동한 사람이 자신이었음을 받아들이는 겸손해지는 경험을 나타낼 수 있습니다. 사랑에서 갈등으로 손상된 관계가 가한 해를 정직하게 인정하며 신뢰를 재건하는 느린 과정을 시작합니다. 보상은 취약함을 필요로 합니다—정방향 소드 5가 결코 허용하지 않을 것입니다. 직업에서 직장 갈등이 식습니다; 화해의 손길이 내밀어집니다; 또는 계속 싸우기보다 독성 상황을 떠나기로 선택합니다. 그러나 이 카드는 또한 남아있는 원한, 표면 아래 계속되는 갈등, 또는 과거 불만을 놓지 못함을 나타낼 수 있습니다. 진정한 화해는 양 당사자가 검을 놓아야 합니다. 어떤 갈등은 용서가 완전히 치유할 수 없는 흉터를 남깁니다.',
