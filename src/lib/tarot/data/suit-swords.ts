...
export const swordsCards: RawCard[] = [
  ...
  },
  {
    ...
    upright: {
      ...
      meaningKo:
        '소드 7은 한 인물이 진영에서 다섯 개의 검을 들고 몰래 빠져나가며 두 개를 남기고, 누군가 알아챘는지 뒤를 돌아보는 것을 보여줍니다. 이것은 속임, 은밀함, 무언가를 벗어남의 카드입니다—하지만 직접 대립이 실패할 때 전략적 사고이기도 합니다. 누군가가 정직하지 않습니다. 공개적으로 도달할 수 없는 목표를 달성하기 위해 비밀리에 행동하는 당신일 수 있습니다. 당신을 속이고, 뒤에서 일하고, 자신의 것이 아닌 것을 가져가는 누군가일 수 있습니다. 모든 검을 가져갈 수 없습니다; 무언가가 남겨질 것입니다; 도둑질은 불완전합니다. 사랑에서 불정직에 주의하세요—파트너의 비밀을 발견하든 자신의 기만적 행동을 인식하든. 불륜, 숨겨진 의도, 또는 작은 거짓말을 통한 신뢰의 느린 침식이 나타날 수 있습니다. 직업에서 누군가가 당신의 일에 대한 공로를 가져가거나, 그림자에서 방해하거나, 승진하기 위해 비윤리적으로 행동할 수 있습니다. 때때로 이 카드는 필요한 교활함을 나타냅니다—무력이 아닌 전략과 타이밍을 사용하는 것. 하지만 방법을 살펴보세요: 거울을 보고 보이는 사람을 존경할 수 있나요? 그 인물은 자신이 하는 일이 잘못됐다는 것을 알기에 뒤를 돌아봅니다.',
