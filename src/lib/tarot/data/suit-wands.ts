...
export const wandsCards: RawCard[] = [
  ...
  },
  {
    ...
    upright: {
      ...
      meaningKo:
        '완드 시종은 젊은 열정, 창조적 불꽃, 그리고 새로운 시작의 흥분된 에너지를 구현합니다. 이 메신저가 흥미로운 소식이나 기회를 가지고 옵니다—아마도 모험으로의 초대, 새로운 창조적 프로젝트, 또는 상상력에 불을 붙이는 영감 주는 아이디어. 시종은 모든 경험이 배움의 기회이기 때문에 실패를 두려워하지 않고 미지를 탐험할 용기가 있습니다. 직업에서 영감을 주는 메시지, 새로운 프로젝트 기회, 또는 젊고 창의적인 동료의 도착을 기대하세요. 사랑에서 열정과 흥분으로 가득한 새로운 로맨스, 또는 기존 관계로 돌아오는 장난기 있는 에너지를 나타낼 수 있습니다. 완드 시종은 내면의 아이를 받아들이라고 권장합니다—호기심 있고, 두려움 없고, 삶이 제공하는 것을 발견할 준비가 된 모습입니다.',
  ...
  },
  {
    ...
    upright: {
      ...
      meaningKo:
        '완드 기사가 불 같은 말을 타고 돌진하며, 열정과 모험의 추구에서 멈출 수 없습니다. 이것은 대담한 행동, 두려움 없는 탐험, 그리고 망설임 없이 욕구를 쫓을 용기의 카드입니다. 에너지와 열정이 최고조에 달합니다—세상을 정복할 준비가 된 느낌입니다. 이 기사는 허락을 기다리지 않습니다; 영감이 오는 순간 행동합니다. 직업에서 빠른 진전, 출장, 또는 장애물을 돌파할 에너지를 기대하세요. 사랑에서 열정이 빠르게 점화됩니다—회오리 로맨스나 파트너와의 흥미진진한 모험. 하지만 주의하세요: 기사는 생각하기 전에 행동하며 충동적일 수 있습니다. 완드 기사는 가장 대담한 자신을 받아들이되, 통제되지 않은 불은 태울 수 있음을 기억하라고 권장합니다. 목적을 가지고 열정의 방향을 정하세요.',
    ...
    reversed: {
      ...
      meaningKo:
        '역방향 완드 기사는 통제 불능으로 타는 불—또는 더 나쁘게, 전혀 점화하기 어려운 것을 보여줍니다. 한편으로, 위험한 무모함으로 행동하여 결과가 있는 성급한 결정을 내리고, 충분한 생각 없이 상황에 돌진하고 있을 수 있습니다. 충동성이 모험적이기보다 파괴적이 됩니다. 다른 한편으로, 불이 꺼진 느낌일 수 있습니다—지연이 좌절시키고, 에너지가 부족하며, 한때 움직이게 했던 열정이 사라진 것 같습니다. 직업에서 자신의 조급함이나 마무리 부족으로 프로젝트가 정체될 수 있습니다. 사랑에서는 불꽃이 너무 뜨거워서 갈등을 일으키거나, 너무 식어서 열정을 잃고 있습니다. 역방향 기사는 묻습니다: 방향 없이 돌진하고 있나요, 아니면 움직여야 할 때 가만히 서 있나요? 무모함과 마비 사이의 균형을 찾으세요.',
  ...
  },
  {
    ...
    upright: {
      ...
      meaningKo:
        '완드 여왕은 손에 해바라기를 들고 발치에 검은 고양이와 함께 왕좌에 앉아 있습니다—자신감, 용기, 그리고 다른 사람을 그녀의 빛으로 끌어당기는 따뜻함을 구현합니다. 이 여왕은 자신의 가치를 알고 빛나는 것을 두려워하지 않습니다. 사람을 끌어당기는 매력이 있고, 창조적으로 생생하며, 맹렬하게 독립적입니다. 이 카드가 나타나면 이러한 자질을 구현하라고 부릅니다: 자신을 믿고, 창의성을 대담하게 표현하고, 힘보다 따뜻함으로 이끄세요. 직업에서 자신감과 카리스마를 통해 존경을 받고 기회를 끌어당깁니다. 사랑에서 바람직하고, 열정적이며, 관계에 흥분을 가져옵니다. 완드 여왕은 또한 이러한 자질을 구현하는 삶 속 인물을 나타낼 수 있습니다—따뜻하고, 지지하며, 성장을 격려하는 사람입니다. 내면의 불이 주변 세상을 밝히게 하세요.',
  ...
  },
  {
    ...
    upright: {
      ...
      meaning:
        'The King of Wands embodies visionary leadership at its finest—charismatic, bold, and honorable. This King has mastered his fire, channeling passionate energy into constructive achievement. He leads not through fear but through inspiration, and others follow willingly because they believe in his vision. The salamander on his robe bites its tail, representing the infinite cycle of creative energy he commands. When this card appears, you are called to step into leadership with confidence. In career, you have the vision and charisma to lead major projects or build enterprises. In love, you bring passion and excitement while maintaining honor and commitment. The King of Wands may also represent a mentor, boss, or partner who embodies these qualities—dynamic, supportive, and ambitious. Rule your kingdom with wisdom and fire.',
      meaningKo:
        '완드 왕은 최상의 비전 있는 리더십을 구현합니다—카리스마 있고, 대담하며, 명예로운. 이 왕은 불을 숙달하여 열정적 에너지를 건설적 성취로 전환합니다. 두려움이 아닌 영감을 통해 이끌고, 다른 사람들이 그의 비전을 믿기 때문에 기꺼이 따릅니다. 그의 예복에 있는 도롱뇽이 꼬리를 무는 것은 그가 명령하는 창조적 에너지의 무한 순환을 나타냅니다. 이 카드가 나타나면 자신감을 가지고 리더십에 들어서라는 부름입니다. 직업에서 주요 프로젝트를 이끌거나 기업을 세울 비전과 카리스마가 있습니다. 사랑에서 명예와 헌신을 유지하면서 열정과 흥분을 가져옵니다. 완드 왕은 또한 이러한 자질을 구현하는 멘토, 상사, 또는 파트너를 나타낼 수 있습니다—역동적이고, 지지하며, 야심적인 사람입니다. 지혜와 불로 왕국을 다스리세요.',
