...
export const wandsCards: RawCard[] = [
  ...
  },
  {
    ...
    upright: {
      ...
      meaningKo:
        '완드 3은 벽을 넘어선 인물을 보여줍니다—배들이 당신의 희망과 야망을 싣고 먼 수평선을 향해 항해합니다. 움직이기 시작한 것이 이제 세상에서 형태를 갖추고 있고, 첫 결과가 돌아오기 시작합니다. 이것은 확장, 해외 기회, 비전이 현실화되고 있다는 확신의 카드입니다. 씨앗을 심었습니다; 이제 자라는 것을 지켜보세요. 직업에서 손길이 뻗어나가길 기대하세요—국제 프로젝트, 글로벌 파트너십, 또는 먼 곳에서의 인정. 사랑에서 장거리 연결이 번성하거나, 여행이 로맨틱한 기회를 가져올 수 있습니다. 완드 3은 당신 안의 사업가를 축하합니다—알려지지 않은 바다로 배를 보내는 용기를 가진 자. 선견지명이 결실을 맺고 있습니다. 자신감을 가지고 수평선을 계속 바라보세요.',
