...
export const majorArcanaCards: RawCard[] = [
  {
    ...
    upright: {
      ...
      meaningKo:
        '바보 카드는 완전히 새로운 모험의 시작을 알립니다. 마치 절벽 끝에서 미지의 세계로 발을 내딛는 것처럼, 당신은 믿음의 도약을 하도록 부름받고 있습니다. 우주와 당신 내면의 안내를 신뢰하세요. 이 카드는 순수한 가능성의 에너지를 담고 있습니다—아직 아무것도 쓰이지 않았고, 당신이 바로 자신의 이야기를 쓰는 작가입니다. 자발성을 포용하고, 두려움을 내려놓고, 삶이 주는 놀라움을 허용하세요. 사랑에서는 새로운 로맨스나 열정의 재점화를 의미할 수 있습니다. 직업에서는 흥미진진한 새 사업이나 완전한 방향 전환을 암시합니다. 우주는 시작할 용기를 가진 자를 지지합니다.',
      advice:
        'Take a leap of faith. Trust the universe and embrace new beginnings with an open heart.',
  ...
  },
  {
    ...
    reversed: {
      ...
      meaning:
        "The reversed Justice card warns of imbalance and unfairness in your current situation. Someone may not be telling the whole truth, or a decision is being made based on biased information. You may be avoiding accountability for your own actions, pointing fingers at others instead of looking inward. Perhaps you're experiencing the consequences of past dishonesty, or you're being treated unfairly by external forces. In legal matters, this card can indicate complications or unjust outcomes. In relationships, there may be a lack of equality or hidden resentments. In career, unethical shortcuts may seem tempting but will backfire. The reversed Justice asks you to restore balance by first being honest with yourself. Own your part in the situation, and work toward fairness even when others don't.",
      meaningKo:
        '역방향 정의 카드는 현재 상황의 불균형과 불공정을 경고합니다. 누군가 전체 진실을 말하지 않거나, 편향된 정보에 기반해 결정이 내려지고 있을 수 있습니다. 자신의 행동에 대한 책임을 회피하며 내면을 보는 대신 다른 사람을 탓하고 있을 수 있습니다. 아마도 과거 부정직의 결과를 경험하고 있거나, 외부 세력에 의해 불공정한 대우를 받고 있을 수 있습니다. 법적 문제에서 이 카드는 복잡함이나 부당한 결과를 나타낼 수 있습니다. 관계에서는 평등 부재나 숨겨진 원망이 있을 수 있습니다. 직업에서 비윤리적 지름길은 유혹적으로 보일 수 있지만 역효과를 낼 것입니다. 역방향 정의는 먼저 자신에게 정직해짐으로써 균형을 회복하라고 요청합니다. 상황에서 당신의 역할을 인정하고, 다른 사람들이 그렇지 않을 때도 공정함을 향해 노력하세요.',
  ...
  },
  {
    ...
    reversed: {
      ...
      meaning:
        "The reversed Temperance warns of imbalance throwing your life into disarray. You may be swinging between extremes—overworking then burning out, overindulging then restricting, giving everything then resentfully withdrawing. This lack of moderation creates conflict both within yourself and with others. Perhaps you're being impatient, wanting immediate results and cutting corners that will cost you later. In relationships, there may be a lack of give-and-take, with one person doing all the compromising. In career, excessive ambition or recklessness may be leading to mistakes. The reversed Temperance asks: Where in your life are you out of balance? What opposing forces within you need reconciliation? Slow down, find your center, and remember that sustainable progress requires patience and moderation.",
      meaningKo:
        '역방향 절제는 불균형이 삶을 혼란에 빠뜨리고 있음을 경고합니다. 극단 사이를 오가고 있을 수 있습니다—과로 후 번아웃, 과식 후 제한, 모든 것을 주고 나서 원망하며 철수. 이 절제 부족이 자신 안에서 그리고 타인과 갈등을 만듭니다. 아마도 조급하여 즉각적인 결과를 원하고 나중에 대가를 치르게 될 지름길을 택하고 있을 수 있습니다. 관계에서는 주고받음이 부족하고, 한 사람이 모든 타협을 하고 있을 수 있습니다. 직업에서 과도한 야망이나 무모함이 실수로 이어질 수 있습니다. 역방향 절제는 묻습니다: 삶의 어디서 균형을 잃었나요? 당신 안의 어떤 대립하는 힘들이 화해가 필요한가요? 속도를 늦추고, 중심을 찾고, 지속 가능한 진전에는 인내와 절제가 필요함을 기억하세요.',
  ...
  },
  {
    ...
    reversed: {
      ...
      meaningKo:
        '역방향 악마는 해방의 강력한 순간을 예고합니다. 마침내 당신을 묶었던 사슬을 있는 그대로—자신이 만든 환상으로—보고 있으며, 벗어날 준비가 되었습니다. 중독이 그 힘을 잃어가고 있거나, 독성 관계가 끝나가거나, 제한적 신념이 무너져 진정한 잠재력이 드러나고 있습니다. 이 카드는 악마와 마주하고 힘을 되찾는 데 필요한 용기를 축하합니다. 관계에서 더 건강한 경계를 세우거나 도움이 되지 않는 것에서 떠나고 있을 수 있습니다. 직업에서 더 이상 정직함을 타협하지 않으려 할 수 있습니다. 역방향 악마는 진정한 자유가 내면에서 온다는 것을 상기시킵니다. 당신은 상황의 희생자가 아닙니다; 해방의 저자입니다. 자기 권한 부여의 이 길을 계속하세요.',
  ...
  },
  {
    ...
    reversed: {
      ...
      meaningKo:
        '역방향 달은 환상이 걷히기 시작하고 진실이 그림자에서 나오고 있음을 신호합니다. 한때 당신을 마비시켰던 두려움이 실제로 무엇인지—종종 어둠 속에서 보였던 것보다 훨씬 작은—보기 시작하면서 힘을 잃고 있습니다. 억압된 감정이 인정과 치유를 구하며 표면으로 떠오르고 있습니다. 이것은 불편할 수 있지만 궁극적으로 해방적입니다. 속임이 드러날 수 있습니다; 비밀이 밝혀집니다. 관계에서 마침내 정직한 대화가 일어날 수 있습니다. 직업에서 혼란의 시기 후에 명료함이 돌아오고 있습니다. 역방향 달은 불안의 안개를 걷어내면서 직관이 더 신뢰할 수 있게 되고 있음을 암시합니다. 아무리 고통스러워도 진실이 환상 속에 사는 것보다 낫다는 것을 믿으세요. 밤이 끝나가고 있습니다; 새벽이 다가옵니다.',
