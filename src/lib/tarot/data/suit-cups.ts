...
export const cupsCards: RawCard[] = [
  ...
  },
  {
    ...
    upright: {
      ...
      meaningKo:
        '컵 4는 나무 아래 앉아 팔짱을 끼고 신성한 손이 제공하는 컵을 보지 못하는 인물을 묘사합니다. 이것은 무관심, 철수, 내향적 불만의 카드입니다. 없는 것에 너무 집중하거나—과거에 너무 실망하여—새로운 축복이 오는 것을 보지 못할 수 있습니다. 영적 피로가 있습니다, "무슨 의미가 있어?" 에너지가 모든 것을 평평하고 무의미하게 느끼게 합니다. 때때로 이 철수는 필요합니다; 성찰과 영혼 탐색은 그 자리가 있습니다. 하지만 이 상태에 너무 오래 머물면 삶이 지나갑니다. 사랑에서 감정적으로 마음을 열지 않을 수 있고, 잠재적 파트너를 밀어내거나 현재 관계를 당연시합니다. 직업에서 불만에 몰두하고 있어 제공되는 기회를 무시하거나 단순히 보지 못합니다. 이 카드는 위를 보고, 주위를 보라고 초대합니다—우주가 무슨 선물을 내밀고 있는데 너무 몰두해서 알아차리지 못했나요? 감사가 무관심의 약입니다.',
      advice:
        'Look up and see what is being offered. Practice gratitude to break free from apathy.',
  ...
  },
  {
    ...
    upright: {
      ...
      meaningKo:
        '컵 기사는 백마를 타고 선물처럼 컵을 내밀며 달려갑니다—그는 낭만적 탐구자, 행동하는 시인, 마음이 이끄는 곳을 따라가는 사람입니다. 이것은 감정, 꿈, 이상주의적 추구의 기사입니다. 이 카드가 나타나면 로맨스가 공기 중에 있습니다; 초대, 제안, 또는 진심 어린 제안이 올 수 있습니다. 매력적이고, 예술적이고, 감정적으로 조율된 사람이 삶에 들어올 수 있습니다—또는 이러한 자질을 직접 구현하도록 부름받고 있습니다. 사랑에서 이것은 덱에서 가장 로맨틱한 카드 중 하나입니다. 프로포즈, 사랑 고백, 또는 로맨틱한 연결의 깊어짐이 나타납니다. 사랑을 찾고 있다면, 마음을 흔드는 누군가가 도착할 수 있습니다. 관계 중이라면, 파트너가 로맨틱한 제스처로 놀라게 할 수 있습니다. 직업에서 창조적 프로젝트가 부르고 있습니다; 실용적인 길이 불분명해도 열정을 따르세요. 컵 기사는 마음에는 자체 지혜가 있다고 가르칩니다. 모든 것이 논리적으로 이해될 필요는 없습니다—어떤 것들은 단순히 옳게 느껴지기 때문에 추구할 가치가 있습니다.',
      advice:
        'Follow your heart on this romantic quest. Let passion guide you to what feels right.',
    ...
    reversed: {
      ...
      meaningKo:
        '역방향 컵 기사는 낭만적 이상주의의 그림자 측면을 경고합니다—실망시키는 매력적인 사람, 헌신하지 못하는 몽상가, 감정을 무기로 사용하는 감정 조종자. 이 기사는 길을 잃었습니다; 열정이 질투로 변질되고, 로맨스가 조종으로, 꿈이 도피로 변했습니다. 로맨틱해 보이지만 실제로는 감정적으로 마음을 열지 않고, 신뢰할 수 없거나, 매력을 사용해 원하는 것을 얻는 사람을 상대하고 있을 수 있습니다. 또는 아마도 당신이 이 기사입니다—환상에 빠져 감정을 의미 있는 행동으로 옮기지 못하고, 관계에서 변덕스럽고 예측 불가능합니다. 사랑에서 실망이 예상됩니다; 로맨틱한 제안이 진정하지 않을 수 있고, 매력적인 사람이 다른 본성을 드러낼 수 있거나, 현실에 존재하지 않는 이상화된 사랑을 쫓고 있을 수 있습니다. 직업에서는 꿈이 규율로 뒷받침되지 않아 창조적 프로젝트가 멈춥니다. 이 카드는 감정적 정직함을 요구합니다—자신과 다른 사람에게. 로맨스는 아름답지만 결국 현실에 착지해야 합니다. 외관에 유혹당하고 있는지 아니면 본질과 진정으로 연결하고 있는지 확인하세요.',
