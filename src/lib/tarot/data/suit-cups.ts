...
export const cupsCards: RawCard[] = [
  ...
  },
  {
    ...
    upright: {
      ...
      meaningKo:
        '컵 기사는 백마를 타고 제물처럼 컵을 내밀며 달려갑니다—그는 낭만적 탐구자, 행동하는 시인, 마음이 이끄는 곳을 따라가는 사람입니다. 이것은 감정, 꿈, 이상주의적 추구의 기사입니다. 이 카드가 나타나면 로맨스가 공기 중에 있습니다; 초대, 제안, 또는 진심 어린 제안이 올 수 있습니다. 매력적이고, 예술적이고, 감정적으로 조율된 사람이 삶에 들어올 수 있습니다—또는 이러한 자질을 직접 구현하도록 부름받고 있습니다. 사랑에서 이것은 덱에서 가장 로맨틱한 카드 중 하나입니다. 프로포즈, 사랑 고백, 또는 로맨틱한 연결의 깊어짐이 나타납니다. 사랑을 찾고 있다면, 마음을 흔드는 누군가가 도착할 수 있습니다. 관계 중이라면, 파트너가 로맨틱한 제스처로 놀라게 할 수 있습니다. 직업에서 창조적 프로젝트가 부르고 있습니다; 실용적인 길이 불분명해도 열정을 따르세요. 컵 기사는 마음에는 자체 지혜가 있다고 가르칩니다. 모든 것이 논리적으로 이해될 필요는 없습니다—어떤 것들은 단순히 옳게 느껴지기 때문에 추구할 가치가 있습니다.',
      advice:
