...
export const cupsCards: RawCard[] = [
  ...
  },
  {
    ...
    reversed: {
      ...
      meaningKo:
        '역방향 컵 10은 관계와 가정생활에서 깨진 꿈의 고통을 드러냅니다. 무지개가 사라졌습니다; 조화가 산산조각 났습니다. 가족 갈등, 이혼, 소원함, 또는 원했던 행복한 가정과 가진 현실 사이의 고통스러운 간극이 있을 수 있습니다. 한때 일치했던 가치관이 갈라졌습니다; 한때 서로를 이해했던 사람들이 이제 다른 언어를 말합니다. 사랑에서 한때 행복했던 관계가 심각한 문제로 어려움을 겪고 있습니다—부정직, 비호환성, 멀어짐. 만들었거나 바랐던 완벽한 삶이 무너지고 있습니다. 가족 역학이 독성일 수 있고, "가족"이 당신에게 무엇을 의미하는지 재정의해야 할 수 있습니다. 직업에서 직장 문화가 기능 장애처럼 느껴집니다; 소속감이나 공유된 목적이 없습니다. 이 카드는 또한 행복에 대한 기존 관념을 거부하지만 진정한 충족이 그들에게 어떤 모습인지 아직 정의하지 않은 사람을 나타낼 수 있습니다. 메시지는 행복이 불가능하다는 것이 아니라, 어떻게 보일 것이라고 생각했던 것에 대한 집착을 놓아야 할 수 있다는 것입니다. 때때로 정방향 컵 10으로 가는 길은 먼저 역방향을 받아들이는 것을 필요로 합니다—관계가 치유되어야 할 곳을 인정하고, 어려운 대화를 하고, 다른 종류의 가족을 만들기로 선택하는 것.',
      advice:
  ...
  },
  {
    ...
    upright: {
      ...
      meaningKo:
        '컵 왕은 거센 물결 가운데 왕좌에 앉아 있지만, 침착하고 중심을 잡고 있습니다—감정의 노예가 아닌 마스터입니다. 이 왕은 감정의 전체 깊이를 여행하고 지혜로 나왔습니다. 공격이 아닌 감정 지능으로, 힘이 아닌 이해로 이끕니다. 다른 사람의 고통을 위한 공간을 유지하면서도 불안정해지지 않고, 연민을 잃지 않고 어려운 결정을 내리며, 우아하게 감정적 복잡성을 탐색할 수 있습니다. 이 카드가 나타나면, 감정적 숙달을 구현하도록 부름받거나 그런 사람을 만날 수 있습니다. 사랑에서 이것은 감정적으로 성숙하고, 지지적이며, 안정적인 파트너나 잠재적 파트너를 신호합니다—마음을 맡길 수 있는 누군가. 기존 관계는 상호 감정적 지원과 이해를 통해 깊어집니다. 직업에서 성공은 감정 지능, 외교, 사람을 이해하고 관리하는 능력을 통해 옵니다. 창조적이고 치유적인 직업이 특히 좋습니다. 컵 왕은 깊이 느끼는 것과 효과적으로 기능하는 것이 반대가 아님을 가르칩니다—가장 강력한 리더는 마음과 정신을 통합한 사람입니다.',
