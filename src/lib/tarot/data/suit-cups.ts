...
export const cupsCards: RawCard[] = [
  ...
  },
  {
    ...
    upright: {
      ...
      meaningKo:
        '컵 왕은 격랑하는 물 가운데 왕좌에 앉아 있지만, 침착하고 중심을 잡고 있습니다—감정의 노예가 아닌 마스터입니다. 이 왕은 감정의 전체 깊이를 여행하고 지혜로 나왔습니다. 공격이 아닌 감정 지능으로, 힘이 아닌 이해로 이끕니다. 다른 사람의 고통을 위한 공간을 유지하면서도 불안정해지지 않고, 연민을 잃지 않고 어려운 결정을 내리며, 우아하게 감정적 복잡성을 탐색할 수 있습니다. 이 카드가 나타나면, 감정적 숙달을 구현하도록 부름받거나 그런 사람을 만날 수 있습니다. 사랑에서 이것은 감정적으로 성숙하고, 지지적이며, 안정적인 파트너나 잠재적 파트너를 신호합니다—마음을 맡길 수 있는 누군가. 기존 관계는 상호 감정적 지원과 이해를 통해 깊어집니다. 직업에서 성공은 감정 지능, 외교, 사람을 이해하고 관리하는 능력을 통해 옵니다. 창조적이고 치유적인 직업이 특히 좋습니다. 컵 왕은 깊이 느끼는 것과 효과적으로 기능하는 것이 반대가 아님을 가르칩니다—가장 강력한 리더는 마음과 정신을 통합한 사람입니다.',
