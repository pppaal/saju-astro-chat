...
export function detectQuestionIntent(questionVariants: string[]): TarotQuestionIntent {
  ...
  if (
    /(\uB2E4\uC2DC\s*\uB9CC\uB0A0|\uB2E4\uC2DC\s*\uC62C\uAE4C|\uC7AC\uD68C|\uB3CC\uC544\uC62C|\uC7AC\uC811\uCD09)/.test(
      joined
    ) &&
    /(\uADF8\s*\uC0AC\uB78C|\uC0C1\uB300|\uD5E4\uC5B4\uC9C4\s*\uC0AC\uB78C|\uC804\s*\uC5F0\uC778|\uC804\uB0A8\uCE5C|\uC804\uC5EC\uCE5C|partner|ex)/.test(
      joined
    )
  ) {
    return 'reconciliation'
  ...
  if (
    /(\uC6B0\uB9AC\s*\uB2E4\uC2DC\s*\uB420\uAE4C|\uC6B0\uB9AC\s*\uB2E4\uC2DC\s*\uB418\uB0D0)/.test(
      joined
    )
  ) {
    return 'reconciliation'
  ...
  if (
    /(\uC5F0\uB77D\s*\uC62C\uAE4C|\uC911\uC694\uD55C\s*\uC5F0\uB77D|\uC560\ud504\ud130\s*\uC62C\uAE4C)/.test(
      joined
    )
  ) {
    return 'meeting_likelihood'
  ...
  if (
    /(\uC5B4\uC7A5\s*\uB2F9\uD558\uB294\s*\uC911\uC77C\uAE4C|\uC5B4\uC7A5\s*\uB2F9\uD558\uB294\uC911\uC784)/.test(
      joined
    )
  ) {
    return 'inner_feelings'
  ...
  if (
    /(\uACE0\uBC31\s*\uD574\uB3C4\s*\uB420\uAE4C|\uACE0\uBC31\s*\uBC15\uC544\uB3C4\s*\uB420\uAE4C)/.test(
      joined
    )
  ) {
    return 'self_decision'
  ...
  if (
    /(\uC6B0\uB9AC\s*\uB2E4\uC2DC\s*\uB418\uB0D0|\uC6B0\uB9AC\s*\uB2E4\uC2DC\s*\uB420\uAE4C)/.test(
      joined
    )
  ) {
    return 'reconciliation'
