...
function formatPositionNarrative(
  meaning: PillarPositionMeaning,
  pillar: PillarData
): string {
...
export function analyzePillarPositions(
  pillars: CalculateSajuDataResult
): PillarPositionAnalysis[] {
...
export function analyzeSameElementPillars(
  saju: CalculateSajuDataResult
): SameElementPillarHit[] {
