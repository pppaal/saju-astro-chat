...
// ============================================================
// 삼재 (三災) — 정본(relationTables) 재export. 예전 이 파일의 로컬 복제본이
// 4개 삼합국 중 3개를 엉뚱한 연지로 매핑(巳酉丑·申子辰·亥卯未)해 해당 띠 전원의
// 삼재 연도가 틀렸다. 이제 SSOT 파생값을 그대로 재export 해 갈라질 수 없게 한다.
// ============================================================
export { SAMJAE_BY_YEAR_BRANCH } from '@/lib/saju/relationTables'
