...
export const HEXAGRAM_WISDOM: Record<number, HexagramWisdomData> = {
    ...
    yaoWisdom: [
      {
        position: 1,
        text: '잠룡물용 (潛龍勿用)',
        meaning: '잠겨있는 용이니 쓰지 마라. 때를 기다려라.',
      },
      {
        position: 2,
        text: '견룡재전 (見龍在田)',
        meaning: '용이 밭에 나타났으니 대인을 만남이 이롭다.',
      },
      {
        position: 3,
        text: '군자종일건건 (君子終日乾乾)',
        meaning: '군자가 종일 힘쓰고 저녁에도 조심하라.',
      },
      {
        position: 4,
        text: '혹약재연 (或躍在淵)',
        meaning: '뛰어오르거나 연못에 있으니 허물이 없다.',
      },
      {
        position: 5,
        text: '비룡재천 (飛龍在天)',
        meaning: '나는 용이 하늘에 있으니 대인을 만남이 이롭다.',
      },
    ...
    yaoWisdom: [
      {
        position: 1,
        text: '이상견빙 (履霜堅冰)',
        meaning: '서리를 밟으니 단단한 얼음이 올 것이다.',
      },
      {
        position: 2,
        text: '직방대 (直方大)',
        meaning: '곧고 바르고 크니 배우지 않아도 이롭지 않음이 없다.',
      },
  ...
  3: {
    ...
    yaoWisdom: [
      { position: 1, text: '반환 (磐桓)', meaning: '머뭇거리니 바르게 거하는 것이 이롭다.' },
      {
        position: 2,
        text: '둔여전여 (屯如邅如)',
        meaning: '어려워 망설이고 있으니 혼인하면 좋다.',
      },
      {
        position: 3,
        text: '즉록무우 (即鹿無虞)',
        meaning: '사냥감만 보고 따라가면 숲에서 헤맨다.',
      },
      {
        position: 4,
        text: '승마반여 (乘馬班如)',
        meaning: '말을 타고 망설이니 혼인을 구하면 이롭다.',
      },
      {
        position: 5,
        text: '둔기고 (屯其膏)',
        meaning: '은택을 베풀기 어려우니 작은 일에는 길하다.',
      },
      {
        position: 6,
        text: '승마반여 읍혈연여 (乘馬班如 泣血漣如)',
        meaning: '말 타고 망설이며 피눈물을 흘린다.',
      },
    ],
  ...
  4: {
    ...
    nature: '어리석음',
    gwaeSa: '亨 匪我求童蒙 童蒙求我',
    meaning: '내가 어린이를 찾는 게 아니라 어린이가 나를 찾는다',
    coreWisdom: '배움의 자세가 중요하다. 스승을 찾되 겸손하라.',
    situationAdvice: {
      career: '배움이 필요한 때다. 멘토를 찾아라.',
      relationship: '순수한 마음으로 다가가라.',
      health: '무지가 병을 키운다. 정확한 진단을 받아라.',
      wealth: '배움에 투자하라. 지식이 재산이다.',
      spiritual: '겸손히 가르침을 구하라.',
    },
    yaoWisdom: [],
    warnings: ['아는 척하지 마라'],
    opportunities: ['학습', '교육', '멘토링'],
  },
  5: {
    name: '수',
    chinese: '需',
    ...
    meaning: '믿음이 있으면 크게 형통하고 큰 강을 건너도 이롭다',
    coreWisdom: '때를 기다려야 한다. 조급함은 금물이다.',
    situationAdvice: {
      career: '때를 기다려라. 준비하며 기회를 노려라.',
      relationship: '서두르지 마라. 자연스럽게 발전시켜라.',
      health: '충분한 휴식이 필요하다.',
      wealth: '장기 투자가 이롭다. 단기 수익을 쫓지 마라.',
      spiritual: '인내와 믿음을 키워라.',
    },
    yaoWisdom: [],
    warnings: ['조급함은 화를 부른다'],
    opportunities: ['준비', '계획', '기다림'],
  },
  6: {
    name: '송',
    chinese: '訟',
    ...
    nature: '쟁송',
    gwaeSa: '有孚窒 惕中吉 終凶',
    meaning: '믿음이 막히니 두려워하면 중간에는 길하나 끝까지 가면 흉하다',
    coreWisdom: '다툼은 피하라. 이기더라도 손해다.',
    situationAdvice: {
      career: '분쟁을 피하라. 중재자를 찾아라.',
      relationship: '말다툼을 삼가라. 화해가 우선이다.',
      health: '스트레스가 병을 키운다.',
      wealth: '소송이나 분쟁은 돈을 잃는다.',
      spiritual: '내면의 갈등을 해소하라.',
    },
    yaoWisdom: [],
    warnings: ['끝까지 가면 패한다'],
    opportunities: ['화해', '중재', '양보'],
  },
  7: {
    name: '사',
    chinese: '師',
    ...
    nature: '통솔',
    gwaeSa: '貞丈人吉 無咎',
    meaning: '어른이 바르게 하면 길하고 허물이 없다',
    coreWisdom: '질서와 규율이 필요하다. 정당한 지도자가 이끌어야 한다.',
    situationAdvice: {
      career: '조직을 이끌어야 할 때다. 규율을 세워라.',
      relationship: '명확한 역할 분담이 필요하다.',
      health: '규칙적인 생활이 건강의 기본이다.',
      wealth: '체계적인 재테크가 필요하다.',
      spiritual: '내면의 질서를 세워라.',
    },
    yaoWisdom: [],
    warnings: ['독선적 리더십은 반발을 산다'],
    opportunities: ['리더십', '조직화', '규율'],
  },
  8: {
    name: '비',
    chinese: '比',
    ...
    nature: '화합',
    gwaeSa: '吉 原筮元永貞 無咎',
    meaning: '길하다. 처음 점쳐 영원히 바르면 허물이 없다',
    coreWisdom: '가까이 함으로써 서로 돕는다. 친밀한 관계를 맺어라.',
    situationAdvice: {
      career: '협력이 성공의 열쇠다. 파트너십을 맺어라.',
      relationship: '가까워질 때다. 마음을 열어라.',
      health: '함께 운동하면 효과가 배가된다.',
      wealth: '공동 투자가 유리하다.',
      spiritual: '도반(道伴)을 찾아라.',
    },
    yaoWisdom: [],
    warnings: ['잘못된 사람과 가까이하면 해롭다'],
    opportunities: ['협력', '친교', '동맹'],
  },
  // 9-64까지 확장 가능 (간략화)
  9: {
    name: '소축',
    ...
    nature: '축적',
    gwaeSa: '亨 密雲不雨 自我西郊',
    meaning: '형통하나 빽빽한 구름이 비가 되지 못한다',
    coreWisdom: '작은 것부터 모아라. 아직 큰 일을 할 때가 아니다.',
    situationAdvice: {
      career: '작은 성과를 축적하라.',
      relationship: '작은 관심과 배려가 쌓인다.',
      health: '건강을 조금씩 챙겨라.',
      wealth: '소액 저축부터 시작하라.',
      spiritual: '작은 수행이 쌓여 큰 깨달음이 된다.',
    },
    yaoWisdom: [],
    warnings: ['너무 큰 것을 바라지 마라'],
    opportunities: ['저축', '작은 시작'],
  },
  10: {
    name: '리',
    chinese: '履',
    ...
    nature: '신중',
    gwaeSa: '履虎尾 不咥人 亨',
    meaning: '호랑이 꼬리를 밟아도 물리지 않으니 형통하다',
    coreWisdom: '예의와 신중함이 위험을 피하게 한다.',
    situationAdvice: {
      career: '조심스럽게 처신하라. 예의를 갖춰라.',
      relationship: '상대를 존중하고 예의 바르게 행동하라.',
      health: '위험한 행동을 삼가라.',
      wealth: '리스크를 신중히 관리하라.',
      spiritual: '겸손과 예절이 덕의 기본이다.',
    },
    yaoWisdom: [],
    warnings: ['방심하면 다친다'],
    opportunities: ['신중한 행동', '예의'],
  },
  11: {
    name: '태',
    chinese: '泰',
    ...
    nature: '태평',
    gwaeSa: '小往大來 吉亨',
    meaning: '작은 것이 가고 큰 것이 오니 길하고 형통하다',
    coreWisdom: '하늘과 땅이 교감하니 만물이 화합한다. 형통의 시기다.',
    situationAdvice: {
      career: '모든 일이 순조롭다. 적극적으로 나아가라.',
      relationship: '화합의 시기다. 관계가 발전한다.',
      health: '건강이 회복되고 좋아진다.',
      wealth: '투자와 사업이 번창한다.',
      spiritual: '내면과 외면이 조화를 이룬다.',
    },
    yaoWisdom: [],
    warnings: ['형통할 때 교만하지 마라'],
    opportunities: ['확장', '발전', '화합'],
  },
  12: {
    name: '비',
    chinese: '否',
    ...
    meaning: '막힌 것이 사람의 도가 아니니 군자가 바르게 함이 이롭지 않다',
    coreWisdom: '하늘과 땅이 소통하지 못하니 만물이 막힌다. 때를 기다려라.',
    situationAdvice: {
      career: '일이 막힌다. 물러나 때를 기다려라.',
      relationship: '소통이 안 된다. 거리를 두어라.',
      health: '기의 순환이 막혔다. 휴식하라.',
      wealth: '투자를 삼가라. 손실이 예상된다.',
      spiritual: '내면으로 침잠하라.',
    },
    yaoWisdom: [],
    warnings: ['무리하게 밀어붙이면 더 막힌다'],
    opportunities: ['휴식', '내성', '때 기다림'],
  },
  // 13-64 간략 데이터
  13: {
    name: '동인',
    ...
    nature: '동지',
    gwaeSa: '同人于野 亨',
    meaning: '들에서 사람들과 화합하니 형통하다',
    coreWisdom: '뜻을 같이하는 사람들과 힘을 모아라.',
    situationAdvice: {
      career: '팀워크가 중요하다.',
      relationship: '동지를 찾아라.',
      health: '함께하면 더 건강해진다.',
      wealth: '공동 투자가 유리하다.',
      spiritual: '도반과 함께 수행하라.',
    },
    yaoWisdom: [],
    warnings: ['파벌을 만들지 마라'],
    opportunities: ['협력', '동맹'],
  ...
  14: {
    ...
    gwaeSa: '元亨',
    meaning: '크게 형통하다',
    coreWisdom: '하늘 위에 해가 있으니 만물을 비춘다. 풍요의 시기다.',
    situationAdvice: {
      career: '성공과 번영의 때다.',
      relationship: '풍요로운 관계를 누려라.',
      health: '에너지가 충만하다.',
      wealth: '재물이 풍족해진다.',
      spiritual: '베풀어라.',
    },
  ...
  15: {
    ...
    nature: '겸허',
    gwaeSa: '亨 君子有終',
    meaning: '형통하니 군자에게 좋은 마침이 있다',
    coreWisdom: '겸손한 산이 땅 아래로 낮추니 덕이 높아진다.',
    situationAdvice: {
      career: '겸손하면 사람들이 따른다.',
      relationship: '낮추면 높아진다.',
      health: '과욕하지 마라.',
      wealth: '겸손이 지킨다.',
      spiritual: '진정한 겸손을 배워라.',
    },
    yaoWisdom: [],
    warnings: ['겸손인 척하지 마라'],
    opportunities: ['겸손', '낮춤'],
  ...
  63: {
    ...
    nature: '완성',
    gwaeSa: '亨小 利貞 初吉終亂',
    meaning: '작은 것이 형통하고 바르게 함이 이롭다. 처음은 길하나 끝은 어지럽다',
    coreWisdom: '일이 이루어졌으나 끝이 있으니 조심하라.',
    situationAdvice: {
      career: '목표를 달성했으나 유지가 어렵다.',
      relationship: '관계가 완성됐으나 권태에 주의하라.',
      health: '건강 유지에 힘써라.',
      wealth: '지키는 것이 중요하다.',
      spiritual: '깨달음을 유지하라.',
    },
    yaoWisdom: [],
    warnings: ['완성 후 해이해지면 무너진다'],
    opportunities: ['유지', '관리'],
  },
  64: {
    name: '미제',
    ...
    element: '화수',
    nature: '미완',
    gwaeSa: '亨 小狐汔濟 濡其尾 無攸利',
    meaning: '형통하나 작은 여우가 거의 건널 때 꼬리를 적시니 이로울 것이 없다',
    coreWisdom: '아직 완성되지 않았으니 마지막까지 방심하지 마라.',
    situationAdvice: {
      career: '마무리가 중요하다. 방심하지 마라.',
      relationship: '아직 갈 길이 남았다.',
      health: '완치까지 관리하라.',
      wealth: '마지막 투자에 신중하라.',
      spiritual: '수행은 끝이 없다.',
    },
    yaoWisdom: [],
    warnings: ['끝까지 방심하면 실패한다'],
...
// 괘 지혜 생성 함수
export function getHexagramWisdom(
  hexagramNumber: number,
  locale: Locale = 'ko'
): HexagramWisdomData | null {
...
export function generateSituationalAdvice(
  ...
  if (!wisdom) {
    return tw(locale, 'checkHexagram')
  }
  ...
  if (changingLines && changingLines.length > 0) {
    const changingAdvice = changingLines
      .map((line) => {
...
export function interpretChangingLines(
  ...
  if (!original || !target) {
    return tw(locale, 'noHexagramInfo')
  }
  ...
  if (lineCount > 0 && lineCount < 6) {
    const positionInsights = changingLines
      .sort((a, b) => a - b)
      .map((line) => {
...
// 일일 지혜 메시지 생성
export function generateDailyWisdom(
  hexagramNumber: number,
  date: Date,
  locale: Locale = 'ko'
): string {
...
export function generatePeriodicWisdom(
  ...
  if (period === 'yearly') {
    ...
    focusArea = ['career', 'relationship', 'health', 'spiritual'][
      periodNumber % 4
    ] as keyof SituationAdvice
  }

  const title = tw(locale, 'fortuneTitle', {
    period: periodLabel,
    name: wisdom.name,
