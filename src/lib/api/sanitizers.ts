 ...
 */
export function cleanStringArray(value: unknown, maxItems = 20, maxLen = 60): string[] {
...
export function normalizeMessages(
  ...
  const { maxMessages = 20, maxLength = 2000, allowedRoles = ALLOWED_ROLES } = options
 ...
 */
export function sanitizeString(value: unknown, maxLen: number, defaultValue = ''): string {
 ...
 */
export function sanitizeHtml(value: unknown, maxLen = 10000, defaultValue = ''): string {
  if (typeof value !== 'string') {
    return defaultValue
  }
 ...
 */
export function sanitizeHtmlSafe(value: unknown, maxLen = 10000, defaultValue = ''): string {
  if (typeof value !== 'string') {
    return defaultValue
  }
