...
> ⚠️ **STALE 경고 (2026-06-05):** 이 문서의 **티어/크레딧 모델이 구버전**이다.
> 현재는 구독 티어(free/basic/premium/enterprise)·**월간** 크레딧 모델이 아니라
> **일회성 크레딧 팩**(`src/lib/config/pricing.ts`: mini 10 / standard 40 /
> plus 100 / mega 240 / ultimate 500)이다. 또 소비 대상으로 적힌 **Dream /
> I-Ching 은 제거된 기능**(라우트 없음). 에러 응답·Rate Limiting·스키마 검증
> 섹션은 대체로 유효하나, 티어·크레딧·기능 목록은 신뢰하지 말 것. 전면 갱신
> 대기 중.
