...
export const careerDeepRules: Rule[] = [
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 정관격(또는 정재격)과 점성 Saturn dignified 또는 10궁 강조가 함께 — 공직·행정·관리 영역에 평생 적성. 정통 위계 안에서 안정 발휘.',
    },
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 정관격·관인상생 + 점성 Jupiter dignified 또는 9궁 강조 — 법조·법무·심판 영역의 평생 결.',
    },
    sajuPredicate: (s) => hitByKeys(s, ['saju.state.classicalCombo.관인상생', 'saju.state.geokguk.정관격']),
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 양인격·편관 강세와 점성 Mars dignified 또는 angular Mars — 강한 결단·물리적 행동·외과·군경 영역 적성.',
    },
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 정인격·인성 강세와 점성 9궁 강조 또는 Mercury dignified — 학습·연구·교육 영역의 평생 결.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 식신격·식상 강세 + 점성 5궁 강조 또는 Venus dignified — 창작·콘텐츠·예술 영역에 평생 적성.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
      'saju.state.geokguk.식신격',
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 편재격과 점성 Mercury Gemini 또는 3궁 강조 — 이동·교환·유통 영역에서 가장 잘 작동하는 결.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 비겁 강세 또는 종왕격 + 점성 1궁 stellium 또는 Mars angular — 독립·자영·창업이 본인 결.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 인성 + 식상 동시 강 + 점성 Moon angular 또는 6궁/12궁 강조 — 의료·간호·돌봄 영역의 결.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
      'saju.state.sibsinGroup.인성.strong',
      'saju.state.sibsinGroup.식상.strong',
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 식상·인성 강세 + 점성 3궁 강조 또는 Mercury angular — 미디어·교육·전달 영역에 평생 결.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
      'saju.state.sibsinGroup.식상.strong',
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 화개살 + 편인 + 점성 12궁 강조 또는 Neptune dignified — 영성·종교·치유 영역의 결.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 정재격·정재 강 + 점성 Mercury domicile/exalt 또는 2궁 강조 — 금융·회계·자산관리 영역의 결.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 식상 + 인성 동시 강 + 점성 Mercury angular 또는 Saturn dignified — 분석·논리·기술 영역의 결.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
      'saju.state.sibsinGroup.식상.strong',
      'saju.state.sibsinGroup.인성.strong',
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '사주 상관격 + 도화살 + 점성 5궁 strong 또는 Sun-Venus angular — 연예·무대·자기 표현 영역의 결.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
      'saju.state.geokguk.상관격',
  ...
  },
  {
    ...
    polarityHint: 'mixed',
    narrative: {
      confirm: '사주 편관 강세·종살격 + 점성 Pluto angular 또는 8궁 stellium — 변혁·심리치료·연구·심층 영역의 결.',
      conflict: '변혁 신호와 안정 신호가 혼재 — 깊게 들어가는 일과 표면 안정 사이 분기.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
      'saju.state.sibsin.strong.편관',
      'saju.state.geokguk.종살격',
    ]),
    astroPredicate: (a) => hitByPrefix(a, [
  ...
  // ─── timing — 직업 변동 / 승진 / 발신 ─────────────────────
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '세운 정관 + 점성 Saturn이 10궁/MC 부드럽게 활성 — 외부 인정·직책 상승 호기. 평가·승진 시점 적합.',
    },
  ...
  },
  {
    ...
    polarityHint: 'mixed',
    narrative: {
      confirm: '세운 편재·편관 + 점성 Uranus 또는 Node가 10궁/MC 자극 — 직장·역할 변동의 해. 새 자리·구조 변경 가능.',
    ...
    astroPredicate: (a) => hitByPrefix(a, [
      ...
      'astro.timing.transit.True Node.',
    ]),
  },
  {
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '세운 정인·편인 + 점성 Jupiter가 9궁 강조 또는 9궁 transit — 자격증·학위·전문성 강화의 해.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
  ...
  },
  {
    ...
    polarityHint: 'pos',
    narrative: {
      confirm: '세운 식신·상관 + 점성 Mercury·Venus가 3궁/5궁 강조 — 글·콘텐츠·발신·출판에 유리한 해.',
    },
    sajuPredicate: (s) => hitByKeys(s, [
      'saju.timing.seun.sibsin.식신',
  ...
  },
  {
    ...
    polarityHint: 'mixed',
    narrative: {
      confirm: '점성 outer planet (Saturn/Uranus/Pluto)이 MC를 직접 자극 + 사주 운이 일주를 충 — 평생 직업 축이 재정의되는 결정적 시기.',
