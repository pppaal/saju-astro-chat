...
export interface RelationOption {
  ...
  labelKo: string
  labelEn: string
  /** [관계 유형별 상담 톤] 블록에 들어가는 한 줄 디렉티브 (ko). */
  tone: string
  /** 같은 디렉티브의 영어판 — EN 세션 system prompt 누출 방지(toneEn 없으면 ko 가 샜다). */
  toneEn: string
...
const RELATION_OPTIONS: readonly RelationOption[] = [
  {
    ...
    toneEn:
      'Attraction, day-to-day harmony, resolving conflict, long-term potential. Bring up marriage only if the user raises it or it fits the larger arc.',
    romantic: true,
  },
  {
    key: 'crush',
    ...
    toneEn:
      'How to approach, the shifting feelings on their side, timing. Frame as possibility, never as certainty.',
    romantic: true,
  },
  {
    key: 'spouse',
    ...
    toneEn:
      'The long-shared bond, family/children dynamics, recovering from crises, growing close again.',
    romantic: true,
  },
  {
    key: 'engaged',
    ...
    toneEn:
      'Pre-marriage check-in: conflict patterns, aligning both families, timing of the start.',
    romantic: true,
  },
  {
    key: 'ex',
    ...
    toneEn:
      'Focus on what was learned and the posture for the next relationship rather than recommending reunion. Mention getting back together only if the user explicitly asks.',
    romantic: true,
  },
  {
    key: 'friend',
    ...
    toneEn:
      'Friendship, trust, growing together. Avoid romantic framing; read Venus/Mars as expression style and drive, not attraction.',
    romantic: false,
  },
  {
    key: 'family',
    ...
    toneEn:
      'Generation gap, communication patterns, tuning distance. Do not use attraction/marriage framing.',
    romantic: false,
  },
  {
    key: 'sibling',
    ...
    toneEn:
      'Growing up together, temperament differences, sharing roles/responsibility, a lasting bond. Do not use attraction/marriage framing.',
    romantic: false,
  },
  {
    key: 'colleague',
    ...
    toneEn:
      'Collaboration style, decision-making, reducing friction. Do not touch personal feelings or romance.',
    romantic: false,
  },
  {
    key: 'business',
    ...
    toneEn:
      'Shared interests, trust, decision-making rhythm. Center the wealth/career placements in astrology and saju.',
    romantic: false,
  },
  {
    key: 'other',
    ...
    toneEn: 'Respect the free-text context the user wrote and tune the tone to it.',
    romantic: false,
  },
] as const
