...
export function analyzePlanetTransits(
  ...
  // ============================================================
  // 목성 트랜짓 분석 (확장, 행운, 성장 - 년운에 중요)
  // 목성은 12년 주기로 띠별 운세에 영향을 미침
  // ============================================================
  if (jupiterPos.sign === natalSunSign) {
    // 목성 합 - 12년만에 한 번 오는 대운의 시작!
    score += 15
  ...
  // ============================================================
  // 토성 트랜짓 분석 (시련, 교훈, 성장 - 인생의 큰 변화)
  // 토성은 29년 주기로 인생의 중요한 시점에 작용
  // ============================================================
  if (saturnPos.sign === natalSunSign) {
    // 토성 합 - Saturn Return 같은 큰 변환점
    score -= 10
  ...
  // ============================================================
  // 어스펙트 분석 (출생 차트 태양과의 관계)
  // 보다 정밀한 합/충/삼분 어스펙트 계산
  // ============================================================
  if (natalSunLongitude !== undefined) {
    // 목성-출생태양 정밀 어스펙트 (최고의 행운!)
  ...
  // ============================================================
  // 행성 간 트랜짓 어스펙트 (현재 하늘의 관계)
  // ============================================================
  // 목성-금성 합/삼분각 - 대길조 (행운+사랑)
