...
} from '@/lib/matrix/core/signalSynthesizer'
import { compileFeatureTokens } from '@/lib/matrix/core/tokenCompiler'
import { buildActivationEngine } from '@/lib/matrix/core/activationEngine'
import { buildRuleEngine } from '@/lib/matrix/core/ruleEngine'
import { buildStateEngine } from '@/lib/matrix/core/stateEngine'
import {
  buildPhaseStrategyEngine,
  type StrategyEngineResult,
} from '@/lib/matrix/core/strategyEngine'
import { buildPatternEngine, type PatternResult } from '@/lib/matrix/core/patternEngine'
import { buildScenarioEngine, type ScenarioResult } from '@/lib/matrix/core/scenarioEngine'
import {
  buildDecisionEngine,
  type DecisionEngineResult,
} from '@/lib/matrix/core/decisionEngine'
import { buildCoreCanonicalOutput } from '@/lib/matrix/core/canonical'
import type { DestinyCoreCanonicalOutput } from '@/lib/matrix/core/types'
import { normalizeMatrixInput } from '@/lib/matrix/core/inputNormalization'
import {
  buildDestinyLatentState,
  type DestinyLatentState,
} from '@/lib/matrix/core/latentState'
