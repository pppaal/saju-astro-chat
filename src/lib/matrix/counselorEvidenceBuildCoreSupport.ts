import type { FusionReport, InsightDomain } from '@/lib/matrix/interpreter/types'
import type { MatrixCalculationInput, MatrixSummary } from '@/lib/matrix/types'
import {
  buildStructuredEvidence,
  summarizeEvidenceEvidence,
  type EvidenceDomain,
} from '@/lib/matrix/ai-report/structuredEvidence'
import type { ReportEvidenceRef } from '@/lib/matrix/ai-report/evidenceRefs'
import type {
  NormalizedSignal,
  SignalDomain,
  SignalSynthesisResult,
} from '@/lib/matrix/ai-report/signalSynthesizer'
import type { StrategyEngineResult } from '@/lib/matrix/ai-report/strategyEngine'
import type {
  UnifiedAnchor,
  UnifiedClaim,
  UnifiedScenarioBundle,
} from '@/lib/matrix/ai-report/types'
import { buildUnifiedEnvelope } from '@/lib/matrix/ai-report/unifiedReport'
import { adaptCoreToCounselor } from '@/lib/matrix/core/adapters'
import type { DestinyCoreResult } from '@/lib/matrix/core/runDestinyCore'
import {
...
} from '@/lib/matrix/counselorEvidenceSanitizer'
import {
  ...
  mapThemeToDomain,
} from '@/lib/matrix/counselorEvidenceVerdict'
import {
  ...
  toEvidenceRefs,
  uniq,
} from '@/lib/matrix/counselorEvidenceSupport'
...
export type {
  ...
  CounselorTheme,
} from '@/lib/matrix/counselorEvidenceTypes'
export { formatCounselorEvidencePacket } from '@/lib/matrix/counselorEvidenceFormatter'
...
function mapSignalDomainToTimelineDomain(
  domain?: string
): import('@/lib/matrix/types').DomainKey | null {
  switch (domain) {
    case 'career':
      return 'career'
    case 'relationship':
