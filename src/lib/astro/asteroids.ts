...
// 사인별 해석 데이터
const CERES_SIGNS: Record<
  ZodiacKo,
  { nurturing: string; food: string; wound: string; healing: string }
> = {
  Aries: {
    nurturing: '독립적 양육, 자립심 강조',
    food: '빠르게 먹음, 에너지 음식',
    wound: '버림받음의 두려움',
    healing: '도움 요청해도 괜찮다는 것 배우기',
  },
  Taurus: {
    nurturing: '물질적 안정 제공, 감각적 돌봄',
    food: '미식가, 요리 재능',
    wound: '소유욕으로 변질된 사랑',
    healing: '사랑과 물질의 분리',
  },
  Gemini: {
    nurturing: '대화와 정보로 돌봄',
    food: '먹으면서 대화, 다양한 음식',
    wound: '감정보다 논리로 접근',
    healing: '감정적 연결 허용',
  },
  Cancer: {
    nurturing: '전통적 모성, 가정 중심',
    food: '집밥, 가족 식사',
    wound: '과보호, 분리 불안',
    healing: '건강한 경계 설정',
  },
  Leo: {
    nurturing: '칭찬과 인정으로 돌봄',
    food: '화려한 식사, 파티',
    wound: '관심 중심이어야 돌봄 느낌',
    healing: '조용한 사랑도 사랑',
  },
  Virgo: {
    nurturing: '실용적 돌봄, 건강 관리',
    food: '건강식, 영양 분석',
    wound: '비판으로 변질된 돌봄',
    healing: '완벽하지 않아도 충분함',
  },
  Libra: {
    nurturing: '공정하고 균형잡힌 돌봄',
    food: '아름다운 테이블 세팅',
    wound: '자기 희생적 돌봄',
    healing: '자기 돌봄 우선',
  },
  ...
  Aquarius: {
    nurturing: '독특한 양육, 개성 존중',
    food: '실험적 음식',
    wound: '거리두기로 느껴짐',
    healing: '개인적 친밀함 연습',
  },
  Pisces: {
    nurturing: '무조건적 사랑, 영적 돌봄',
    food: '직관적 식사',
    wound: '경계 없는 희생',
    healing: '건강한 경계 = 사랑',
  },
...
const PALLAS_SIGNS: Record<
  ZodiacKo,
  { intelligence: string; pattern: string; creative: string; justice: string }
> = {
  Aries: {
    intelligence: '빠른 전략, 선제 공격',
    pattern: '즉각적 패턴 파악',
    creative: '개척적 예술',
    justice: '직접 행동',
  },
  Taurus: {
    intelligence: '실용적 지혜, 점진적 전략',
    pattern: '물질적 패턴, 가치 분석',
    creative: '공예, 촉각 예술',
    justice: '자원 공정 분배',
  },
  Gemini: {
    intelligence: '언어 전략, 다각도 분석',
    pattern: '언어/소통 패턴',
    creative: '글쓰기, 디자인',
    justice: '논리적 토론',
  },
  Cancer: {
    intelligence: '감정 지능, 보호 전략',
    pattern: '감정/가족 패턴',
    creative: '가정 예술',
    justice: '돌봄 정의',
  },
  Leo: {
    intelligence: '창조적 전략, 드라마틱 지혜',
    pattern: '자기 표현 패턴',
    creative: '공연 예술',
    justice: '공정한 인정',
  },
  Virgo: {
    intelligence: '분석적 지혜, 세부 전략',
    pattern: '시스템/건강 패턴',
    creative: '치유 예술, 공예',
    justice: '실용적 해결',
  },
  Libra: {
    intelligence: '외교 전략, 균형 지혜',
    pattern: '관계/조화 패턴',
    creative: '미술, 디자인',
    justice: '법적 정의',
  },
  Scorpio: {
    intelligence: '심층 전략, 심리 지혜',
    pattern: '숨겨진 패턴, 동기',
    creative: '변형 예술',
    justice: '근본 변혁',
  },
  Sagittarius: {
    intelligence: '철학적 지혜, 큰 그림',
    pattern: '의미/진실 패턴',
    creative: '교육 예술',
    justice: '도덕적 정의',
  },
  Capricorn: {
    intelligence: '구조적 전략, 장기 계획',
    pattern: '권력/체계 패턴',
    creative: '건축, 조직',
    justice: '제도적 정의',
  },
  Aquarius: {
    intelligence: '혁신 전략, 미래 지혜',
    pattern: '사회/기술 패턴',
    creative: '첨단 예술',
    justice: '사회 정의',
  },
  Pisces: {
    intelligence: '직관 지혜, 영적 전략',
    pattern: '영적/상징 패턴',
    creative: '영감 예술',
    justice: '연민 정의',
  },
...
const JUNO_SIGNS: Record<
  ZodiacKo,
  { partnerNeed: string; commitment: string; shadow: string; ideal: string }
> = {
  Aries: {
    partnerNeed: '독립적이고 활동적인 파트너',
    commitment: '열정적, 선구적',
    shadow: '경쟁, 주도권 다툼',
    ideal: '함께 모험하는 관계',
  },
  Taurus: {
    partnerNeed: '안정적이고 감각적인 파트너',
    commitment: '충실하고 지속적',
    shadow: '소유욕, 변화 거부',
    ideal: '물질적 안정 공유',
  },
  Gemini: {
    partnerNeed: '지적이고 소통 잘하는 파트너',
    commitment: '유연하고 다양',
    shadow: '가벼움, 불안정',
    ideal: '끊임없는 대화',
  },
  Cancer: {
    partnerNeed: '돌봐주고 가정적인 파트너',
    commitment: '보호적, 감정적',
    shadow: '의존, 과거 집착',
    ideal: '가정 중심 파트너십',
  },
  Leo: {
    partnerNeed: '존경해주고 빛나게 해주는 파트너',
    commitment: '로맨틱, 드라마틱',
    shadow: '관심 경쟁',
    ideal: '서로 빛나게 함',
  },
  Virgo: {
    partnerNeed: '실용적이고 성장 지향적 파트너',
    commitment: '헌신적, 서비스 지향',
    shadow: '비판, 완벽주의',
    ideal: '함께 성장',
  },
  Libra: {
    partnerNeed: '균형잡히고 공정한 파트너',
    commitment: '조화롭고 우아',
    shadow: '우유부단, 갈등 회피',
    ideal: '평등한 파트너십',
  },
  Scorpio: {
    partnerNeed: '깊이 있고 변형적인 파트너',
    commitment: '강렬하고 충성스러움',
    shadow: '질투, 통제',
    ideal: '영혼 수준의 결합',
  },
  Sagittarius: {
    partnerNeed: '자유롭고 철학적인 파트너',
    commitment: '모험적, 성장 지향',
    shadow: '속박 거부',
    ideal: '함께 성장하는 여정',
  },
  Capricorn: {
    partnerNeed: '야망 있고 책임감 있는 파트너',
    commitment: '전통적, 장기적',
    shadow: '일 우선, 감정 억압',
    ideal: '파워 커플',
  },
  Aquarius: {
    partnerNeed: '독특하고 친구 같은 파트너',
    commitment: '비전통적, 자유로움',
    shadow: '거리두기',
    ideal: '우정 기반 결합',
  },
  Pisces: {
    partnerNeed: '영적이고 연민 깊은 파트너',
    commitment: '무조건적, 영적',
    shadow: '환상, 경계 상실',
    ideal: '영혼의 합일',
  },
...
const VESTA_SIGNS: Record<
  ZodiacKo,
  { devotion: string; fire: string; work: string; shadow: string }
> = {
  Aries: {
    devotion: '선구적 프로젝트',
    fire: '행동의 열정',
 ...
 * 차트에 소행성 추가
 */
export function extendChartWithAsteroids(chart: Chart, jdUT: number): ExtendedChartWithAsteroids {
